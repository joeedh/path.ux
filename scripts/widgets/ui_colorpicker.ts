...
export class ColorField extends UIBase {
  constructor() {
    ...
    this.canvas.addEventListener("touchstart", (e) => {
      ...
      do_touch(e);
      if (mx !== undefined) return this.on_mousedown(e, mx, my, 0);
    });

    this.canvas.addEventListener("touchmove", (e) => {
      do_touch(e);
      if (mx !== undefined) return this.on_mousemove(e, mx, my, 0);
    });

    this.canvas.addEventListener("touchend", (e) => {
      do_touch(e);
      if (mx !== undefined) return this.on_mouseup(e, mx, my, 0);
    });
  ...
  on_mousedown(e, x, y, button) {
    ...
    let px1 = field.params.box.x,
      py1 = field.params.box.y,
      px2 = px1 + field.params.box.width,
      py2 = py1 + field.params.box.height;
  ...
  _sample_box(x, y) {
    ...
    let px = field.params.box.x,
      py = field.params.box.y,
      pw = field.params.box.width,
      ph = field.params.box.height;
  ...
  _redraw() {
    ...
    let w = size,
      h = (size * field.height) / field.width;
