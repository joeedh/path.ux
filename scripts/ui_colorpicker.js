...
let _ui_colorpicker = undefined;

define([
  "util", "vectormath", "ui_base", './icon_enum', './events',
  './ui'
], function(util, vectormath, ui_base, icon_enum, events, ui) {
  "use strict";

  let exports = _ui_colorpicker = {};
...
let inv_sample = exports.inv_sample = function(u, v) {
...
let sample = exports.sample = function(u, v) {
  let ret = sample_rets.next();
...
let fields = {};
exports.getFieldImage = function(size, hsva) {
    fieldrand.seed(0);
  ...
  let ColorField = exports.ColorField = class ColorField extends UIBase {
    constructor() {
      super();
    ...
    _sample_box(x, y) {
      ...
      let ret = exports.sample(u, 1.0-v);
      u = ret[0], v = 1.0-ret[1];
    ...
    _redraw() {
      ...
      let ret = exports.inv_sample(u, v);
      u = ret[0], v = ret[1];
  ...
  let ColorPicker =  exports.ColorPicker = class ColorPicker extends ui.ColumnFrame {
    constructor() {
      super();
