...
!(function () {
  ...
  var e,
          ...
          start: function (e, t) {
            if (!c.get())
              if (j(t.map, "data-ephox-embed-iri"))
                ...
                "source" === e && (u.source ? u.altsource || (u.altsource = t.map.src) : (u.source = t.map.src)),
              ...
              if (!m.get()) {
                if ("video" === e && u)
                  for (var t = 0; t < 2; t++)
                    if (c[U[t]]) {
                      var r = [];
                      (r.map = {}), d < t && (N(r, { src: c[U[t]], type: c[U[t] + "mime"] }), l.start("source", r, !0));
                    }
                if (c.poster && "object" === e && u && !s) {
                  var n = [];
                  (n.map = {}), N(n, { src: c.poster, width: c.width, height: c.height }), l.start("img", n, !0);
                }
              }
              l.end(e);
            },
        ...
        ? S.extend({}, e[0], {
            url: (function (e, t) {
              for (
                var r,
                  n =
                    (r = t.match(/^(https?:\/\/|www\.)(.+)$/i)) && 1 < r.length && "www." !== r[1] ? r[1] : "https://",
                  i = e.regex.exec(t),
                  a = n + e.url,
                  o = function (e) {
      ...
      return (
        ...
        "iframe" === n.type
          ? ((d = (m = n).allowFullscreen ? ' allowFullscreen="1"' : ""),
            '<iframe src="' + m.source + '" width="' + m.width + '" height="' + m.height + '"' + d + "></iframe>")
          : "application/x-shockwave-flash" === n.sourcemime
            ? ((l =
              ...
              s.poster && (l += '<img src="' + s.poster + '" width="' + s.width + '" height="' + s.height + '" />'),
              (l += "</object>"))
    ...
    X = function (i, a) {
      return function (e) {
        if (d(e.url) && 0 < e.url.trim().length) {
          var t = e.html,
            r = V(a, t),
      ...
      e.insertContent(t),
        (function (e, t) {
          for (var r = e.dom.select("img[data-mce-object]"), n = 0; n < t.length; n++)
            for (var i = r.length - 1; 0 <= i; i--) t[n] === r[i] && r.splice(i, 1);
    ...
    Z = function (e, t, r) {
      var n;
      (t.embed = E(t.embed, t)),
        t.embed && (e.source === t.source || ((n = t.source), B.hasOwnProperty(n)))
          ? Y(r, t.embed)
          : G(r, t)
              .then(function (e) {
                Y(r, e.html);
    ...
    ee = function (m) {
      var e,
        ...
        i =
          ...
          (n =
            (t = r).getAttribute("data-mce-object") || t.getAttribute("data-ephox-embed-iri")
        ...
        o = {
          ...
          items: (function (e) {
            ...
            m.getParam("media_dimensions", !0)
              ? [{ type: "sizeinput", name: "dimensions", label: "Constrain proportions", constrain: !0 }]
              : [],
          ]),
        },
      ...
      m.getParam("media_alt_source", !0) &&
        u.push({ name: "altsource", type: "urlinput", filetype: "media", label: "Alternative source URL" }),
        m.getParam("media_poster", !0) &&
          u.push({ name: "poster", type: "urlinput", filetype: "image", label: "Media poster (Image URL)" });
            ...
            switch (t.name) {
              case "source":
                (s = d.get()),
                  ...
                  s.source !== l.source && (X(f, m)({ url: l.source, html: "" }), G(m, l).then(X(f, m))["catch"](Q(m)));
                break;
              case "embed":
              ...
              if (((o = !0), "script" !== e && "noscript" !== e && "svg" !== e)) {
                for (var n = t.length - 1; 0 <= n; n--) {
                  ...
                  0 === i.indexOf("on") && (delete t.map[i], t.splice(n, 1)),
                    "style" === i && (t[n].value = a.dom.serializeStyle(a.dom.parseStyle(t[n].value), e));
                }
                c.start(e, t, r), (o = !1);
              }
            },
    ...
    ie = function (e, t, r) {
      var n, i, a, o, c;
      for (o = (a = t.attributes).length; o--; )
        (n = a[o].name),
          (i = a[o].value),
          "width" !== n &&
            "height" !== n &&
            "style" !== n &&
            (("data" !== n && "src" !== n) || (i = e.convertURL(i, n)), r.attr("data-mce-p-" + n, i));
      (c = t.firstChild && t.firstChild.value) && (r.attr("data-mce-html", escape(ne(e, c))), (r.firstChild = null));
    },
    ae = function (e) {
      for (; (e = e.parent); )
    ...
    oe = function (f) {
      return function (e) {
        for (var t, r, n, i, a, o, c, u, s, l, m, d, h = e.length; h--; )
          (t = e[h]).parent &&
            (t.parent.attr("data-mce-object") ||
              ("script" === t.name && !(r = A(O(f), t.attr("src")))) ||
              (r && (r.width && t.attr("width", r.width.toString()), r.height && t.attr("height", r.height.toString())),
              "iframe" === t.name && f.getParam("media_live_embeds", !0) && re.ceFalse
                ? ae(t) ||
                  t.replace(
                    ((c = f),
                    (m = l = s = void 0),
                    (d = (u = t).name),
                    (s = new te("span", 1)).attr({
                      contentEditable  : "false",
                      style            : u.attr("style"),
                      "data-mce-object": d,
                      "class"          : "mce-preview-object mce-object-" + d,
                    }),
                    ie(c, u, s),
                    (l = new te(d, 1)).attr({
                      src            : u.attr("src"),
                      allowfullscreen: u.attr("allowfullscreen"),
                      style          : u.attr("style"),
                      "class"        : u.attr("class"),
                      width          : u.attr("width"),
                      height         : u.attr("height"),
                      frameborder    : "0",
                    }),
                    (m = new te("span", 1)).attr("class", "mce-shim"),
                    s.append(l),
                    s.append(m),
                    s)
                  )
                : ae(t) ||
                  t.replace(
                    ...
                    (a = void 0),
                    (o = (i = t).name),
                    ((a = new te("img", 1)).shortEnded = !0),
                    ie(n, i, a),
                    a.attr({
                      width            : i.attr("width") || "300",
                      height           : i.attr("height") || ("audio" === o ? "30" : "150"),
                      style            : i.attr("style"),
    ...
    ce = function (e) {
      ...
      e.ui.registry.addToggleButton("media", {
        ...
        onSetup:
          ((t = e),
          (r = ["img[data-mce-object]", "span[data-mce-object]", "div[data-ephox-embed-iri]"]),
          function (e) {
      ...
      return (
        ...
        (d = e).on("preInit", function () {
          ...
          S.each("webkitallowfullscreen mozallowfullscreen allowfullscreen".split(" "), function (e) {
            ...
            d.parser.addNodeFilter("iframe,video,audio,object,embed,script", oe(d)),
                ...
                if ((r = e[l]).parent) {
                    ...
                    u = r.attr(t),
                      ...
                      "audio" !== u &&
                        ...
                        ((s = r.attr("class")) && -1 !== s.indexOf("mce-preview-object")
                          ? n.attr({ width: r.firstChild.attr("width"), height: r.firstChild.attr("height") })
                  ...
                  "script" === u && n.attr("type", "text/javascript"),
                    (o = r.attr("data-mce-html")) &&
                      (((c = new te("#text", 3)).raw = !0), (c.value = ne(d, unescape(o))), n.append(c)),
                    r.replace(n);
                }
            });
        }),
        ...
        r.on("ObjectResized", function (e) {
          ...
          r.getAttribute("data-mce-object") &&
            ...
            ((t = unescape(t)),
            r.setAttribute("data-mce-html", escape(E(t, { width: String(e.width), height: String(e.height) }))));
        }),
        (n = e),
        {
          showDialog: function () {
