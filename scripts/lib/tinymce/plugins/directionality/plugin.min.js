...
!(function (u) {
  ...
  var n,
    ...
    l = function (n, t) {
      var e,
        r = n.dom,
        o = n.selection.getSelectedBlocks();
      o.length &&
        ((e = r.getAttrib(o[0], "dir")),
        c.each(o, function (n) {
          r.getParent(n.parentNode, '*[dir="' + t + '"]', r.getRoot()) || r.setAttrib(n, "dir", e !== t ? t : null);
        }),
        n.nodeChanged());
    },
    d = function (n) {
    ...
    h = function (n) {
      return null === n || n === undefined ? s : g(n);
    },
    y = function (n) {
    ...
    T = {
      fromHtml: function (n, t) {
        var e = (t || u.document).createElement("div");
        ...
        return y(e.childNodes[0]);
      },
      fromTag: function (n, t) {
        var e = (t || u.document).createElement(n);
        return y(e);
      },
      fromText: function (n, t) {
        var e = (t || u.document).createTextNode(n);
        return y(e);
      },
      fromDom  : y,
      fromPoint: function (n, t, e) {
        var r = n.dom();
        return h(r.elementFromPoint(t, e)).map(y);
      },
    },
    v =
      ((r = "function"),
    ...
    w = function (n, t) {
      var e,
        r,
        o = n.dom(),
        i = u.window.getComputedStyle(o).getPropertyValue(t);
      return "" !== i ||
    ...
    N = function (n, t) {
      return (e = n).style !== undefined && v(e.style.getPropertyValue) ? n.style.getPropertyValue(t) : "";
      var e;
    },
    O = function (t, r) {
      return function (e) {
        var n = function (n) {
          var t = T.fromDom(n.element);
          e.setActive(("rtl" === w(t, "direction") ? "rtl" : "ltr") === r);
        };
        return (
          t.on("NodeChange", n),
          function () {
  ...
  !(function D() {
    i.add("directionality", function (n) {
      var t, e;
