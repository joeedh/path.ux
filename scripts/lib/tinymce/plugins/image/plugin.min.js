...
!(function (m) {
  ...
  var e,
    ...
    C =
      ...
      function () {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
          var a = e[r];
          for (var i in a) T.call(a, i) && (n[i] = o(n[i], a[i]));
        }
        return n;
      }),
    U = function () {
    ...
    O =
      ("undefined" != typeof m.window ? m.window : Function("return this;")(),
      function (e, t, n) {
        !(function (e, t, n) {
          if (!(S(n) || y(n) || w(n)))
            throw (
    ...
    _ = tinymce.util.Tools.resolve("tinymce.util.XHR"),
    E = function (e) {
    ...
    K = function (e) {
      ...
      X(e)
        ...
        : ((t = e),
          ...
          F.insertAfter(n, t),
          n.appendChild(t),
          n.appendChild(F.create("figcaption", { contentEditable: "true" }, "Caption")),
    ...
    ie = function (e) {
      return 0 === F.getAttrib(e, "alt").length && "presentation" === F.getAttrib(e, "role");
    },
    oe = function () {
      return {
        src         : "",
    ...
    le = function (e, t) {
      var n = m.document.createElement("img");
      return (
        V(n, "style", t.style),
    ...
    ce = function (e, t, n) {
      if (n) {
        ...
        "presentation" === F.getAttrib(e, "role") && F.setAttrib(e, "role", "");
      }
      var a;
    },
    me = function (r, a) {
    ...
    de = function (e, t, n) {
      ...
      ue(n, o, t, "caption", function (e, t, n) {
        ...
        (r = n),
        (a = o),
        ((i = t).alt === a.alt && i.isDecorative === a.isDecorative) || ce(r, i.alt, i.isDecorative);
    },
    ge = function (e, t) {
    ...
    fe = function (e) {
      ...
      return n ? e.dom.select("img", n)[0] : t && ("IMG" !== t.nodeName || B(t)) ? null : t;
    },
    pe = function (t, e) {
      var n = t.dom,
        r = n.getParent(
    ...
    he = function (t, e) {
      var n = (function (e, t) {
        var n = m.document.createElement("img");
        if ((de(e, U(U({}, t), { caption: !1 }), n), ce(n, t.alt, t.isDecorative), t.caption)) {
          var r = F.create("figure", { "class": "image" });
          return (
            r.appendChild(n),
            r.appendChild(F.create("figcaption", { contentEditable: "true" }, "Caption")),
    ...
    be = function (t, e) {
      ...
      if (
        ...
        t.selection.select(l),
          ...
          (a = e),
          (o = function () {
            (i.onload = i.onerror = null), r.selection && (r.selection.select(i), r.nodeChanged());
          }),
          ((i = l).onload = function () {
            a.width ||
              a.height ||
              !E(r) ||
              r.dom.setAttribs(i, { width: String(i.clientWidth), height: String(i.clientHeight) }),
              o();
          }),
          (i.onerror = o);
    },
    ...
    we = function (e, a) {
      ...
      return (
        ve.each(e, function (e) {
          var t = S(e.text) ? e.text : S(e.title) ? e.title : "";
          if (e.menu !== undefined) {
            var n = we(e.menu, a);
    ...
    Ae = function (e, n) {
      return (function (e, t) {
        ...
        return (
          (t = e),
          Object.prototype.hasOwnProperty.call(t, "items") ? Ae(e.items, n) : e.value === n ? A.some(e) : A.none()
        );
        var t;
      });
    },
  ...
  function Ce(o) {
    var t = function (e, r, a, t) {
      var i, n;
      (i = new m.XMLHttpRequest()).open("POST", o.url),
        ...
        (i.onload = function () {
          ...
          i.status < 200 || 300 <= i.status
            ...
            : (e = JSON.parse(i.responseText)) && "string" == typeof e.location
              ? r(((t = o.basePath), (n = e.location), t ? t.replace(/\/$/, "") + "/" + n.replace(/^\//, "") : n))
              : a("Invalid JSON: " + i.responseText);
        }),
        (n = new m.FormData()).append("file", e.blob(), e.filename()),
        i.send(n);
    };
    return (
  ...
  var Ue = function (e) {
    ...
    Oe = function (r) {
      var t,
        ...
        y = R(r),
        w = r.getParam("automatic_uploads", !0, "boolean"),
        D = A.some(r.getParam("image_prepend_url", "", "string")).filter(function (e) {
    ...
    Ie = function (e) {
      var t = e.imageList.map(function (e) {
          return { name: "images", type: "selectbox", label: "Image list", items: e };
        }),
        n = {
          name    : "alt",
          type    : "input",
        ...
        r = e.classList.map(function (e) {
          return { name: "classes", type: "selectbox", label: "Class", items: e };
        });
      return x([
    ...
    Re = function (e, t) {
      ...
      if (o !== undefined) {
        ...
        (r = l),
          ...
          n.hasAccessibilityOptions && (r.isDecorative = a.isDecorative || r.isDecorative || !1),
          n.hasImageTitle && S(a.title) && (r.title = a.title),
          n.hasDimensions &&
            (S(a.width) && (r.dimensions.width = a.width), S(a.height) && (r.dimensions.height = a.height)),
          S(a["class"]) &&
    ...
    He = function (e, t, n) {
      ...
      return (
        (u.vspace =
          (r = s)["margin-top"] && r["margin-bottom"] && r["margin-top"] === r["margin-bottom"]
            ? H(String(r["margin-top"]))
            : ""),
        (u.hspace =
          (a = s)["margin-right"] && a["margin-left"] && a["margin-right"] === a["margin-left"]
            ? H(String(a["margin-right"]))
            : ""),
        (u.border = (i = s)["border-width"] ? H(String(i["border-width"])) : ""),
        (u.borderstyle = (o = s)["border-style"] ? String(o["border-style"]) : ""),
        (u.style = (l = t)(e(l(s)))),
        u
      );
    },
    ke = function (s, u, t, c) {
      ...
      c.block("Uploading image"),
        (0 === (e = n.fileinput).length ? A.none() : A.some(e[0])).fold(
          function () {
            c.unblock();
          },
          function (n) {
            var r,
              a = m.URL.createObjectURL(n),
              i = Ce({ url: u.url, basePath: u.basePath, credentials: u.credentials, handler: u.handler }),
              o = function () {
        ...
        "src" === t.name
          ...
          : "images" === t.name
            ...
            : "alt" === t.name
              ...
              : "style" === t.name
                ? ((o = h), (s = (l = e).getData()), (u = He(o.parseStyle, o.serializeStyle, s)), l.setData(u))
                : "vspace" === t.name || "hspace" === t.name || "border" === t.name || "borderstyle" === t.name
                  ? ((n = h),
                    (r = e),
                  ...
                  : "fileinput" === t.name
                    ? ke(h, b, v, e)
                    : "isDecorative" === t.name && (e.getData().isDecorative ? e.disable("alt") : e.enable("alt"));
      };
    },
    Be = function (i) {
      return function (e) {
        var t,
          n,
          r,
          a = { prevImage: Te((t = e).imageList, t.image.src), prevAlt: t.image.alt, open: !0 };
        return {
            ...
            (r = e).hasAdvTab || r.hasUploadUrl || r.hasUploadHandler
              ? {
                  ...
                  tabs: x([
                    [Ne(r)],
                    r.hasAdvTab ? [Ue(r)] : [],
                    r.hasUploadTab && (r.hasUploadUrl || r.hasUploadHandler) ? [Le(r)] : [],
                  ]),
                }
      ...
      return function (e) {
        return (
          ...
          new L(function (t) {
            ...
            (n.onload = function () {
              var e = { width: z(n.width, n.clientWidth), height: z(n.height, n.clientHeight) };
              r(L.resolve(e));
            }),
              (n.onerror = function () {
    ...
    Ge = function (t) {
      var n,
        ...
        e = {
          onSubmit: function (n) {
            return function (e) {
              var t = C(_e(n.image), e.getData());
              s.execCommand("mceUpdateImage", !1, Ee(t, n.hasAccessibilityOptions)),
    ...
    qe = function (i) {
      return function (e) {
        for (
          ...
          (t = a.attr("class")) &&
            /\bimage\b/.test(t) &&
            (a.attr("contenteditable", i ? "false" : null), ve.each(a.getAll("figcaption"), r));
        }
      };
    };
  !(function $e() {
    a.add("image", function (e) {
      ...
      (t = e).on("PreInit", function () {
        ...
        n.ui.registry.addMenuItem("image", { icon: "image", text: "Image...", onAction: Ge(n).openLater }),
        n.ui.registry.addContextMenu("image", {
          update: function (e) {
            return ae(e) || ("IMG" === e.nodeName && !B(e)) ? ["image"] : [];
          },
        }),
        We(e);
    });
