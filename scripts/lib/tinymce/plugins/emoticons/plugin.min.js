...
!(function (m) {
  ...
  var n,
    ...
    g = {
      ...
      none: r,
      from: function (n) {
        return null === n || n === undefined ? l : s(n);
      },
    },
    f = function (n, t) {
    ...
    x = function (n) {
      var e,
        t = n.getParam("emoticons_append", {}, "object");
      return (
        (e = function (n) {
            ...
            (t = b(n, e)),
              ...
              C(t, function (n, t) {
                var e = { title: t, keywords: n.keywords, "char": n["char"], category: P(D, n.category) },
                  o = r[e.category] !== undefined ? r[e.category] : [];
    ...
    N = function (r, u) {
      var e,
        o,
        i,
        n = { pattern: "", results: y(u.listAll(), "", g.some(300)) },
        a = h(_),
        c =
          ((e = function (n) {
            var t, e, o, r, i;
        ...
        t = { label: "Search", type: "input", name: S },
        ...
        s = function () {
          return {
            ...
            onAction: function (n, t) {
              var e, o;
              "results" === t.name && ((e = r), (o = t.value), e.insertContent(o), n.close());
            },
            buttons    : [{ type: "cancel", text: "Close", primary: !0 }],
          };
        },
        f = r.windowManager.open(s());
      f.focus(S),
        u.hasLoaded() ||
  ...
  !(function E() {
    o.add("emoticons", function (n, t) {
      var e,
        ...
        a,
        c,
        l = ((o = t), (e = n).getParam("emoticons_database_url", o + "/js/emojis" + e.suffix + ".js")),
        s = n.getParam("emoticons_database_id", "tinymce.plugins.emoticons", "string"),
        f = L(n, l, s);
      (i = f),
        (u = function () {
          return N(r, i);
