                  ...
                  (function t(o) {
                    ...
                    return function (e) {
                      ...
                      if (o === i) {
                        ...
                        (r = s.parentNode),
                          0 < e.startNodeIndex &&
                            ((t = c.createTextNode(s.data.substring(0, e.startNodeIndex))),
                            r.insertBefore(t, s));
                        var l = m(e.match, a);
                        return (
                          r.insertBefore(l, s),
                          e.endNodeIndex < s.length &&
                            ((n = c.createTextNode(s.data.substring(e.endNodeIndex))),
                            r.insertBefore(n, s)),
        ...
        function (e, t, r, o) {
          ...
          (n["addToDictionary" === e ? "word" : "text"] = t),
            ...
            f.send({
              ...
              error: function () {
                var e =
                  c.translate("The spelling service was not found: (") + g(c) + c.translate(")");
                o(e);
              },
            });
        })
