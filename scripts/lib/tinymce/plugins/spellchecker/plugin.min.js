...
!(function (N) {
  ...
  var k = function (e) {
    ...
    y = tinymce.util.Tools.resolve("tinymce.PluginManager"),
  ...
  var r = function (a, r) {
      ...
      function l(e) {
        var t = a.getElementsByTagName("*"),
          n = [];
        e = "number" == typeof e ? "" + e : null;
        for (var r = 0; r < t.length; r++) {
          var o = t[r],
            i = o.getAttribute("data-mce-index");
          null !== i &&
            i.length &&
      ...
      function u(e) {
        for (var t = i.length; t--; ) if (i[t] === e) return t;
        return -1;
      }
      function e(e) {
        for (var t = 0, n = i.length; t < n && !1 !== e(i[t], t); t++);
        return this;
      }
      function t(e) {
        var t,
          n = l(e ? u(e) : null);
        for (t = n.length; t--; ) s(n[t]);
        return this;
      }
      function d(e) {
        var t = l(u(e)),
      ...
      return (
        (g = r.schema.getBlockElements()),
        (h = r.schema.getWhiteSpaceElements()),
        (p = r.schema.getShortEndedElements()),
        {
          text: (o = (function f(e) {
            var t;
          ...
          find: function y(e, t) {
            if (o && e.global) for (; (n = e.exec(o)); ) i.push(c(n, t));
            return this;
          },
          add: function S(e, t, n) {
            return i.push({ start: e, end: e + t, text: o.substr(e, t), data: n }), this;
          },
          wrap: function w(e) {
            return (
              i.length &&
                (function f(e, t, n) {
                  ...
                  e: for (;;) {
                    if (
                      ...
                      3 === u.nodeType &&
                        (!o && u.length + l >= c.end ? ((o = u), (a = c.end - l)) : r && s.push(u),
                        !r && u.length + l > c.start && ((r = u), (i = c.start - l)),
                        (l += u.length)),
                      r && o)
                    ) {
                      if (
                        ...
                        break;
                    } else if ((h[u.nodeName] && !g[u.nodeName]) || !u.firstChild) {
                      if (u.nextSibling) {
                        u = u.nextSibling;
                        continue;
                      }
                  ...
                  (function t(o) {
                    ...
                    return function (e) {
                      ...
                      if (o === i) {
                        ...
                        (r = s.parentNode),
                          0 < e.startNodeIndex &&
                            ((t = c.createTextNode(s.data.substring(0, e.startNodeIndex))), r.insertBefore(t, s));
                        var l = m(e.match, a);
                        return (
                          r.insertBefore(l, s),
                          e.endNodeIndex < s.length &&
                            ((n = c.createTextNode(s.data.substring(e.endNodeIndex))), r.insertBefore(n, s)),
                          s.parentNode.removeChild(s),
                          l
                        );
                      }
                      (t = c.createTextNode(o.data.substring(0, e.startNodeIndex))),
                        (n = c.createTextNode(i.data.substring(e.endNodeIndex)));
                      for (
                        var u = m(o.data.substring(e.startNodeIndex), a), d = 0, f = e.innerNodes.length;
                        d < f;
                        ++d
                      ) {
                        var g = e.innerNodes[d],
                          h = m(g.data, a);
                        g.parentNode.replaceChild(h, g);
                      }
                      var p = m(i.data.substring(0, e.endNodeIndex), a);
                      return (
            ...
            f.send({
              ...
              success: function (e) {
                ...
                if (t) t.error ? o(t.error) : r(t);
                  ...
                  var n = c.translate("Server response wasn't proper JSON.");
                  o(n);
                }
              },
              error: function () {
                var e = c.translate("The spelling service was not found: (") + g(c) + c.translate(")");
                o(e);
              },
            });
        })
      ...
      if (!a(t, n, r)) {
        t.setProgressState(!0),
          p(
            ...
            function (e) {
              t.notificationManager.open({ text: e, type: "error" }), t.setProgressState(!1), a(t, n, r);
            }
          ),
          t.focus();
      }
    ...
    a = function (e, t, n) {
      ...
      if ((u(e, n).reset(), e.selection.moveToBookmark(r), n.set(null), t.get()))
    ...
    A = "SpellcheckStart SpellcheckEnd",
    B = function (n, e, r, t, o, i) {
      var a,
        c,
        s,
        l =
      ...
      1 < l.length ? n.ui.registry.addSplitButton("spellchecker", f) : n.ui.registry.addToggleButton("spellchecker", d),
            ...
            onAction: function () {
              ...
              (e = s),
                ...
                p(
                  ...
                  function (e) {
                    t.notificationManager.open({ text: e, type: "error" }), t.setProgressState(!1);
                  }
                );
            },
          })),
      ...
      o.ui.registry.addContextMenu("spellchecker", {
        update: function (e) {
          ...
          var n = (function (e, t) {
            var n,
              r = [];
            if ((n = h.toArray(e.getBody().getElementsByTagName("span"))).length)
          ...
          if (0 < n.length) {
            ...
            return (
              ...
              I(o, i, a, c, s, l, t.getAttribute("data-mce-word"), n)
            );
          }
        },
      });
    ...
    y.add("spellchecker", function (e, t) {
      if (
        ...
        !(
          ...
          ("undefined" != typeof N.window.console &&
        ...
        var n = k(!1),
          r = k(((x = (v = e).getParam("language", "en")), v.getParam("spellchecker_language", x))),
          o = k(null),
          i = k(null);
        return (
          B(e, t, n, o, r, i),
