...
!(function (r) {
  ...
  var n,
    ...
    v = function (n) {
      return null === n || n === undefined ? d : m(n);
    },
    g = function (t) {
      return function (n) {
        return typeof n === t;
    ...
    T =
      ("undefined" != typeof r.window ? r.window : Function("return this;")(),
      function (n) {
    ...
    A = function (n, t, e) {
      !(function (n, t, e) {
        if (!(h(e) || p(e) || y(e)))
          throw (
            (r.console.error("Invalid call to Attr.set. Key ", t, ":: Value ", e, ":: Element ", n),
    ...
    D = function (n, t) {
      return (o = t), (u = C((e = n), (r = "class")).concat([o])), A(e, r, u.join(" ")), !0;
      var e, r, o, u;
    },
    E = function (n, t) {
      return (
    ...
    L = function (n) {
      0 === (S(n) ? n.dom().classList : C(n, "class")).length && O(n, "class");
    },
    x = function (n) {
    ...
    V = {
      fromHtml: function (n, t) {
        var e = (t || r.document).createElement("div");
      ...
      fromTag: function (n, t) {
        var e = (t || r.document).createElement(n);
        return x(e);
      },
      fromText: function (n, t) {
        var e = (t || r.document).createTextNode(n);
        return x(e);
      },
      fromDom  : x,
    ...
    q = "mce-nbsp",
    H = function (n) {
      return '<span data-mce-bogus="1" class="mce-' + B[n] + '">' + n + "</span>";
    },
    F = function (n) {
      var t = T(n);
    ...
    K = function (c, n) {
      var t = I(V.fromDom(n), F);
      w(t, function (n) {
        var t,
          e,
          r = n.dom().parentNode;
        if (U(r)) (t = V.fromDom(r)), (e = q), S(t) ? t.dom().classList.add(e) : D(t, e);
        else {
          for (
            var o = c.dom.encode(T(n)).replace(j, H), u = c.dom.create("div", null, o), i = void 0;
            (i = u.lastChild);
    ...
    z = function (n) {
      ...
      (r = r !== undefined ? r : t), R(n, r), K(n, r), n.selection.moveToBookmark(e);
    },
    G = function (n, t) {
      var e,
        r,
  ...
  !(function W() {
    c.add("visualchars", function (n) {
      ...
      return (
        ...
        !1 !== i.settings.forced_root_block &&
          i.on("keydown", function (n) {
            !0 === c.get() && (13 === n.keyCode ? z(i) : a());
          }),
        (f = d),
        (s = n).on("init", function () {
          var n = !s.getParam("visualchars_default_state", !1);
          f.set(n), G(s, f);
        }),
        (l = d),
        {
