  ...
  var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    i = function (e) {
      var t = (function (t) {
        ...
        l.each(t.contentCSS, function (e) {
          n +=
        ...
        var r = t.settings.body_id || "tinymce";
        -1 !== r.indexOf("=") && (r = (r = t.getParam("body_id", "", "hash"))[t.id] || r);
        var a = t.settings.body_class || "";
        -1 !== a.indexOf("=") && (a = (a = t.getParam("body_class", "", "hash"))[t.id] || "");
        var c =
            ...
            (m.mac ? "e.metaKey" : "e.ctrlKey && !e.altKey") +
