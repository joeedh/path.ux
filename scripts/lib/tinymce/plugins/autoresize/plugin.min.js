  ...
  var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    b = function (e, t) {
      var n,
        ...
        a = e.getDoc();
      if (a)
        if ((s = e).plugins.fullscreen && s.plugins.fullscreen.isFullscreen()) y(e, !0);
        else {
          var s,
            u = a.documentElement,
            g = e.getParam("autoresize_bottom_margin", 50, "number");
          i = v(e);
          var l = p(r, u, "margin-top", !0),
            f = p(r, u, "margin-bottom", !0);
          (o = u.offsetHeight + l + f + g) < 0 && (o = 0);
          var c = e.getContainer().offsetHeight - e.getContentAreaContainer().offsetHeight;
          o + c > v(e) && (i = o + c);
          var m = e.getParam("max_height", 0, "number");
          if ((m && m < i ? ((i = m), y(e, !0)) : y(e, !1), i !== t.get())) {
            ...
            e.hasFocus() && e.selection.scrollIntoView(e.selection.getNode()), h.webkit && n < 0 && b(e, t);
          }
        }
    };
  !(function t() {
    e.add("autoresize", function (e) {
      if ((e.settings.hasOwnProperty("resize") || (e.settings.resize = !1), !e.inline)) {
        var t =
          ((a = 0),
          {
            get: function () {
        ...
        (r = t),
          ...
          (n = e).on("init", function () {
            ...
            t.setStyles(n.getDoc().documentElement, { height: "auto" }),
              t.setStyles(n.getBody(), { paddingLeft: e, paddingRight: e, "min-height": 0 });
          }),
