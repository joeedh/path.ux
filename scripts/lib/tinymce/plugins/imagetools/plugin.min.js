    ...
    return new T(function (t, e) {
      (function g(t) {
        ...
        for (
          ...
          for (
            var f = 1024 * s, l = Math.min(1024 + f, u), d = new Array(l - f), m = f, h = 0;
            m < l;
            ++h, ++m
          )
  ...
  var et = function (t, e, n) {
    ...
    lt = function (t, e) {
      ...
      return (
        0 === n.indexOf("data:") ||
        0 === n.indexOf("blob:") ||
        new $(n).host === t.documentBaseURI.host
      );
    },
    dt = function (t, e) {
      return (
        -1 !== d.inArray(t.getParam("imagetools_cors_hosts", [], "string[]"), new $(e.src).host)
      );
    },
    mt = function (t, e) {
      var n,
