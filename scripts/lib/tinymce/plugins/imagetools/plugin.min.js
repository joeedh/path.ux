...
!(function (p) {
  ...
  var t,
    ...
    v = {
      ...
      none: a,
      from: function (t) {
        return null === t || t === undefined ? c : s(t);
      },
    };
  function m(t, e) {
    ...
    T = window.Promise
      ...
      : ((b =
          (w = function (t) {
            ...
            (this._state = null), (this._value = null), (this._deferreds = []), L(t, _(U, this), _(A, this));
          }).immediateFn ||
        ...
        (w.prototype.then = function (n, r) {
          ...
          return new w(function (t, e) {
            R.call(o, new E(n, r, t, e));
          });
        }),
        (w.all = function () {
          for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
          var c = Array.prototype.slice.call(1 === t.length && I(t[0]) ? t[0] : t);
        ...
        (w.resolve = function (e) {
          return e && "object" == typeof e && e.constructor === w
            ? e
            : new w(function (t) {
                t(e);
              });
  ...
  function U(t) {
    try {
      ...
      if (t && ("object" == typeof t || "function" == typeof t)) {
        var e = t.then;
        if ("function" == typeof e) return void L(_(e, t), _(U, this), _(A, this));
      }
      (this._state = !0), (this._value = t), x.call(this);
    } catch (n) {
      A.call(this, n);
    }
  }
  function A(t) {
    (this._state = !1), (this._value = t), x.call(this);
  }
  function x() {
            ...
            return new T(function (t, n) {
              ...
              e.open("GET", r, !0),
                ...
                (e.onerror = function () {
                  ...
                  n(
                    0 === this.status
                      ? (((t = new Error("No access to download image")).code = 18), (t.name = "SecurityError"), t)
  ...
  function C(a) {
    return new T(function (t, e) {
      ...
      r.addEventListener("load", i), r.addEventListener("error", u), (r.src = n), r.complete && i();
    });
  }
  function k(n) {
    return new T(function (t, e) {
      (function g(t) {
        ...
        if (!n) return v.none();
        for (
          var r = n[1], o = e[1], i = p.atob(o), u = i.length, a = Math.ceil(u / 1024), c = new Array(a), s = 0;
          s < a;
          ++s
        ) {
          for (var f = 1024 * s, l = Math.min(1024 + f, u), d = new Array(l - f), m = f, h = 0; m < l; ++h, ++m)
  ...
  function N(e, n) {
    return e.toCanvas().then(function (t) {
      return (function a(t, e, n) {
        var r = m(t.width, t.height),
          o = g(r),
          i = 0,
          u = 0;
        (90 !== (n = n < 0 ? 360 + n : n) && 270 !== n) || y(r, r.height, r.width);
        (90 !== n && 180 !== n) || (i = r.width);
        (270 !== n && 180 !== n) || (u = r.height);
        return o.translate(i, u), o.rotate((n * Math.PI) / 180), o.drawImage(t, 0, 0), B(r, e);
      })(t, e.getType(), n);
    });
  }
  function D(e, n) {
    return e.toCanvas().then(function (t) {
      return (function i(t, e, n) {
        var r = m(t.width, t.height),
          o = g(r);
        "v" === n ? (o.scale(1, -1), o.drawImage(t, 0, -r.height)) : (o.scale(-1, 1), o.drawImage(t, -r.width, 0));
        return B(r, e);
      })(t, e.getType(), n);
    });
  }
  var F = function (t, e) {
    ...
    z = tinymce.util.Tools.resolve("tinymce.util.Promise"),
    ...
    return (
      ...
      e || n
        ? r(e) && r(n)
          ...
          : null
        : ((e = t.width), (n = t.height), e && n ? { w: parseInt(e, 10), h: parseInt(n, 10) } : null)
    );
  }
  function J(t) {
  ...
  var K = function (t) {
    ...
    V = function (e, r, o) {
      return new z(function (t) {
        var n;
        ((n = new p.XMLHttpRequest()).onreadystatechange = function () {
          4 === n.readyState && t({ status: n.status, blob: this.response });
        }),
          n.open("GET", e, !0),
          (n.withCredentials = o),
    ...
    tt = function (t, e) {
      var n,
        r,
        o,
        i = { "Content-Type": "application/json;charset=UTF-8", "tiny-api-key": e };
      return V(
        ((r = e),
        (o = -1 === (n = t).indexOf("?") ? "?" : "&"),
        /[?&]apiKey=/.test(n) || !r ? n : n + o + "apiKey=" + encodeURIComponent(r)),
        i,
        !1
      ).then(function (t) {
        return t.status < 200 || 300 <= t.status
          ? ((e = t.status), (n = t.blob), 400 === (r = e) || 403 === r || 500 === r ? Z(0, n) : Q(e))
          : z.resolve(t.blob);
        var e, n, r;
      });
    };
  var et = function (t, e, n) {
      return e
        ...
        : (function r(t, e) {
            return V(t, {}, e).then(function (t) {
              return t.status < 200 || 300 <= t.status ? Q(t.status) : z.resolve(t.blob);
            });
          })(t, n);
    },
    nt = function (t) {
    ...
    rt = {
      fromHtml: function (t, e) {
        ...
        return nt(n.childNodes[0]);
      },
      fromTag: function (t, e) {
        var n = (e || p.document).createElement(t);
        return nt(n);
      },
      fromText: function (t, e) {
        var n = (e || p.document).createTextNode(t);
        return nt(n);
      },
      fromDom  : nt,
      fromPoint: function (t, e, n) {
        var r = t.dom();
        return v.from(r.elementFromPoint(e, n)).map(nt);
      },
    },
    ot =
      ...
      var e = function (t) {
        return (
          ...
          n.dom.is(e, "img:not([data-mce-object],[data-mce-placeholder])") &&
            (lt(n, t) || dt(n, t) || n.settings.imagetools_proxy)
        );
        var e;
      };
      return at(n, t)
    ...
    ft = function (t) {
      ...
      return at(t, e) ? ut(e) : v.some(rt.fromDom(e));
    },
    lt = function (t, e) {
      var n = e.src;
      return 0 === n.indexOf("data:") || 0 === n.indexOf("blob:") || new $(n).host === t.documentBaseURI.host;
    },
    dt = function (t, e) {
      return -1 !== d.inArray(t.getParam("imagetools_cors_hosts", [], "string[]"), new $(e.src).host);
    },
    mt = function (t, e) {
      var n,
        r,
      ...
      return dt(t, e)
        ? et(
            ...
            ((r = t),
            (o = e),
            -1 !== d.inArray(r.getParam("imagetools_credentials_hosts", [], "string[]"), new $(o.src).host))
          )
        : lt(t, e)
          ? j(e)
          : ((u = t.getParam("imagetools_proxy")),
            (u += (-1 === u.indexOf("?") ? "?" : "&") + "url=" + encodeURIComponent(e.src)),
            (n = (i = t).getParam("api_key", i.getParam("imagetools_api_key", "", "string"), "string")),
            et(u, n, !1));
    },
    ht = function (t, e) {
      return (
    ...
    gt = function (t, e) {
      var n;
      return (n = t.editorUpload.blobCache.getByUri(e.src)) ? z.resolve(n.blob()) : ht(t, e);
    },
    pt = function (t) {
      q.clearTimeout(t.get());
    },
    vt = function (a, c, s, f, l, d) {
      return c.toBlob().then(function (t) {
        ...
        return (
          ...
          a.getParam("images_reuse_filename", !1, "boolean") &&
            (n = (o = r.getByUri(e))
              ? ((e = o.uri()), o.name())
              : ((i = a), (u = e.match(/\/([^\/\?]+)?\.(?:jpeg|jpg|png|gif)(?:\?|$)/i)) ? i.dom.encode(u[1]) : null)),
          (o = r.create({ id: "imagetools" + it++, blob: t, base64: c.toBase64(), uri: e, name: n })),
          r.add(o),
    ...
    yt = function (n, r, t, o) {
      return function () {
        return ft(n).fold(
          function () {
            st(n, "Could not find selected image");
          },
          function (e) {
            return n
              ._scanForImages()
              ...
              (G(r) &&
                (function o(t, e) {
                  ...
                  e &&
                    ...
                    (n = t.width),
                    (r = t.height),
                    (n || r) && (t.setAttribute("width", e.w), t.setAttribute("height", e.h)));
                })(r, e)),
            p.URL.revokeObjectURL(t.src),
            u
          );
    ...
    Tt = function (i, u) {
      return function () {
        ...
        ft(i).each(function (e) {
          ct(i, e.dom()).each(function (t) {
            gt(i, e.dom()).then(function (t) {
              var e,
                n = { blob: (e = t), url: p.URL.createObjectURL(e) };
              i.windowManager.open({
                title   : "Edit Image",
                size    : "large",
                body: {
                  type : "panel",
                  items: [{ type: "imagetools", name: "imagetools", label: "Edit Image", currentState: n }],
                },
                buttons: [
                  { type: "cancel", name: "cancel", text: "Cancel" },
                  { type: "submit", name: "save", text: "Save", primary: !0, disabled: !0 },
                ],
                onSubmit: function (t) {
  ...
  !(function _t() {
    r.add("imagetools", function (t) {
      ...
      (n = t),
        ...
        d.each(
          {
            mceImageRotateLeft    : wt(n, e, -90),
            mceImageRotateRight   : wt(n, e, 90),
            mceImageFlipVertical  : bt(n, e, "v"),
            mceImageFlipHorizontal: bt(n, e, "h"),
            mceEditImage          : Tt(n, e),
          },
          function (t, e) {
            n.addCommand(e, t);
        ...
        r.ui.registry.addButton("editimage", {
          ...
          onSetup: function (n) {
            var t = function () {
              ft(r).each(function (t) {
                var e = ct(r, t.dom()).isNone();
                n.setDisabled(e);
              });
            };
            return (
        ...
        r.ui.registry.addContextMenu("imagetools", {
          update: function (t) {
            return ct(r, t).fold(
              ...
              function (t) {
                return [{ text: "Edit image", icon: "edit-image", onAction: o("mceEditImage") }];
              }
            );
          },
        }),
        ...
        (u = t).on("NodeChange", function (t) {
          var e = c.get();
          e && e.src !== t.element.src && (pt(a), u.editorUpload.uploadImagesAuto(), c.set(null)),
            ct(u, t.element).each(c.set);
        });
    });
  })();
})(window);
