                      ...
                      C = {
                            ...
                            switch (((t = t || {}), r)) {
                              case "Object":
                                ...
                                for (var i in ((a = {}), (t[n] = a), e))
                                  e.hasOwnProperty(i) && (a[i] = s(e[i], t));
                                return a;
                              case "Array":
                        ...
                        highlightElement: function (e, n, t) {
                          var a = C.util.getLanguage(e),
                            r = C.languages[a];
                          e.className =
                            e.className.replace(c, "").replace(/\s+/g, " ") + " language-" + a;
                          var i = e.parentNode;
                          i &&
                            "pre" === i.nodeName.toLowerCase() &&
                            (i.className =
                              i.className.replace(c, "").replace(/\s+/g, " ") + " language-" + a);
      ...
      a.ui.registry.addToggleButton("codesample", {
        ...
        onSetup: function (t) {
          var e = function () {
            var e, n;
            t.setActive(
              ((n = (e = a).selection.getStart()), e.dom.is(n, 'pre[class*="language-"]'))
            );
          };
          return (
            a.on("NodeChange", e),
