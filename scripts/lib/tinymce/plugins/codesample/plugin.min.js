...
!(function (e) {
  ...
  var n,
    ...
    d = {
      ...
      none: l,
      from: function (e) {
        return null === e || e === undefined ? u : c(e);
      },
    },
  ...
  var f = "undefined" != typeof e.window ? e.window : Function("return this;")(),
    h = {},
    b = { exports: h },
    y = {};
  !(function (n, t, a, d) {
    ...
    (window.Prism = { manual: !0 }),
      (function (e) {
        if ("object" == typeof t && void 0 !== a) a.exports = e();
        else if ("function" == typeof n && n.amd) n([], e);
        else {
              ...
              function (e, t, n) {
                (function (e) {
                  var n = (function (u) {
                    var c = /\blang(?:uage)?-([\w-]+)\b/i,
                      ...
                      C = {
                        ...
                        util: {
                          encode: function (e) {
                            return e instanceof O
                              ? new O(e.type, C.util.encode(e.content), e.alias)
                              : Array.isArray(e)
                                ? e.map(C.util.encode)
                                : e
                                    .replace(/&/g, "&amp;")
                          ...
                          clone: function s(e, t) {
                            ...
                            switch (((t = t || {}), r)) {
                              case "Object":
                                ...
                                for (var i in ((a = {}), (t[n] = a), e)) e.hasOwnProperty(i) && (a[i] = s(e[i], t));
                                return a;
                              case "Array":
                                return ((n = C.util.objId(e)), t[n])
                                  ? t[n]
                                  : ((a = []),
                                    (t[n] = a),
                          ...
                          insertBefore: function (t, e, n, a) {
                            ...
                            for (var s in r)
                              if (r.hasOwnProperty(s)) {
                                if (s == e) for (var o in n) n.hasOwnProperty(o) && (i[o] = n[o]);
                            ...
                            for (var i in e)
                              if (e.hasOwnProperty(i)) {
                                ...
                                var s = e[i],
                                  o = C.util.type(s);
                                "Object" !== o || a[r(s)]
                                  ? "Array" !== o || a[r(s)] || ((a[r(s)] = !0), l(s, n, i, a))
                                  : ((a[r(s)] = !0), l(s, n, null, a));
                              }
                          },
                        },
                        plugins                    : {},
                        ...
                        highlightAllUnder: function (e, n, t) {
                          ...
                          for (var r, i = 0; (r = a.elements[i++]); ) C.highlightElement(r, !0 === n, a.callback);
                        },
                        highlightElement: function (e, n, t) {
                          ...
                          i &&
                            ...
                            (i.className = i.className.replace(c, "").replace(/\s+/g, " ") + " language-" + a);
                          var s = { element: e, language: a, grammar: r, code: e.textContent };
                          function o(e) {
                            (s.highlightedCode = e),
                              C.hooks.run("before-insert", s),
                              (s.element.innerHTML = s.highlightedCode),
                              C.hooks.run("after-highlight", s),
                              C.hooks.run("complete", s),
                              t && t.call(s.element);
                          }
                          if ((C.hooks.run("before-sanity-check", s), !s.code))
                            return C.hooks.run("complete", s), void (t && t.call(s.element));
                          if ((C.hooks.run("before-highlight", s), s.grammar))
                            if (n && u.Worker) {
                            ...
                            } else o(C.highlight(s.code, s.grammar, s.language));
                          else o(C.util.encode(s.code));
                        },
                        ...
                        matchGrammar: function (e, n, t, a, r, i, s) {
                          for (var o in t)
                            if (t.hasOwnProperty(o) && t[o]) {
                              ...
                              for (var u = 0; u < l.length; ++u) {
                                ...
                                c = c.pattern || c;
                                for (var b = a, y = r; b < n.length; y += n[b].length, ++b) {
                                  var w = n[b];
                                  ...
                                  if (!(w instanceof O)) {
                                    if (g && b != n.length - 1) {
                                      ...
                                      for (
                                        var v = P.index + (p && P[1] ? P[1].length : 0),
                                          k = P.index + P[0].length,
                                          x = b,
                                          _ = y,
                                          F = n.length;
                                        x < F && (_ < k || (!n[x].type && !n[x - 1].greedy));
                                        ++x
                                      )
                                        (_ += n[x].length) <= v && (++b, (y = _));
                                      if (n[b] instanceof O) continue;
                                      (A = x - b), (w = e.slice(y, _)), (P.index -= y);
                                    } else {
                                      c.lastIndex = 0;
                                      var P = c.exec(w),
                                        A = 1;
                                    ...
                                    if (P) {
                                      p && (m = P[1] ? P[1].length : 0);
                                      k = (v = P.index + m) + (P = P[0].slice(m)).length;
                                      var S = w.slice(0, v),
                                        j = w.slice(k),
                                        $ = [b, A];
                                      S && (++b, (y += S.length), $.push(S));
                                      var E = new O(o, d ? C.tokenize(P, d) : P, f, P, g);
                                      if (
                                        ($.push(E),
                                        j && $.push(j),
                                        Array.prototype.splice.apply(n, $),
                                        1 != A && C.matchGrammar(e, n, t, b, y, !0, o + "," + u),
                                        i)
                                      )
                                        break;
                                    } else if (i) break;
                        ...
                        tokenize: function (e, n) {
                          ...
                          return C.matchGrammar(e, t, n, 0, 0, !1), t;
                        },
                        hooks: {
                          all: {},
                          add: function (e, n) {
                    ...
                    if (
                      ((u.Prism = C),
                      (O.stringify = function (e, n) {
                        if ("string" == typeof e) return e;
                        if (Array.isArray(e))
                          return e
                            .map(function (e) {
                              return O.stringify(e, n);
                            })
                            .join("");
                        var t = {
                          type      : e.type,
                          content   : O.stringify(e.content, n),
                          tag       : "span",
                        ...
                        if (e.alias) {
                          ...
                          Array.prototype.push.apply(t.classes, a);
                        }
                        C.hooks.run("wrap", t);
                    ...
                    if ((e && ((C.filename = e.src), e.hasAttribute("data-manual") && (C.manual = !0)), !C.manual)) {
                      ...
                      "loading" === a || ("interactive" === a && e && e.defer)
                  ...
                  void 0 !== t && t.exports && (t.exports = n), void 0 !== e && (e.Prism = n);
                }).call(
                  this,
                  void 0 !== y ? y : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}
                );
              },
              {},
            ],
              ...
              function (e, n, t) {
                ...
                (a = Prism),
                  ...
                  (a.languages.java = a.languages.extend("clike", {
                    ...
                    keyword     : r,
                    "function"  : [a.languages.clike["function"], { pattern: /(\:\:)[a-z_]\w*/, lookbehind: !0 }],
                    number:
                ...
                (y = Prism),
                  Object.defineProperties((y.languages["markup-templating"] = {}), {
                      ...
                      value: function (a, r, e, i) {
                        if (a.language === r) {
                          ...
                          (a.code = a.code.replace(e, function (e) {
                            ...
                            for (var n, t = s.length; -1 !== a.code.indexOf((n = b(r, t))); ) ++t;
                            return (s[t] = e), n;
                          })),
                    ...
                    tokenizePlaceholders: {
                      value: function (p, g) {
                        if (p.language === g && p.tokenStack) {
                          p.grammar = y.languages[g];
                          var m = 0,
                          ...
                          !(function h(e) {
                            for (var n = 0; n < e.length && !(m >= f.length); n++) {
                              ...
                              if ("string" == typeof t || (t.content && "string" == typeof t.content)) {
                                var a = f[m],
                                  r = p.tokenStack[a],
                                  i = "string" == typeof t ? t : t.content,
                                  s = b(g, a),
                                  o = i.indexOf(s);
                                if (-1 < o) {
                                  ++m;
                                  var l = i.substring(0, o),
                                    u = new y.Token(g, y.tokenize(r, p.grammar), "language-" + g, r),
                                    c = i.substring(o + s.length),
                                    d = [];
                                  l && d.push.apply(d, h([l])),
                                    d.push(u),
                                    c && d.push.apply(d, h([c])),
                                    "string" == typeof t ? e.splice.apply(e, [n, 1].concat(d)) : (t.content = d);
                                }
                              } else t.content && h(t.content);
                            }
                            return e;
                          })(p.tokens);
                        }
                  ...
                  Object.defineProperty(Prism.languages.markup.tag, "addInlined", {
                    value: function (e, n) {
                      ...
                      (t["language-" + n] = {
                        ...
                        (t.cdata = /^<!\[CDATA\[|\]\]>$/i);
                      var a = {
                        "included-cdata": { pattern: /<!\[CDATA\[[\s\S]*?\]\]>/i, inside: t },
                      };
  ...
  var w = b.exports.boltExport,
    ...
    x = function (i) {
      var e,
        ...
        a = (0 === (e = n).length ? d.none() : d.some(e[0])).fold(
          function () {
            return "";
          },
          function (e) {
    ...
    r.add("codesample", function (n) {
      ...
      (r = (t = n).$),
        ...
        (a = n).addCommand("codesample", function () {
          ...
          a.selection.isCollapsed() || g(e) ? x(a) : a.formatter.toggle("code");
        }),
