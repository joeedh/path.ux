...
!(function () {
  ...
  var e,
    ...
    w = function (e) {
      ...
      return v.mac ? a.join("").replace(/\s/, "") : a.join("+");
    },
                ...
                : '<div data-mce-tabstop="1" tabindex="-1">' +
                  (function (a) {
                    var t,
                      ...
                      n =
                        ((e = f((t = a).plugins)),
                        t.settings.forced_plugins === undefined
                          ? e
                          : (function (e, t) {
                              ...
                              return !h(t.settings.forced_plugins, e);
                            })),
                      o = p(n, function (e) {
                        return (
                          "<li>" +
                          ...
                          g(C, function (e) {
                            ...
                            function () {
                              ...
                              return "function" == typeof e ? s(e()) : n;
                            },
                            function (e) {
                              return s({ name: e.name, url: "https://www.tiny.cloud/docs/plugins/" + e.key });
                            }
                          )) +
                          "</li>"
                        );
                      ...
                      i = o.length,
                      r = o.join("");
                    return "<p><b>" + A.translate(["Plugins installed ({0}):", i]) + "</b></p><ul>" + r + "</ul>";
                  })(n) +
                  "</div>",
              ((t = p(
                [
      ...
      var n,
          ...
          items: [
            {
              ...
              cells: p(k, function (e) {
                var t = p(e.shortcuts, w).join(" or ");
                return [e.action, t];
              }),
            },
          ],
        ...
        u =
          ((i =
            ...
            ((a = x.majorVersion), (o = x.minorVersion), 0 === a.indexOf("@") ? "X.X.X" : a + "." + o) +
            "</a>"),
          {
            name : "versions",
            title: "Version",
            items: [
              { type: "htmlpanel", html: "<p>" + A.translate(["You are using {0}", i]) + "</p>", presets: "document" },
            ],
          }),
        h = m((((n = {})[s.name] = s), (n[c.name] = c), (n[l.name] = l), (n[u.name] = u), n), t.get());
      return (
        (r = e),
        d.from(r.getParam("help_tabs")).fold(
          function () {
            return (
              (t = f((e = h))),
              -1 !== (n = t.indexOf("versions")) && (t.splice(n, 1), t.push("versions")),
              { tabs: e, names: t }
            );
            var e, t, n;
          },
          function (e) {
            return (
              ...
              (n = {}),
              (a = p(e, function (e) {
                return "string" == typeof e ? (y(t, e) && (n[e] = t[e]), e) : (n[e.name] = e).name;
              })),
              { tabs: n, names: a }
            );
            var t, n, a;
  ...
  !(function F() {
    a.add("help", function (e) {
      ...
      return (
        (o = c),
        (a = e).ui.registry.addButton("help", { icon: "help", tooltip: "Help", onAction: o }),
        a.ui.registry.addMenuItem("help", { text: "Help", icon: "help", shortcut: "Alt+0", onAction: o }),
        (i = c),
