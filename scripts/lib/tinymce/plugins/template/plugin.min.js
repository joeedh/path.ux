  ...
  var n,
    ...
    m = function (e, t, n) {
      ...
      return (
        ...
        (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace(
          "%D",
          "%m/%d/%Y"
        )).replace("%r", "%I:%M:%S %p")).replace("%Y", "" + n.getFullYear())).replace("%y", "" + n.getYear())).replace(
          "%m",
          f(n.getMonth() + 1, 2)
        )).replace("%d", f(n.getDate(), 2))).replace("%H", "" + f(n.getHours(), 2))).replace(
          "%M",
          "" + f(n.getMinutes(), 2)
        )).replace("%S", "" + f(n.getSeconds(), 2))).replace("%I", "" + (((n.getHours() + 11) % 12) + 1))).replace(
          "%p",
          n.getHours() < 12 ? "AM" : "PM"
        )).replace("%B", "" + e.translate(u[n.getMonth()]))).replace("%b", "" + e.translate(o[n.getMonth()]))).replace(
          "%A",
    ...
    y = function (n, e, t) {
      var r,
        a,
        o = n.dom,
        u = n.selection.getContent();
      (t = g(t, l(n))),
        (r = o.create("div", null, t)),
        (a = o.select(".mceTmpl", r)) && 0 < a.length && (r = o.create("div", null)).appendChild(a[0].cloneNode(!0)),
        p.each(o.select("*", r), function (e) {
          var t;
          h(e, n.getParam("template_cdate_classes", "cdate").replace(/\s+/g, "|")) &&
            (e.innerHTML = m(n, (t = n).getParam("template_cdate_format", t.translate("%Y-%m-%d")))),
            h(e, n.getParam("template_mdate_classes", "mdate").replace(/\s+/g, "|")) && (e.innerHTML = m(n, s(n))),
            h(e, n.getParam("template_selected_content_classes", "selcontent").replace(/\s+/g, "|")) &&
              (e.innerHTML = u);
        }),
        v(n, r),
    ...
    O = {
      ...
      none: M,
      from: function (e) {
        return null === e || e === undefined ? T : _(e);
      },
    },
    x = function (e, t) {
    ...
    C = function (e) {
      return e.replace(/["'<>&]/g, function (e) {
        return (P((t = D), (n = e)) ? O.from(t[n]) : O.none()).getOr(e);
        var t, n;
      });
    },
    A = function (l, t) {
      var e = function (e) {
        ...
        f = function (e) {
          l.windowManager.alert("Could not load the specified template.", function () {
      ...
      (function () {
        ...
        var e = l.translate("No templates defined.");
        return l.notificationManager.open({ text: e, type: "info" }), O.none();
      })().each(function (o) {
        var u = e(o),
          i = function (e, t) {
            return {
            ...
            var r = (function (t, e) {
                if (-1 === e.indexOf("<html>")) {
                  ...
                  p.each(t.contentCSS, function (e) {
                    n += '<link type="text/css" rel="stylesheet" href="' + t.documentBaseURI.toAbsolute(e) + '">';
                  });
                  var r = t.settings.body_class || "";
                  -1 !== r.indexOf("=") && (r = (r = t.getParam("body_class", "", "hash"))[t.id] || "");
                  var a = t.dom.encode,
                    o = t.getBody().dir,
                    u = o ? ' dir="' + a(o) + '"' : "";
                  e =
                ...
                return g(e, t.getParam("template_preview_replace_values"));
              })(l, n),
              a = [
                { type: "selectbox", name: "template", label: "Templates", items: u },
                { type: "htmlpanel", html: '<p aria-live="polite">' + C(t.value.description) + "</p>" },
                { label: "Preview", type: "iframe", name: "preview", sandboxed: !1 },
              ],
              o = { template: t.text, preview: r };
            e.unblock(), e.redial(i(a, o)), e.focus("template");
          },
          t = l.windowManager.open(i([], { template: "", preview: "" }));
        t.block("Loading..."),
          m(o[0])
            .then(function (e) {
              c(t, o[0], e);
          ...
          p.each(t.select("div", e.node), function (e) {
            t.hasClass(e, "mceTmpl") &&
              (p.each(t.select("*", e), function (e) {
                t.hasClass(e, r.getParam("template_mdate_classes", "mdate").replace(/\s+/g, "|")) &&
                  (e.innerHTML = m(r, n));
              }),
              v(r, e));
          });
