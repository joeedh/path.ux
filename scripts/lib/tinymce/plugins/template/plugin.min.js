  ...
  var n,
    ...
    y = function (n, e, t) {
      ...
      (t = g(t, l(n))),
        ...
        (a = o.select(".mceTmpl", r)) &&
          0 < a.length &&
          (r = o.create("div", null)).appendChild(a[0].cloneNode(!0)),
        p.each(o.select("*", r), function (e) {
          ...
          h(e, n.getParam("template_cdate_classes", "cdate").replace(/\s+/g, "|")) &&
            ...
            h(e, n.getParam("template_mdate_classes", "mdate").replace(/\s+/g, "|")) &&
              (e.innerHTML = m(n, s(n))),
            h(
              e,
              n.getParam("template_selected_content_classes", "selcontent").replace(/\s+/g, "|")
            ) && (e.innerHTML = u);
        }),
        v(n, r),
          ...
          c = function (e, t, n) {
            var r = (function (t, e) {
                if (-1 === e.indexOf("<html>")) {
                  ...
                  -1 !== r.indexOf("=") &&
                    (r = (r = t.getParam("body_class", "", "hash"))[t.id] || "");
                  var a = t.dom.encode,
                    o = t.getBody().dir,
                    u = o ? ' dir="' + a(o) + '"' : "";
                  e =
