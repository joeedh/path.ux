...
!(function (s) {
  ...
  var e = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    v = t.DOM,
    n = function (e) {
      e.keyCode !== m.TAB || e.ctrlKey || e.altKey || e.metaKey || e.preventDefault();
    },
    i = function (c) {
      function e(n) {
        var i, o, e, l, t;
        if (
          !(n.keyCode !== m.TAB || n.ctrlKey || n.altKey || n.metaKey || n.isDefaultPrevented()) &&
          (1 ===
            (e = d.explode((t = c).getParam("tab_focus", t.getParam("tabfocus_elements", ":prev,:next")))).length &&
            ((e[1] = e[0]), (e[0] = ":prev")),
          (o = n.shiftKey ? (":prev" === e[0] ? r(-1) : v.get(e[0])) : ":next" === e[1] ? r(1) : v.get(e[1])))
        ) {
          var u = a.get(o.id || o.name);
          o.id && u
            ? u.focus()
