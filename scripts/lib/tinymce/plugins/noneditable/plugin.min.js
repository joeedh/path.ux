...
!(function () {
  ...
  var t = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    f = function (n) {
      return function (t) {
        return -1 !== (" " + t.attr("class") + " ").indexOf(n);
      };
    },
    s = function (i, o, c) {
      return function (t) {
        ...
        if ('"' === r) return t;
        if (">" === r) {
          var a = o.lastIndexOf("<", e);
          if (-1 !== a) if (-1 !== o.substring(a, e).indexOf('contenteditable="false"')) return t;
        }
        return (
          '<span class="' +
          c +
          ...
          i.dom.encode(n[0]) +
          '">' +
          i.dom.encode("string" == typeof n[1] ? n[1] : n[0]) +
          "</span>"
        );
      };
    },
    n = function (n) {
      var t,
        e,
        r = "contenteditable";
      (t = " " + l.trim(n.getParam("noneditable_editable_class", "mceEditable")) + " "), (e = " " + l.trim(u(n)) + " ");
      var a,
        i = f(t),
        o = f(e),
        c = (a = n.getParam("noneditable_regexp", [])) && a.constructor === RegExp ? [a] : a;
      n.on("PreInit", function () {
        0 < c.length &&
          ...
          n.parser.addAttributeFilter("class", function (t) {
            for (var n, e = t.length; e--; ) (n = t[e]), i(n) ? n.attr(r, "true") : o(n) && n.attr(r, "false");
          }),
          n.serializer.addAttributeFilter(r, function (t) {
            for (var n, e = t.length; e--; )
              (n = t[e]),
                (i(n) || o(n)) &&
                  (0 < c.length && n.attr("data-mce-content")
