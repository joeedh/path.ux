...
!(function (V) {
  ...
  var r = function (e) {
    ...
    l = t(function (e, t) {
      ...
      return (
        n === r(t) &&
        (-1 !== ["undefined", "boolean", "number", "string", "function", "xml", "null"].indexOf(n)
          ? e === t
          : "array" === n
            ? i(l).eq(e, t)
            : "object" === n && u(l).eq(e, t))
        ...
        return (
          ...
          (null === t
            ...
            : "object" == n && (Array.prototype.isPrototypeOf(t) || (t.constructor && "Array" === t.constructor.name))
              ? "array"
              : "object" == n &&
                  (String.prototype.isPrototypeOf(t) || (t.constructor && "String" === t.constructor.name))
                ? "string"
                : n) === r
        );
        var t, n;
  ...
  var he,
    ...
    De = {
      unknown: function () {
        return Ae({ current: undefined, version: Re.unknown() });
      },
      nu     : Ae,
      edge   : x("Edge"),
      chrome : x("Chrome"),
    ...
    Fe = {
      unknown: function () {
        return Me({ current: undefined, version: Re.unknown() });
      },
      nu      : Me,
      windows : x(Oe),
      ios     : x("iOS"),
    ...
    Ge = [
      ...
      { name: "Firefox", versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: Ye("firefox") },
      {
        name          : "Safari",
    ...
    Je = [
      { name: "Windows", search: Ye("win"), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
      {
        name          : "iOS",
        search: function (e) {
      ...
      { name: "OSX", search: Ye("mac os x"), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
      ...
      { name: "ChromeOS", search: Ye("cros"), versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/] },
    ],
    Qe = { browsers: x(Ge), oses: x(Je) },
    Ze = function (e, t) {
      var n,
        r,
        o,
        ...
        p = Qe.browsers(),
        g = Qe.oses(),
        h = ze(p, e).fold(De.unknown, De.nu),
        v = je(g, e).fold(Fe.unknown, Fe.nu);
      return {
        browser   : h,
        os        : v,
        deviceType:
    ...
    tt =
      ...
      function () {
        for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
        return ye || ((ye = !0), (ve = he.apply(null, e))), ve;
      }),
    nt = function () {
      return tt();
    },
    ...
    st = function (e, t) {
      return nt().browser.isIE() ? ut(e, t) : ((n = t), (r = e.dom()), (o = n.dom()), r !== o && r.contains(o));
      var n, r, o;
    },
    ct = function (e) {
    ...
    Mt = function (e) {
      ...
      return r === n
        ? Lt(r.offsetLeft, r.offsetTop)
        : Bt(e)
          ? ((t = n.getBoundingClientRect()), Lt(t.left, t.top))
          : Lt(0, 0);
    },
    Ft = function (e) {
    ...
    zt = function (e, t) {
      nt().browser.isSafari() && D(e.dom().scrollIntoViewIfNeeded)
    ...
    sn = function (e, t, n) {
      if (!(q(n) || T(n) || O(n)))
        throw (
          (V.console.error("Invalid call to Attr.set. Key ", t, ":: Value ", n, ":: Element ", e),
  ...
  (be = undefined),
    ...
    (xe = undefined),
    (function (e) {
      if ("object" == typeof Ce && void 0 !== we) we.exports = e();
      else if ("function" == typeof be && be.amd) be([], e);
      else {
      ...
      return (function l(i, a, u) {
        ...
        for (var c = "function" == typeof xe && xe, e = 0; e < u.length; e++) s(u[e]);
        return s;
      })(
        {
          1: [
      ...
      : ((xn =
        ...
        (Nn =
          (Sn = function (e) {
            if ("object" != typeof this) throw new TypeError("Promises must be constructed via new");
            if ("function" != typeof e) throw new TypeError("not a function");
            (this._state = null), (this._value = null), (this._deferreds = []), qn(e, Fn(zn, this), Fn(jn, this));
          }).immediateFn ||
        ...
        (Sn.resolve = function (t) {
          return t && "object" == typeof t && t.constructor === Sn
            ? t
            : new Sn(function (e) {
                e(t);
              });
  ...
  function zn(e) {
    try {
      ...
      if (e && ("object" == typeof e || "function" == typeof e)) {
        var t = e.then;
        if ("function" == typeof t) return void qn(Fn(t, e), Fn(zn, this), Fn(jn, this));
      }
      (this._state = !0), (this._value = e), Hn.call(this);
    } catch (n) {
      jn.call(this, n);
    }
  }
  function jn(e) {
    (this._state = !1), (this._value = e), Hn.call(this);
  }
  function Hn() {
    for (var e = 0, t = this._deferreds.length; e < t; e++) Un.call(this, this._deferreds[e]);
    ...
    hr = {
      ...
      toArray: function (e) {
        var t,
          n,
          r = e;
        if (!or(e)) for (r = [], t = 0, n = e.length; t < n; t++) r[t] = e[t];
        return r;
      },
    ...
    var b = function (e) {
      ...
      n = function (e, t, n) {
          ...
          f = function () {
            l(function () {
              for (var e, t, n = p.styleSheets, r = n.length; r--; )
                if ((t = (e = n[r]).ownerNode ? e.ownerNode : e.owningElement) && t.id === o.id) return s(), 1;
            }, f);
          },
          d = function () {
            l(function () {
        ...
        if (
          ...
          y[e] ? (a = y[e]) : ((a = { passed: [], failed: [] }), (y[e] = a)),
          t && a.passed.push(t),
          n && a.failed.push(n),
          1 !== a.status)
        )
          if (2 !== a.status)
            if (3 !== a.status) {
              if (
                ...
                (o.onload = f), (o.onerror = c);
              else {
                if (0 < V.navigator.userAgent.indexOf("Firefox"))
                  return ((r = p.createElement("style")).textContent = '@import "' + e + '"'), d(), void b(r);
                f();
              }
              var m;
              b(o), (o.href = e);
  ...
  var yr,
    ...
    Pr = function (e, t) {
      var n,
        r = t.childNodes;
      if (!$t(t) || !Br(t)) {
        for (n = r.length - 1; 0 <= n; n--) Pr(e, r[n]);
        if (!1 === tn(t)) {
          if (Zt(t) && 0 < t.nodeValue.length) {
            ...
            $t(t) &&
            (1 === (r = t.childNodes).length && Br(r[0]) && t.parentNode.insertBefore(r[0], t),
  ...
  var jr = function (e, t) {
    ...
    if (e) {
      for (e = e.split(","), t = t || 10, n = 0; n < e.length; n += 2)
        (r = String.fromCharCode(parseInt(e[n], t))), br[r] || ((o = "&" + e[n + 1] + ";"), (i[r] = o), (i[o] = r));
      return i;
    }
  };
  yr = jr(
        ...
        return e.replace(Ur, function (e, t) {
          return t
            ? 65535 < (t = "x" === t.charAt(0).toLowerCase() ? parseInt(t.substr(1), 16) : parseInt(t, 10))
              ...
              : zr[t] || String.fromCharCode(t)
            : Cr[e] ||
                yr[e] ||
                ((n = e), ((r = Ne.fromTag("div").dom()).innerHTML = n), r.textContent || r.innerText || n);
          var n, r;
        });
      },
    },
    ...
    eo = function (e) {
      var u,
        ...
        a = function (e, t, n) {
          ...
          for (t = t || "", "string" == typeof (n = n || []) && (n = Zr(n)), r = (e = Zr(e)).length; r--; )
            (i = { attributes: a((o = Zr([u, t].join(" ")))), attributesOrder: o, children: a(n, Kr) }), (s[e[r]] = i);
        },
        c = function (e, t) {
          var n, r, o, i;
          for (n = (e = Zr(e)).length, t = Zr(t); n--; )
  ...
  function no(i) {
    var e,
      ...
      v = function (e, t, n) {
        ...
        return (
          r
            ? (r = Xr(r, /[, ]/, Xr(r.toUpperCase(), /[, ]/)))
            : (r = Wr[e]) || ((r = Xr(t, " ", Xr(t.toUpperCase(), " "))), (r = Gr(r, n)), (Wr[e] = r)),
          r
        );
      };
    (n = eo((i = i || {}).schema)),
    ...
    var N = function (e) {
      ...
      y = function (e) {
        ...
        if (e)
          for (
            e = Zr(e, ","), x["@"] && ((h = x["@"].attributes), (v = x["@"].attributesOrder)), t = 0, n = e.length;
            t < n;
            t++
          )
            if ((i = b.exec(e[t]))) {
      ...
      C = function (e) {
        var a = /^(~)?(.+)$/;
        e &&
          ((Wr.text_block_elements = Wr.block_elements = null),
          Yr(Zr(e, ","), function (e) {
            var t = a.exec(e),
              n = "~" === t[1],
              r = n ? "span" : "div",
              o = t[2];
            if (((p[o] = p[r]), (g[o] = r), n || ((c[o.toUpperCase()] = {}), (c[o] = {})), !x[o])) {
              var i = x[r];
              delete (i = Gr({}, i)).removeEmptyAttrs, delete i.removeEmpty, (x[o] = i);
            }
            Yr(p, function (e, t) {
              e[r] && ((p[t] = e = Gr({}, p[t])), (e[o] = e[r]));
            });
          }));
      },
      w = function (e) {
    ...
    i.valid_elements
      ? b(i.valid_elements)
      : (Yr(n, function (e, t) {
          (x[t] = { attributes: e.attributes, attributesOrder: e.attributesOrder }), (p[t] = e.children);
        }),
        "html5" !== i.schema &&
          Yr(Zr("strong/b em/i"), function (e) {
            (e = Zr(e, "/")), (x[e[1]].outputName = e[0]);
          }),
      ...
      i.invalid_elements &&
        Yr(Jr(i.invalid_elements), function (e) {
          x[e] && delete x[e];
        }),
  ...
  var ro = "\ufeff",
    ...
    po = function (e, t) {
      var n,
        r,
        o = t || {};
      for (n in e) so[n] || (o[n] = e[n]);
      if (
        (o.target || (o.target = o.srcElement || V.document),
        rr.experimentalShadowDom &&
      ...
      return (
        (o.preventDefault = function () {
          (o.isDefaultPrevented = lo), e && (e.preventDefault ? e.preventDefault() : (e.returnValue = !1));
        }),
        (o.stopPropagation = function () {
          (o.isPropagationStopped = lo), e && (e.stopPropagation ? e.stopPropagation() : (e.cancelBubble = !0));
        }),
        !(o.stopImmediatePropagation = function () {
          (o.isImmediatePropagationStopped = lo), o.stopPropagation();
        }) == ((r = o).isDefaultPrevented === lo || r.isDefaultPrevented === co) &&
          ((o.isDefaultPrevented = co), (o.isPropagationStopped = co), (o.isImmediatePropagationStopped = co)),
    ...
    go = function (e, t, n) {
      ...
      if (n.domLoaded) t(o);
        ...
        var i = function () {
          mo(e, "DOMContentLoaded", i), mo(e, "load", i), n.domLoaded || ((n.domLoaded = !0), t(o));
        };
    ...
    ho =
      ((vo.prototype.bind = function (e, t, n, r) {
        var o,
          i,
          a,
          u,
                ...
                : (f.hasMouseEnterLeave ||
                    ((s = f.mouseEnterLeave[u]) &&
                      (c = function (e) {
                        ...
                        n ||
                          (((e = po(e || d.event)).type = "mouseout" === e.type ? "mouseleave" : "mouseenter"),
                          (e.target = t),
          ...
          if (((s = this.events[r]), e)) {
            ...
            for (i = c.length; i--; )
              if ((o = s[(u = c[i])])) {
                ...
                (t && 0 !== o.length) || (delete s[u], mo(n, o.fakeName || u, o.nativeHandler, o.capture));
              }
          } else
            oe(s, function (e, t) {
              ...
              (s = {});
          for (u in s) if (me(s, u)) return this;
      ...
      (vo.prototype.executeHandlers = function (e, t) {
        ...
        if ((n = a && a[e.type]))
          for (r = 0, o = n.length; r < o; r++)
            if (((i = n[r]) && !1 === i.func.call(i.scope, e) && e.preventDefault(), e.isImmediatePropagationStopped()))
              return;
      }),
      (vo.Event = new vo()),
      vo);
  ...
  var yo,
    ...
    ei =
      ...
      Zo +
      ")*)|.*)\\)|)",
    ti = new RegExp("^" + Jo + "+|((?:^|[^\\\\])(?:\\\\.)*)" + Jo + "+$", "g"),
    ni = new RegExp("^" + Jo + "*," + Jo + "*"),
    ri = new RegExp("^" + Jo + "*([>+~]|" + Jo + ")" + Jo + "*"),
    oi = new RegExp("=" + Jo + "*([^\\]'\"]*?)" + Jo + "*\\]", "g"),
    ii = new RegExp(ei),
    ai = new RegExp("^" + Qo + "$"),
    ui = {
      ID          : new RegExp("^#(" + Qo + ")"),
    ...
    si = /^(?:input|select|textarea|button)$/i,
    ci = /^h\d$/i,
    li = /^[^{]+\{\s*\[native \w/,
    fi = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
    di = /[+~]/,
    mi = /'|\\/g,
    pi = new RegExp("\\\\([\\da-f]{1,6}" + Jo + "?|(" + Jo + ")|.)", "ig"),
    gi = function (e, t, n) {
      var r = "0x" + t - 65536;
      return r != r || n
        ? t
  ...
  try {
    Xo.apply(($o = Yo.call(Io.childNodes)), Io.childNodes), $o[Io.childNodes.length].nodeType;
  } catch (pE) {
    Xo = {
      apply: $o.length
        ? function (e, t) {
  ...
  var hi = function (e, t, n, r) {
    ...
    if (((t ? t.ownerDocument || t : Io) !== To && Ro(t), (n = n || []), !e || "string" != typeof e)) return n;
    ...
    if (Do && !r) {
      if ((o = fi.exec(e)))
        if ((a = o[1])) {
          ...
          if (o[2]) return Xo.apply(n, t.getElementsByTagName(e)), n;
          if ((a = o[3]) && yo.getElementsByClassName) return Xo.apply(n, t.getElementsByClassName(a)), n;
        }
      if (yo.qsa && (!Oo || !Oo.test(e))) {
        if (((f = l = Lo), (d = t), (m = 9 === u && e), 1 === u && "object" !== t.nodeName.toLowerCase())) {
          for (
            c = xo(e),
            ...
            c[s] = f + Si(c[s]);
          (d = (di.test(e) && wi(t.parentNode)) || t), (m = c.join(","));
        }
        if (m)
          try {
            return Xo.apply(n, d.querySelectorAll(m)), n;
          } catch (p) {
          } finally {
  ...
  function vi() {
    var n = [];
    function r(e, t) {
      return n.push(e + " ") > bo.cacheLength && delete r[n.shift()], (r[e + " "] = t);
    }
    return r;
  }
  function yi(e) {
    ...
    return e.first
      ...
      : function (e, t, n) {
          ...
          if (n) {
            ...
            for (; (e = e[u]); )
              if (1 === e.nodeType || s) {
                if ((r = (o = e[Lo] || (e[Lo] = {}))[u]) && r[0] === Mo && r[1] === c) return (i[2] = r[2]);
      ...
      yi(function (e, t, n, r) {
        var o,
          ...
          l =
            e ||
            (function m(e, t, n) {
              for (var r = 0, o = t.length; r < o; r++) hi(e, t[r], n);
              return n;
            })(g || "*", n.nodeType ? [n] : n, []),
          f = !p || (!e && g) ? l : ki(l, u, p, n, r),
          d = h ? (y || (e ? p : c || v) ? [] : t) : f;
        if ((h && h(f, d, n, r), v))
          for (o = ki(d, s), v(o, [], n, r), i = o.length; i--; ) (a = o[i]) && (d[s[i]] = !(f[s[i]] = a));
        if (e) {
          if (y || p) {
            if (y) {
            ...
            for (i = d.length; i--; ) (a = d[i]) && -1 < (o = y ? Go.call(e, a) : u[i]) && (e[o] = !(t[o] = a));
          }
        } else (d = ki(d === t ? d.splice(c, d.length) : d)), y ? y(null, t, d, r) : Xo.apply(t, d);
      })
    );
  }
  function Ri(e) {
    for (
      ...
      if ((t = bo.relative[e[u].type])) l = [Ni(Ei(l), t)];
      else {
        if ((t = bo.filter[e[u].type].apply(null, e[u].matches))[Lo]) {
          for (n = ++u; n < o && !bo.relative[e[n].type]; n++);
          return _i(
            1 < u && Ei(l),
            1 < u && Si(e.slice(0, u - 1).concat({ value: " " === e[u - 2].type ? "*" : "" })).replace(ti, "$1"),
            t,
            u < n && Ri(e.slice(u, n)),
            n < o && Ri((e = e.slice(n))),
            n < o && Si(e)
  ...
  (yo = hi.support = {}),
    ...
    (Ro = hi.setDocument =
      function (e) {
        var t,
          s = e ? e.ownerDocument || e : Io,
          n = s.defaultView;
        return s !== To && 9 === s.nodeType && s.documentElement
          ? ((Ao = (To = s).documentElement),
            (Do = !wo(s)),
            n &&
              n !==
                (function r(e) {
            ...
            (bo.find.TAG = yo.getElementsByTagName
              ? function (e, t) {
                  if (typeof t.getElementsByTagName != Vo) return t.getElementsByTagName(e);
                }
              : function (e, t) {
                  var n,
                    r = [],
            ...
            (bo.find.CLASS =
              yo.getElementsByClassName &&
              function (e, t) {
                if (Do) return t.getElementsByClassName(e);
              }),
            (Bo = []),
            (Oo = []),
            ...
            (Ho = t
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!yo.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e === s || (e.ownerDocument === Io && Po(Io, e))
                        ? -1
                        : t === s || (t.ownerDocument === Io && Po(Io, t))
                          ? 1
                          : ko
                            ? Go.call(ko, e) - Go.call(ko, t)
                            : 0
                      : 4 & n
                        ? -1
                        : 1)
    ...
    (hi.matchesSelector = function (e, t) {
      if (
        ...
        try {
          ...
          if (n || yo.disconnectedMatch || (e.document && 11 !== e.document.nodeType)) return n;
        } catch (pE) {}
      return 0 < hi(t, To, null, [e]).length;
    }),
    (hi.contains = function (e, t) {
      return (e.ownerDocument || e) !== To && Ro(e), Po(e, t);
    }),
    ...
    (hi.uniqueSort = function (e) {
      var t,
        ...
        r = 0,
        o = 0;
      if (((_o = !yo.detectDuplicates), (ko = !yo.sortStable && e.slice(0)), e.sort(Ho), _o)) {
      ...
      function (e) {
        ...
        if (o) {
          if (1 === o || 9 === o || 11 === o) {
            ...
            for (e = e.firstChild; e; e = e.nextSibling) n += Co(e);
          } else if (3 === o || 4 === o) return e.nodeValue;
        } else for (; (t = e[r++]); ) n += Co(t);
        return n;
      }),
    ((bo = hi.selectors =
      {
        ...
        filter: {
          ...
          CLASS: function (e) {
            ...
            return (
              t ||
              ((t = new RegExp("(^|" + Jo + ")" + e + "(" + Jo + "|$)")) &&
                Uo(e, function (e) {
                  return t.test(
                    ("string" == typeof e.className && e.className) ||
                      (typeof e.getAttribute != Vo && e.getAttribute("class")) ||
                      ""
                  );
                }))
            );
            ...
            return 1 === p && 0 === g
              ...
              : function (e, t, n) {
                  ...
                  if (l) {
                    ...
                    } else if (d && (r = (e[Lo] || (e[Lo] = {}))[m]) && r[0] === Mo) a = r[1];
                    else
                      for (
                        ;
                        (i = (++u && i && i[c]) || (a = u = 0) || s.pop()) &&
          ...
          PSEUDO: function (e, i) {
            var t,
              a = bo.pseudos[e] || bo.setFilters[e.toLowerCase()] || hi.error("unsupported pseudo: " + e);
            return a[Lo]
              ? a(i)
              : 1 < a.length
                ? ((t = [e, e, "", i]),
                  bo.setFilters.hasOwnProperty(e.toLowerCase())
                    ? yi(function (e, t) {
                        for (var n, r = a(e, i), o = r.length; o--; ) e[(n = Go.call(e, r[o]))] = !(t[n] = r[o]);
                      })
                    : function (e) {
                        return a(e, 0, t);
                      })
        ...
        pseudos: {
          ...
          lang: yi(function (n) {
            return (
              ai.test(n || "") || hi.error("unsupported lang: " + n),
    ...
    (xo = hi.tokenize =
      function (e, t) {
        ...
        for (a = e, u = [], s = bo.preFilter; a; ) {
          for (i in ((n && !(r = ni.exec(a))) || (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
          (n = !1),
          (r = ri.exec(a)) &&
            ((n = r.shift()), o.push({ value: n, type: r[0].replace(ti, " ") }), (a = a.slice(n.length))),
          bo.filter))
            bo.filter.hasOwnProperty(i) &&
              (!(r = ui[i].exec(a)) ||
                (s[i] && !(r = s[i](r))) ||
    ...
    (So = hi.compile =
      function (e, t) {
        var n,
          ...
          i = jo[e + " "];
        if (!i) {
          for (n = (t = t || xo(e)).length; n--; ) (i = Ri(t[n]))[Lo] ? r.push(i) : o.push(i);
          (i = jo(
            e,
            (function a(h, v) {
              var y = 0 < v.length,
                ...
                e = function (e, t, n, r, o) {
                  ...
                  if (((s += c), y && c !== s)) {
                    ...
                    if (e) {
                      if (0 < s) for (; c--; ) l[c] || f[c] || (f[c] = Wo.call(r));
                      f = ki(f);
                    }
                    Xo.apply(r, f), o && !e && 0 < f.length && 1 < s + v.length && hi.uniqueSort(r);
                  }
                  return o && ((Mo = p), (Eo = d)), l;
                };
              return y ? yi(e) : e;
            })(o, r)
          )).selector = e;
      ...
      function (e, t, n, r) {
        ...
        if (((n = n || []), 1 === l.length)) {
          if (
            ...
            9 === t.nodeType &&
            Do &&
            bo.relative[i[1].type]
          ) {
            if (!(t = (bo.find.ID(a.matches[0].replace(pi, gi), t) || [])[0])) return n;
            c && (t = t.parentNode), (e = e.slice(i.shift().value.length));
          }
          for (o = ui.needsContext.test(e) ? 0 : i.length; o-- && ((a = i[o]), !bo.relative[(u = a.type)]); )
            if (
              (s = bo.find[u]) &&
              (r = s(a.matches[0].replace(pi, gi), (di.test(i[0].type) && wi(t.parentNode)) || t))
            ) {
              if ((i.splice(o, 1), !(e = r.length && Si(i)))) return Xo.apply(n, r), n;
              break;
            }
        }
        return (c || So(e, l))(r, t, !Do, n, (di.test(e) && wi(t.parentNode)) || t), n;
      }),
  ...
  var Ti = V.document,
    ...
    Mi = function (e, t) {
      var n, r, o;
      for (
        o = (t = t || Ti).createElement("div"), n = t.createDocumentFragment(), o.innerHTML = e;
        (r = o.firstChild);
    ...
    Fi = function (e, t, n, r) {
      var o;
      if (Ii(t)) t = Mi(t, Qi(e[0]));
      else if (t.length && !t.nodeType) {
        if (((t = na.makeArray(t)), r)) for (o = t.length - 1; 0 <= o; o--) Fi(e, t[o], n, r);
    ...
    zi = function (e, t, n) {
      ...
      return (
        ...
        e.each(function () {
          (n && r === this.parentNode) ||
            ((r = this.parentNode), (o = t.cloneNode(!1)), this.parentNode.insertBefore(o, this)),
            o.appendChild(this);
        }),
        e
      );
    ...
    Vi = { "for": "htmlFor", "class": "className", readonly: "readOnly" },
    qi = { "float": "cssFloat" },
    $i = {},
    Wi = {},
    Ki = function (e, t) {
  ...
  (Ki.fn = Ki.prototype =
    {
      ...
      init: function (e, t) {
        ...
        if (Ii(e)) {
          if (
            ...
            return na(t).find(e);
          if (n[1]) for (r = Mi(e, Qi(t)).firstChild; r; ) Ai.call(o, r), (r = r.nextSibling);
          else {
            if (!(r = Qi(t).getElementById(n[2]))) return o;
      ...
      add: function (e, t) {
        var n, r;
        if (Ii(e)) return this.add(na(e));
        if (!1 !== t)
          for (n = na.unique(this.toArray().concat(na.makeArray(e))), this.length = n.length, r = 0; r < n.length; r++)
            this[r] = n[r];
        else Ai.apply(this, na.makeArray(e));
        return this;
      },
      attr: function (t, n) {
        var e,
        ...
        if ("object" == typeof t)
          ...
          if (!Li(n)) {
            if (r[0] && 1 === r[0].nodeType) {
              if ((e = $i[t]) && e.get) return e.get(r[0], t);
              if (Hi[t]) return r.prop(t) ? t : undefined;
          ...
          this.each(function () {
            var e;
            if (1 === this.nodeType) {
              if ((e = $i[t]) && e.set) return void e.set(this, n);
      ...
      prop: function (e, t) {
        ...
        if ("object" == typeof (e = Vi[e] || e))
          ...
          if (!Li(t)) return n[0] && n[0].nodeType && e in n[0] ? n[0][e] : t;
          this.each(function () {
      ...
      css: function (n, r) {
        ...
        if ("object" == typeof n)
          ...
          if (((e = i[0]), (o = Wi[n]) && o.get)) return o.get(e);
      ...
      remove: function () {
        for (var e, t = this.length; t--; ) (e = this[t]), Bi.clean(e), e.parentNode && e.parentNode.removeChild(e);
        return this;
      },
      empty: function () {
      ...
      appendTo: function (e) {
        return na(e).append(this), this;
      },
      prependTo: function (e) {
        return na(e).prepend(this), this;
      },
      ...
      find: function (e) {
        var t,
          n,
          r = [];
        for (t = 0, n = this.length; t < n; t++) na.find(e, this[t], r);
        return na(r);
      },
      filter: function (n) {
        return na(
          "function" == typeof n
            ? Ji(this.toArray(), function (e, t) {
                return n(t, e);
              })
        ...
        return e
          ...
          : ((t = this[0]) &&
              ...
              t.getBoundingClientRect &&
                ((i = (o = t.getBoundingClientRect()).left + (r.scrollLeft || n.body.scrollLeft) - r.clientLeft),
  ...
  var Zi = function (e, t, n) {
      ...
      for ("string" != typeof n && n instanceof na && (n = n[0]); o && 9 !== o.nodeType; ) {
        if (n !== undefined) {
          if (o === n) break;
          if ("string" == typeof n && na(o).is(n)) break;
        }
    ...
    ea = function (e, t, n, r) {
      ...
      for (r instanceof na && (r = r[0]); e; e = e[t])
        if (!n || e.nodeType === n) {
          if (r !== undefined) {
            if (e === r) break;
            if ("string" == typeof r && na(e).is(r)) break;
          }
          o.push(e);
        }
      return o;
    ...
    function (r, o) {
      Ki.fn[r] = function (t) {
        ...
        this.each(function () {
          ...
          1 < this.length && (Pi[r] || (n = na.unique(n)), 0 === r.indexOf("parents") && (n = n.reverse()));
        var e = na(n);
      ...
      function (o, i) {
        Ki.fn[o] = function (t, e) {
          ...
          this.each(function () {
            ...
            1 < this.length &&
              ((n = na.unique(n)), (0 !== o.indexOf("parents") && "prevUntil" !== o) || (n = n.reverse()));
          var r = na(n);
  ...
  function pa(a, u) {
    ...
    var r = {},
      ...
      o = {},
      t = 0,
      e = vr(a, { contentCssCors: u.contentCssCors, referrerPolicy: u.referrerPolicy }),
      f = [],
      d = u.schema ? u.schema : no({}),
      i = ao({ url_converter: u.url_converter, url_converter_scope: u.url_converter_scope }, u.schema),
      m = u.ownEvents ? new ho() : ho.Event,
      n = d.getBlockElements(),
      p = na.overrideDefaults(function () {
        return { context: a, element: H.getRoot() };
      }),
      g = function (e) {
      ...
      I = function (t, e, n) {
        return _(e, function (e) {
          return (
            hr.is(e, "array") && (t = t.cloneNode(!0)),
            n &&
              aa(ua(e.childNodes), function (e) {
                t.appendChild(e);
              }),
      ...
      U = function (e, t, n, r) {
        if (hr.isArray(e)) {
          for (var o = e.length, i = []; o--; ) i[o] = U(e[o], t, n, r);
          return i;
        }
        return !u.collect || (e !== a && e !== l) || f.push([e, t, n, r]), m.bind(e, t, n, r || H);
      },
      z = function (e, t, n) {
        var r;
        if (hr.isArray(e)) {
          r = e.length;
          for (var o = []; r--; ) o[r] = z(e[r], t, n);
          return o;
        }
      ...
      H = {
        ...
        root                    : null,
        clone: function (t, e) {
          if (!sa || 1 !== t.nodeType || e) return t.cloneNode(e);
        ...
        getRect: function (e) {
          var t, n;
          return (e = g(e)), (t = w(e)), (n = S(e)), { x: t.x, y: t.y, w: n.w, h: n.h };
        },
        getSize                 : S,
        ...
        isEmpty: function (e, t) {
          ...
          if ((e = e.firstChild)) {
            ...
            do {
              ...
              if (8 === n) return !1;
              if (3 === n && !la.test(e.nodeValue)) return !1;
              if (3 === n && e.parentNode && a[e.parentNode.nodeName] && la.test(e.nodeValue)) return !1;
              e = i.next();
            } while (e);
          }
          return o <= 1;
  ...
  ((ia = pa = pa || {}).DOM = ia(V.document)), (ia.nodeIndex = ma);
  var ga = pa,
    ha = ga.DOM,
    va = hr.each,
    ya = hr.grep,
    ba =
      ((Ca.prototype._setReferrerPolicy = function (e) {
      ...
      (Ca.prototype.loadScript = function (e, t, n) {
        ...
        (o = i.uniqueId()),
          ...
          (r.onerror = function () {
            D(n)
              ? n()
              : "undefined" != typeof V.console && V.console.log && V.console.log("Failed to load script: " + e);
          }),
        ...
        !1 !== _a.languageLoad &&
          e(
            ...
            function () {
              ...
              !e ||
                (n && -1 === ("," + (n || "") + ",").indexOf("," + e + ",")) ||
                ba.ScriptLoader.add(s[t] + "/langs/" + e + ".js");
            },
            "loaded"
          );
      },
  ...
  ((wa = _a = _a || {}).PluginManager = wa()), (wa.ThemeManager = wa());
  var Ra = _a,
    Ta = function (n, r) {
      var o = null;
      return {
    ...
    Ba = function (e, t) {
      return (o = t), (i = Da((n = e), (r = "class")).concat([o])), cn(n, r, i.join(" ")), !0;
      var n, r, o, i;
    },
    Pa = function (e, t) {
      return (
    ...
    Fa = function (e, t) {
      ...
      return (
        z(ht(e), function (e) {
          t(e) && (n = n.concat([e])), (n = n.concat(Fa(e, t)));
        }),
        n
      );
    },
    Ua = function (e, t) {
      return (
        (n = t), (o = (r = e) === undefined ? V.document : r.dom()), it(o) ? [] : U(o.querySelectorAll(n), Ne.fromDom)
      );
      var n, r, o;
    };
  ...
  var ja,
    ...
    Ka = x("mce-annotation"),
    Xa = x("data-mce-annotation"),
    Ya = x("data-mce-annotation-uid"),
    Ga = function (r, e) {
      var t = r.selection.getRng(),
        ...
        s = function (e, t) {
          return (n = t), (r = e.dom()) && r.hasAttribute && r.hasAttribute(n) ? R.some(fn(e, t)) : R.none();
          var n, r;
        };
    ...
    Qa = function (i, e) {
      var a = xa({}),
        ...
        u = function (e, t) {
          var n = a.get(),
            r = t(n.hasOwnProperty(e) ? n[e] : { listeners: [], previous: xa(R.none()) });
          (n[e] = r), a.set(n);
        },
        t = Aa(function () {
          var e,
            ...
            n,
            r = a.get(),
            o = ((e = ne(r)), (n = B.call(e, 0)).sort(t), n);
          z(o, function (e) {
            u(e, function (u) {
    ...
    nu = function (e, t) {
      var n,
        r,
        o = ct(e).dom(),
        i = Ne.fromDom(o.createDocumentFragment()),
        a = ((n = t), ((r = (o || V.document).createElement("div")).innerHTML = n), ht(Ne.fromDom(r)));
      Nt(i, a), Et(e), St(e, i);
    },
    ru = function (e, t) {
    ...
    bu = function (e, t, n) {
      ...
      return (
        ...
        r.appendChild(((i = V.document.createElement("br")).setAttribute("data-mce-bogus", "1"), i)),
        (o = t.parentNode),
    ...
    Eu = rn,
    ku = Zt,
    _u = Wt(["script", "style", "textarea"]),
    Ru = Wt(["img", "input", "textarea", "hr", "iframe", "video", "audio", "object"]),
    Tu = Wt(["table"]),
    Au = gu,
    Du = function (e) {
    ...
    Iu = function (e, t) {
      return (e = Lu(e)), t || (e.left = e.left + e.width), (e.right = e.left), (e.width = 0), e;
    },
    Mu = function (e, t, n) {
    ...
    Wu = $t,
    Ku = Du,
    Xu = Kt("display", "block table"),
    Yu = Kt("float", "left right"),
    Gu = (function () {
    ...
    Ju = m(Kt("white-space", "pre pre-line pre-wrap")),
    Qu = Zt,
    Zu = rn,
    es = ga.nodeIndex,
    ts = Hu,
    ...
    is = function (e) {
      var t,
        n = e.startContainer,
        r = e.startOffset;
      return !!(rs(e.toString()) && Ju(n.parentNode) && Zt(n) && ((t = n.data), rs(t[r - 1]) || rs(t[r + 1])));
    },
    as = function (e) {
    ...
    us = function (e) {
      var t, n, r, o, i, a, u, s;
      return (
        (t = 0 < (n = e.getClientRects()).length ? Lu(n[0]) : Lu(e.getBoundingClientRect())),
        !os(e) && Zu(e) && as(t)
          ? ((i = (r = e).ownerDocument),
            (a = ns(i)),
        ...
        o = function (e) {
          ...
          0 !== e.height &&
            ((0 < r.length &&
              ((t = e),
              (n = r[r.length - 1]),
              t.left === n.left && t.top === n.top && t.bottom === n.bottom && t.right === n.right)) ||
              r.push(e));
        },
        i = function (e, t) {
          ...
          if (t < e.data.length) {
            ...
            if (qu(e.data[t - 1]) && (n.setStart(e, t), n.setEnd(e, t + 1), !is(n))) return o(ss(us(n), !1)), r;
          }
          0 < t && (n.setStart(e, t - 1), n.setEnd(e, t), is(n) || o(ss(us(n), !1))),
            t < e.data.length && (n.setStart(e, t), n.setEnd(e, t + 1), is(n) || o(ss(us(n), !0)));
        };
      if (Qu(e.container())) return i(e.container(), e.offset()), r;
      if (Wu(e.container()))
        if (e.isAtEnd())
          (n = ts(e.container(), e.offset())), Qu(n) && i(n, n.data.length), Gu(n) && !Zu(n) && o(ss(us(n), !1));
        else {
          if (((n = ts(e.container(), e.offset())), Qu(n) && i(n, 0), Gu(n) && e.isAtEnd())) return o(ss(us(n), !1)), r;
  ...
  function ls(t, n, e) {
    ...
    return {
      ...
      toRange: function () {
        var e;
        return (e = ns(t.ownerDocument)).setStart(t, n), e.setEnd(t, n), e;
      },
      getClientRects: r,
      isVisible: function () {
        return 0 < r().length;
  ...
  var fs,
    ...
    ys = function (e) {
      return e
        ? cr(
            e.childNodes,
            function (e, t) {
              return gs(t) && "BR" !== t.nodeName ? (e = e.concat(ys(t))) : e.push(t), e;
            },
            []
          )
        : [];
          ...
          (r = cr(
            ...
            ? ps(r)
              ? (function (e, t) {
                  ...
                  return ps(e) && t > e.data.length && (t = e.data.length), ms(e, t);
                })(r, parseInt(o, 10))
              : ((o = "after" === o ? hs(r) + 1 : hs(r)), ms(r.parentNode, o))
            : null)
        : null;
    },
    Ss = function (e, t) {
    ...
    Ns = function (e, t, n) {
      ...
      nn(n)
        ...
        : ((r = e), (o = n), t.insertNode(o), Ss(r, o.previousSibling), Ss(r, o.nextSibling));
    },
    Es = an,
        ...
        Zt(a)
          ? s.push(
              n
                ? (function (e, t, n) {
                    var r, o;
                    for (o = e(t.data.slice(0, n)).length, r = t.previousSibling; r && Zt(r); r = r.previousSibling)
                      o += e(r.data).length;
                    return o;
                  })(t, a, u)
                : u
            )
          : (u >= (i = a.childNodes).length && i.length && ((c = 1), (u = Math.max(0, i.length - 1))),
    ...
    Ts = function (e) {
      return Rs(e, !0), Rs(e, !1), e;
    },
    As = function (e, t) {
      var n;
      if ($t(e) && ((e = Hu(e, t)), Es(e))) return e;
      if (gu(e)) {
        if ((Zt(e) && mu(e) && (e = e.parentNode), (n = e.previousSibling), Es(n))) return n;
        if (((n = e.nextSibling), Es(n))) return n;
      }
    },
    Ds = function (e, t, n) {
      var r = n.getNode(),
        o = r ? r.nodeName : null,
        i = n.getRng();
      if (Es(r) || "IMG" === o) return { name: o, index: _s(n.dom, o, r) };
      var a,
        u,
        s,
        c,
        ...
        f,
        d,
        m = As((a = i).startContainer, a.startOffset) || As(a.endContainer, a.endOffset);
      return m
        ? { name: (o = m.tagName), index: _s(n.dom, o, m) }
        : ((u = e),
          (c = t),
          (l = i),
          (f = (s = n).dom),
    ...
    Bs = function (e, t) {
      var n = e.dom,
        ...
        a = e.getNode(),
        u = a.nodeName;
      if ("IMG" === u) return { name: u, index: _s(n, u, a) };
      ...
      return Ns(n, r, l), e.moveToBookmark({ id: o, keep: !0 }), { id: o };
    },
    Ps = function (e, t, n) {
      return 2 === t
        ? Ds(lu, n, e)
        : 3 === t
          ? ((o = (r = e).getRng()),
            { start: ws(r.dom.getRoot(), ms.fromRangeStart(o)), end: ws(r.dom.getRoot(), ms.fromRangeEnd(o)) })
          : t
            ? { rng: e.getRng() }
            : Bs(e, !1);
      var r, o;
    ...
    tc = function (e, t) {
      return Ys(e) && t.container() === e
        ? ((r = t),
          (o = Qs((n = e).data.substr(0, r.offset()))),
          (i = Qs(n.data.substr(r.offset()))),
          0 < (a = o.text + i.text).length ? (Js(n, a), ms(n, r.offset() - o.count)) : r)
        : Zs(e, t);
      var n, r, o, i, a;
    },
    nc = function (e, t) {
      return ms.isTextPosition(t) ? tc(e, t) : ((n = e), ((r = t).container() === n.parentNode ? ec : Zs)(n, r));
      var n, r;
    },
    rc = function (e) {
      if ((Xs(e) && gu(e) && (hu(e) ? e.removeAttribute("data-mce-caret") : Gs(e)), Ys(e))) {
        var t = lu(
          (function (e) {
            try {
              return e.nodeValue;
    ...
    ac = function (e, t, n) {
      ...
      return (
        (i =
          "BODY" === e.tagName
            ? ((r = e.ownerDocument.documentElement), (o = e.scrollLeft || r.scrollLeft), e.scrollTop || r.scrollTop)
            : ((u = e.getBoundingClientRect()), (o = e.scrollLeft - u.left), e.scrollTop - u.top)),
        (s.left += o),
        (s.right += o),
        (s.top += i),
        (s.bottom += i),
    ...
    uc = function (e, a, u, t) {
      var n,
        ...
        f = function () {
          !(function (e) {
            var t, n, r, o, i;
            for (t = Ua(Ne.fromDom(e), "*[contentEditable=false]"), o = 0; o < t.length; o++)
            ...
            c.get().each(function (e) {
              na(e.caret).remove(), c.set(R.none());
            }),
            n && (Xn.clearInterval(n), (n = null));
        },
        d = function () {
          n = Xn.setInterval(function () {
            t()
              ? na("div.mce-visual-caret", a).toggleClass("mce-visual-caret-hidden")
              : na("div.mce-visual-caret", a).addClass("mce-visual-caret-hidden");
          }, 500);
        };
      return {
        show: function (t, e) {
          var n, r, o;
          if ((f(), $t((o = e)) && /^(TD|TH)$/i.test(o.tagName))) return null;
          if (!u(e))
            return (
              (s = (function (e, t) {
                var n, r, o;
                if (((r = e.ownerDocument.createTextNode(su)), (o = e.parentNode), t)) {
                  if (((n = e.previousSibling), du(n))) {
                    if (gu(n)) return n;
                    if (wu(n)) return n.splitText(n.data.length - 1);
                  }
                  o.insertBefore(r, e);
                } else {
                  if (((n = e.nextSibling), du(n))) {
                    if (gu(n)) return n;
                    if (Cu(n)) return n.splitText(1), n;
                  }
              ...
              ic(s.nextSibling) ? (r.setStart(s, 0), r.setEnd(s, 0)) : (r.setStart(s, 1), r.setEnd(s, 1)),
              r
            );
          (s = bu(l, e, t)), (n = ac(a, e, t)), na(s).css("top", n.top);
          var i = na('<div class="mce-visual-caret" data-mce-bogus="all"></div>').css(n).appendTo(a)[0];
          return (
            c.set(R.some({ caret: i, element: e, before: t })),
            c.get().each(function (e) {
    ...
    lc = an,
    fc = Kt("display", "block table table-cell table-caption list-item"),
    dc = gu,
    mc = mu,
    pc = $t,
    gc = Du,
    hc = function (e, t) {
      for (var n; (n = e(t)); ) if (!mc(n)) return n;
      return null;
    },
    vc = function (e, t, n, r, o) {
      var i = new ra(e, r);
      if (t < 0) {
        if ((lc(e) || mc(e)) && n((e = hc(i.prev, !0)))) return e;
        for (; (e = hc(i.prev, o)); ) if (n(e)) return e;
      }
      if (0 < t) {
        if ((lc(e) || mc(e)) && n((e = hc(i.next, !0)))) return e;
        for (; (e = hc(i.next, o)); ) if (n(e)) return e;
      }
      return null;
    },
    yc = function (e, t) {
    ...
    Cc = function (e, t) {
      var n, r;
      return t ? ((n = t.container()), (r = t.offset()), pc(n) ? n.childNodes[r + e] : null) : null;
    },
    wc = function (e, t) {
    ...
    xc = function (e, t, n) {
      ...
      for (o = e ? "previousSibling" : "nextSibling"; n && n !== t; ) {
        if (((r = n[o]), dc(r) && (r = r[o]), lc(r))) {
          if (((a = n), yc(r, (i = t)) === yc(a, i))) return r;
          break;
        }
        if (gc(r)) break;
        n = n.parentNode;
    ...
    Ec = function (e, t, n) {
      var r,
        ...
        u = N(xc, !0, t),
        s = N(xc, !1, t);
      if (((o = n.startContainer), (i = n.startOffset), mu(o))) {
        if (
          (pc(o) || (o = o.parentNode),
          "before" === (a = o.getAttribute("data-mce-caret")) && ((r = o.nextSibling), cc(r)))
        )
          return Sc(r);
        if ("after" === a && ((r = o.previousSibling), cc(r))) return Nc(r);
      }
      if (!n.collapsed) return n;
      if (Zt(o)) {
        if (dc(o)) {
          if (1 === e) {
            if ((r = s(o))) return Sc(r);
            if ((r = u(o))) return Nc(r);
          }
          if (-1 === e) {
            if ((r = u(o))) return Nc(r);
            if ((r = s(o))) return Sc(r);
        ...
        if (wu(o) && i >= o.data.length - 1) return 1 === e && (r = s(o)) ? Sc(r) : n;
        if (Cu(o) && i <= 1) return -1 === e && (r = u(o)) ? Nc(r) : n;
        if (i === o.data.length) return (r = s(o)) ? Sc(r) : n;
        if (0 === i) return (r = u(o)) ? Nc(r) : n;
      }
      return n;
    },
    kc = function (e, t) {
  ...
  ((ds = fs = fs || {})[(ds.Backwards = -1)] = "Backwards"), (ds[(ds.Forwards = 1)] = "Forwards");
  var Dc,
    Oc = an,
    Bc = Zt,
    Pc = $t,
    ...
    zc = function (e, t) {
      if (0 < e) {
        if (Ic(t.previousSibling) && !Bc(t.previousSibling)) return ms.before(t);
        if (Bc(t)) return ms(t, 0);
      }
      if (e < 0) {
        if (Ic(t.nextSibling) && !Bc(t.nextSibling)) return ms.after(t);
        if (Bc(t)) return ms(t, t.data.length);
      }
      return !(e < 0) || Lc(t) ? ms.before(t) : ms.after(t);
    },
    jc = function (e, t, n) {
      var r, o, i, a, u;
      if (!Pc(n) || !t) return null;
      if (t.isEqual(ms.after(n)) && n.lastChild) {
        if (((u = ms.after(n.lastChild)), e < 0 && Ic(n.lastChild) && Pc(n.lastChild)))
      ...
      var s,
        ...
        d = u.offset();
      if (Bc(f)) {
        if (e < 0 && 0 < d) return ms(f, --d);
        if (0 < e && d < f.length) return ms(f, ++d);
        r = f;
      } else {
        if (e < 0 && 0 < d && ((o = Uc(f, d - 1)), Ic(o)))
          return !Mc(o) && (i = vc(o, e, Fc, o))
            ? Bc(i)
              ? ms(i, i.data.length)
              : ms.after(i)
            : Bc(o)
              ? ms(o, o.data.length)
              : ms.before(o);
        if (0 < e && d < f.childNodes.length && ((o = Uc(f, d)), Ic(o)))
          return Lc(o)
            ? ((s = n),
              (l = (c = o).nextSibling) && Ic(l) ? (Bc(l) ? ms(l, 0) : ms.before(l)) : jc(fs.Forwards, ms.after(c), s))
            : !Mc(o) && (i = vc(o, e, Fc, o))
              ? Bc(i)
                ? ms(i, 0)
                : ms.before(i)
      ...
      return ((0 < e && u.isAtEnd()) || (e < 0 && u.isAtStart())) && ((r = vc(r, e, x(!0), n, !0)), Fc(r, n))
        ? zc(e, r)
        : ((o = vc(r, e, Fc, n)),
          !(a = fr(
            H(
    ...
    Wc = function (e, t, n) {
      return e
        ? !$c(t, n) && ((r = t), !(!ms.isTextPosition(r) && rn(r.getNode()))) && qc(t) && Vc(n)
        : !$c(n, t) && Vc(t) && qc(n);
      var r;
    },
    Kc = function (e, t, n) {
    ...
    Gc = function (e, t) {
      ...
      return Zt(u)
        ? R.some(ms(u, e ? 0 : u.data.length))
        : u
          ? Du(u)
            ? R.some(e ? ms.before(u) : rn((a = u)) ? ms.before(a) : ms.after(a))
            : ((r = t), (o = u), (i = (n = e) ? ms.before(o) : ms.after(o)), Kc(n, r, i))
          : R.none();
    },
    Jc = N(Kc, !0),
    Qc = N(Kc, !1),
    ...
    el = N(Gc, !1),
    tl = function (e, t) {
      return $t(t) && e.isBlock(t) && !t.innerHTML && !rr.ie && (t.innerHTML = '<br data-mce-bogus="1" />'), t;
    },
    nl = function (e, t) {
      return el(e).fold(
        function () {
    ...
    ol = function (e, t, n, r) {
      ...
      if (s) {
        for (a = s[0], i = c, o = s.length - 1; 1 <= o; o--) {
          if (((u = i.childNodes), rl(c, i, r))) return !0;
          if (s[o] > u.length - 1) return !!rl(c, i, r) || nl(i, r);
          i = u[s[o]];
        }
      ...
      if (c) {
        if (
          ...
          a &&
            ...
            Zt(a) &&
            !rr.opera &&
            ((o = a.nodeValue.length), a.appendData(i.nodeValue), e.remove(i), (s = ((u = a), o)));
        }
    ...
    ul = function (e, t) {
      var n,
        ...
        h = e.dom;
      if (t) {
        if (((g = t), hr.isArray(g.start)))
          return (m = t), (p = (d = h).createRng()), ol(d, !0, m, p) && ol(d, !1, m, p) ? R.some(p) : R.none();
        ...
        if (t.hasOwnProperty("rng")) return R.some(t.rng);
      }
      return R.none();
    },
    sl = function (e, t, n) {
      ...
      if (
        ...
        for (
          u < (i = s.childNodes).length
            ? ((s = i[u]), (r = new ra(s, e.getParent(s, e.isBlock))))
            : ((s = i[i.length - 1]), (r = new ra(s, e.getParent(s, e.isBlock))).next(!0)),
            o = r.current();
          o;
          o = r.next()
        )
          if (3 === o.nodeType && !bl(o)) return n.setStart(o, 0), void t.setRng(n);
    },
    hl = function (e, t, n) {
      if (e) {
        var r = t ? "nextSibling" : "previousSibling";
        for (e = n ? e : e[r]; e; e = e[r]) if (1 === e.nodeType || !bl(e)) return e;
      }
    },
    vl = function (e, t) {
      return pl(t) && (t = t.nodeName), !!e.schema.getTextBlockElements()[t.toLowerCase()];
    },
    yl = function (e, t, n) {
    ...
    Dl = function (e, t) {
      for (var n = t; n; ) {
        if ($t(n) && e.getContentEditable(n)) return "false" === e.getContentEditable(n) ? n : t;
        n = n.parentNode;
      }
      return t;
    },
    ...
    Ll = function (i, e, t, n, a, r) {
      ...
      return o(t, n, Bl)
        ...
        .orThunk(function () {
          return u ? R.some({ container: u, offset: a ? 0 : u.length }) : R.none();
        });
    },
    ...
    Ml = function (t, e, n, r) {
      ...
      if ((o && e[0].wrapper && (o = Rl(i, o, "ul,ol").reverse()[0] || o), !o))
        for (o = n; o[r] && !i.isBlock(o[r]) && ((o = o[r]), !wl(o, "br")); );
      return o || n;
    },
    ...
    Ul = function (e, t, n, r) {
      ...
      var o = t.startContainer,
        ...
        u = t.endOffset,
        s = e.dom;
      $t(o) && o.hasChildNodes() && ((o = Hu(o, i)), Zt(o) && (i = 0)),
        $t(a) && a.hasChildNodes() && ((a = Hu(a, t.collapsed ? u : u - 1)), Zt(a) && (u = a.nodeValue.length)),
        (o = Dl(s, o)),
        (a = Dl(s, a)),
        (_l(o.parentNode) || _l(o)) &&
          ((o = _l(o) ? o : o.parentNode),
          (o = t.collapsed ? o.previousSibling || o : o.nextSibling || o),
          Zt(o) && (i = t.collapsed ? o.length : 0)),
        (_l(a.parentNode) || _l(a)) &&
          ((a = _l(a) ? a : a.parentNode),
          (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a),
          Zt(a) && (u = t.collapsed ? 0 : a.length)),
        t.collapsed &&
          (Ll(s, e.getBody(), o, i, !0, r).each(function (e) {
            var t = e.container,
              n = e.offset;
            (o = t), (i = n);
          }),
      ...
      return (
        (n[0].inline || n[0].block_expand) &&
          ((n[0].inline && Zt(o) && 0 !== i) || (o = Fl(s, n, o, i, a, u, !0)),
          (n[0].inline && Zt(a) && u !== a.nodeValue.length) || (a = Fl(s, n, o, i, a, u, !1))),
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
          ((o = Il(s, n, t, o, "previousSibling")), (a = Il(s, n, t, a, "nextSibling"))),
        (n[0].block || n[0].selector) &&
          ((o = Ml(e, n, o, "previousSibling")),
          (a = Ml(e, n, a, "nextSibling")),
          n[0].block &&
            (s.isBlock(o) || (o = Fl(s, n, o, i, a, u, !0)), s.isBlock(a) || (a = Fl(s, n, o, i, a, u, !1)))),
        $t(o) && ((i = s.nodeIndex(o)), (o = o.parentNode)),
        $t(a) && ((u = s.nodeIndex(a) + 1), (a = a.parentNode)),
    ...
    jl = function (e, t, u) {
      var n = t.startContainer,
        ...
        s = function (e) {
          var t;
          return (
            3 === (t = e[0]).nodeType && t === n && r >= t.nodeValue.length && e.splice(0, 1),
            (t = e[e.length - 1]),
      ...
      if (
        (1 === n.nodeType && n.hasChildNodes() && (n = zl(n, r)),
    ...
    Xl = function (o, e) {
      return $u(
        ...
        (u = i.startOffset),
        Zt(a) ? (0 === u ? R.some(Ne.fromDom(a)) : R.none()) : R.from(a.childNodes[u]).map(Ne.fromDom)),
        ((n = (t = e).endContainer),
        (r = t.endOffset),
        Zt(n) ? (r === n.data.length ? R.some(Ne.fromDom(n)) : R.none()) : R.from(n.childNodes[r - 1]).map(Ne.fromDom)),
        function (e, t) {
          var n = K(Wl(o), N(at, e)),
            r = K(Kl(o), N(at, t));
  ...
  var Zl = (function gE(n, r) {
    ...
    tf = function (r, o, i, a) {
      return ft(o).fold(
        ...
        function (e) {
          return "br" === a || (Ot((n = o)) && ef(n) === ro)
            ? "valid"
            : Dt((t = o)) && Ma(t, Ka())
              ? "existing"
              : Ms(o)
                ? "caret"
                : yl(r, i, a) && yl(r, Rt(e), i)
                  ? "valid"
                  : "invalid-child";
          var t, n;
        }
          ...
          switch (tf(i, e, "span", Rt(e))) {
            ...
            case "valid":
              var o = s.get().getOrThunk(function () {
                var e = ou(u);
                return a.push(e), s.set(R.some(e)), e;
              });
              Ct((t = e), (n = o)), St(n, t);
          }
        };
      return (
        jl(i.dom, e, function (e) {
          var t;
          c(), (t = U(e, Ne.fromDom)), l(t);
        }),
        a
      );
    },
    of = function (u, s, c, l) {
      u.undoManager.transact(function () {
        ...
        if (
          ...
          nu(a, oo), r.getRng().insertNode(a.dom()), r.select(a.dom());
        } else
          Ql(r, !1, function () {
            Jl(u, function (e) {
    ...
    uf = /^[ \t\r\n]*$/,
    sf = { "#text": 3, "#comment": 8, "#cdata": 4, "#pi": 7, "#doctype": 10, "#document-fragment": 11 },
    cf = function (e, t, n) {
    ...
    df =
      ...
      (mf.prototype.append = function (e) {
        ...
        return (
          t ? (((t.next = e).prev = t), (this.lastChild = e)) : (this.lastChild = this.firstChild = e),
          (e.parent = this),
          e
        );
      }),
      ...
      (mf.prototype.getAll = function (e) {
        for (var t = [], n = this.firstChild; n; n = cf(n, this)) n.name === e && t.push(n);
        return t;
      }),
      ...
      (mf.prototype.isEmpty = function (e, t, n) {
        ...
        if (r)
          do {
            ...
            if (3 === r.type && !lf(r)) return !1;
            if (3 === r.type && r.parent && t[r.parent.name] && uf.test(r.value)) return !1;
            if (n && n(r)) return !1;
          } while ((r = cf(r, this)));
        return !0;
      }),
      ...
      return (
        ...
        (f = "html" === e.element_format),
        {
          start: function (e, t, n) {
            var r, o, i, a;
            if (
              (u && s[e] && 0 < d.length && 0 < (a = d[d.length - 1]).length && "\n" !== a && d.push("\n"),
              d.push("<", e),
              t)
            )
          ...
          var m = function (e) {
            ...
            if (l) l(e);
              ...
              if (
                ...
                (n = e.shortEnded),
                (r = e.attributes),
                d && r && 1 < r.length && (((a = []).map = {}), (c = p.getElementRule(e.name))))
              ) {
                ...
                for (u = 0, s = r.length; u < s; u++)
                  (o = r[u].name) in a.map || ((i = r.map[o]), (a.map[o] = i), a.push({ name: o, value: i }));
                r = a;
              }
    ...
    var X = W.comment ? W.comment : e,
      ...
      n = function (m, e) {
        ...
        var t,
          ...
          P = 0,
          L = $r.decode,
          I = hr.makeMap("src,href,data,background,formaction,poster,xlink:href"),
          M = /((java|vb)script|mhtml):/i,
          F = "html" === e ? 0 : 1,
          U = function (e) {
            var t, n;
            for (t = B.length; t-- && B[t].name !== e; );
            if (0 <= t) {
              for (n = B.length - 1; t <= n; n--) (e = B[n]).valid && Q(e.name);
              B.length = t;
            }
          },
          z = function (e, t) {
          ...
          H = function (e, t) {
            ...
            return (e = D.substr(t, o - t)), j(r ? n + e : e), o + 1;
          },
            ...
            if (I[t] && !W.allow_script_urls) {
              ...
              if (
                ...
                !(c = W).allow_html_data_urls &&
                  (/^data:image\//i.test(l)
                    ? !1 === c.allow_svg_data_urls && /^data:image\/svg\+xml/i.test(l)
                    : /^data:/i.test(l)))
              )
                return;
            }
            (g && (t in I || 0 === t.indexOf("on"))) || ((p.map[t] = n), p.push({ name: t, value: n }));
          };
        for (
          k = new RegExp(
          ...
          var q = t[0];
          if ((O < t.index && z(L(D.substr(O, t.index - O))), (n = t[7])))
            ":" === (n = n.toLowerCase()).charAt(0) && (n = n.substr(1)), U(n);
          else if ((n = t[8])) {
            if (t.index + q.length > D.length) {
              z(L(D.substr(t.index))), (O = t.index + q.length);
              continue;
            }
            ...
            if (null !== $) {
              if ("all" === $) {
                (O = yf(K, D, k.lastIndex)), (k.lastIndex = O);
                continue;
              }
              f = !1;
            }
            if (!v || (l = K.getElementRule(n))) {
              if (
                ((f = !0),
                v && ((b = l.attributes), (C = l.attributePatterns)),
                (y = t[9])
                  ? ((g = -1 !== y.indexOf("data-mce-type")) && u && (f = !1), ((p = []).map = {}), y.replace(_, V))
                  : ((p = []).map = {}),
                v && !g)
              ) {
                if (
                  ((w = l.attributesRequired),
                  ...
                  for (o = S.length; o--; )
                    (a = (d = S[o]).name),
                      ...
                      (p.map[a] = T),
                      p.push({ name: a, value: T });
                if (x)
                  for (o = x.length; o--; )
                    (a = (d = x[o]).name) in p.map ||
                      ("{$uid}" === (T = d.value) && (T = "mce_" + P++), (p.map[a] = T), p.push({ name: a, value: T }));
                if (w) {
            ...
            if ((r = R[n])) {
              (r.lastIndex = O = t.index + q.length),
                (O = (t = r.exec(D))
                  ? (f && (i = D.substr(O, t.index - O)), t.index + t[0].length)
                  : ((i = D.substr(O)), D.length)),
                f && (0 < i.length && z(i, !0), Q(n)),
                (k.lastIndex = O);
              continue;
            }
            c || (y && y.indexOf("/") === y.length - 1 ? f && Q(n) : B.push({ name: n, valid: f }));
          } else if ((n = t[1])) j(n);
          else if ((n = t[2])) {
            if (!(1 == F || W.preserve_cdata || (0 < B.length && K.isValidChild(B[B.length - 1].name, "#cdata")))) {
              (O = H("", t.index + 2)), (k.lastIndex = O);
              continue;
            }
            Y(n);
          } else if ((n = t[3])) ee(n);
            ...
            if ((n = t[4]) || "<!" === q) {
              (O = H(n, t.index + q.length)), (k.lastIndex = O);
              continue;
            }
            if ((n = t[5])) {
              if (1 != F) {
        ...
        for (O < D.length && z(L(D.substr(O))), o = B.length - 1; 0 <= o; o--) (n = B[o]).valid && Q(n.name);
      };
    return {
      parse: function (e, t) {
        void 0 === t && (t = "html"),
          n(
            (function (e) {
              for (
                var t, n = /data:[^;]+;base64,([a-z0-9\+\/=]+)/gi, r = [], o = {}, i = tu("img"), a = 0, u = 0;
                (t = n.exec(e));
              ...
              return 0 === a
                ...
                : (a < e.length && r.push(e.substr(a)), { prefix: i, uris: o, html: r.join("") });
            })(e),
            t
          );
      },
  ...
  var wf,
    ...
    Tf = function (e, t, n, r) {
      ...
      else if ("text" === t.format) o = lu(r.innerText || r.textContent);
      else {
      ...
      return (
        "text" === t.format || Or(Ne.fromDom(r)) ? (t.content = o) : (t.content = hr.trim(o)),
    ...
    $f = function (e, t) {
      var n,
        ...
        i = Ne.fromDom(e),
        a = Ne.fromDom(t);
      return (n = a), (r = "pre,code"), (o = N(at, i)), qa(n, r, o).isSome();
    },
    Wf = function (e, t) {
      return (
        (Du(t) && !1 === ((r = e), Zt((o = t)) && /^[ \t\r\n]*$/.test(o.data) && !1 === $f(r, o))) ||
        ($t((n = t)) && "A" === n.nodeName && n.hasAttribute("name")) ||
        Kf(t)
      );
      var n, r, o;
    },
    Kf = Xt("data-mce-bookmark"),
    Xf = Xt("data-mce-bogus"),
    Yf =
      ((wf = "data-mce-bogus"),
      (xf = "all"),
      function (e) {
    ...
    Jf = function (e) {
      var t = Ua(e, "br"),
        n = H(
          (function (e) {
            for (var t = [], n = e.dom(); n; ) t.push(Ne.fromDom(n)), (n = n.lastChild);
            return t;
          })(e).slice(-1),
          Er
        );
    ...
    Qf = function (e) {
      Et(e), St(e, Ne.fromHtml('<br data-mce-bogus="1">'));
    },
    Zf = function (n) {
    ...
    id = function (e, t) {
      return (
        ...
        (o = (n = t).container()),
        (i = n.offset()),
        !1 === ms.isTextPosition(n) && o === r.parentNode && i > ms.before(r).offset()
          ? ms(t.container(), t.offset() - 1)
          : t
      );
      var n, r, o, i;
    },
    ad = function (e) {
      return Du(e.previousSibling)
        ? R.some(((t = e.previousSibling), Zt(t) ? ms(t, t.data.length) : ms.after(t)))
        : e.previousSibling
    ...
    ud = function (e) {
      return Du(e.nextSibling)
        ? R.some(((t = e.nextSibling), Zt(t) ? ms(t, 0) : ms.before(t)))
        : e.nextSibling
          ? Zc(e.nextSibling)
          : R.none();
      var t;
    ...
    md = function (e) {
      if (Gf(e)) {
        ...
        return Et(e), St(e, t), R.some(ms.before(t.dom()));
      }
      return R.none();
    },
    pd = function (e, t, l) {
      ...
      return (
        ...
        ((n = a).isSome() && r.isSome() && o.isSome()
          ? R.some(i(n.getOrDie(), r.getOrDie(), o.getOrDie()))
          : R.none()
        ).orThunk(function () {
          return (
            l &&
    ...
    gd = function (t, n, e, r) {
      ...
      var o,
        ...
        s = pd(e, a, ((i = e), me(t.schema.getTextInlineElements(), Rt(i))));
        ...
        z(a, function (e, r) {
          ...
          u.push(o),
            (n[o] = function () {
              ...
              if (e !== i.length)
                throw new Error(
                  "Wrong number of arguments to case " + o + ". Expected " + i.length + " (" + i + "), got " + e
                );
              ...
              return {
                fold: function () {
                  if (arguments.length !== a.length)
                    throw new Error(
                      "Wrong number of arguments to fold. Expected " + a.length + ", got " + arguments.length
                    );
                ...
                match: function (e) {
                  ...
                  if (u.length !== t.length)
                    throw new Error(
                      "Wrong number of arguments to match. Expected: " + u.join(",") + "\nActual: " + t.join(",")
                    );
                  if (
                    !G(u, function (e) {
                      return M(t, e);
    ...
    yd = hd([{ removeTable: ["element"] }, { emptyCells: ["cells"] }, { deleteCellSelection: ["rng", "cell"] }]),
    bd = function (e, t) {
    ...
    xd = function (e, t) {
      return Cd(e.start, t).bind(function (r) {
        return Cd(e.end, t).bind(function (e) {
          return (t = at(r, e)), (n = r), t ? R.some(n) : R.none();
          var t, n;
        });
      });
    },
      ...
      return e
        ...
        .bind(function (e) {
          return xd((t = e), n).map(function (e) {
            return { rng: t, table: e, cells: Sd(e) };
          });
          var t;
        });
    },
    ...
    Ad = function (e, t) {
      var n,
        ...
        s = ((o = u), (i = bd((r = t).startContainer, o)), (a = bd(r.endContainer, o)), $u(i, a, vd));
      return Rd(s, t, u)
        .map(function (e) {
    ...
    Dd = function (e) {
      var t;
      return (8 === Tt((t = e)) || "#comment" === Rt(t) ? dt : bt)(e)
        .bind(Dd)
        .orThunk(function () {
          return R.some(e);
        });
    ...
    Od = function (e, t) {
      return z(t, Qf), e.selection.setCursorLocation(t[0].dom(), 0), !0;
    },
    Bd = function (e, t, n) {
      t.deleteContents();
      var r,
        o = Dd(n).getOr(n),
        i = Ne.fromDom(e.dom.getParent(o.dom(), e.dom.isBlock));
      if ((Gf(i) && (Qf(i), e.selection.setCursorLocation(i.dom(), 0)), !at(n, i))) {
        var a = ft(i).is(n)
          ? []
          : ft((r = i))
              .map(ht)
    ...
    Fd = function (e, t) {
      return Qf(t), e.selection.setCursorLocation(t.dom(), 0), R.some(!0);
    },
    Ud = function (u, s, c, l, f) {
      return Xc(c, u.getBody(), f)
        .bind(function (e) {
          return (
            (o = c),
            (i = f),
    ...
    Vd = function (e, t) {
      var n,
        ...
        i,
        a,
        u = Ne.fromDom(e.selection.getStart(!0)),
        s = $l(e);
    ...
    Wd = function (e, t) {
      ...
      return (
        ...
        ("br" === (n = t.firstChild).name || n.value === oo)
      );
    },
    Kd = function (e, t) {
      var n,
    ...
    Zd = function (e, o, i, t) {
      ...
      return R(1)
        ? Qd(E, k, _)
        : R(2)
          ? ((d = E), (m = k), (p = _), o.insertAfter(m.reverse(), d), Jd(m[0], p))
          : ((h = k),
            (v = _),
            (y = g = E),
            (C = (b = i).cloneRange()),
    ...
    tm = function (e, t) {
      var n,
        ...
        a = o.startOffset;
      o.collapsed &&
        ((r = a), Zt((n = i)) && n.nodeValue[r - 1] === oo) &&
        Zt(i) &&
        (i.insertData(a - 1, " "), i.deleteData(a, 1), o.setStart(i, a), o.setEnd(i, a), e.selection.setRng(o)),
    ...
    nm = function (e) {
      ...
      var r,
        o,
        i,
        a = t.getParent(n.startContainer, em);
      (r = t),
        (o = n),
        null !== (i = a) && i === r.getParent(o.endContainer, em) && Xl(Ne.fromDom(i), o)
          ? Bd(e, n, Ne.fromDom(a))
    ...
    rm = function (e, t, n) {
      ...
      if (
        ...
        (r = e.parser),
        (m = n.merge),
        (o = hf({ validate: e.settings.validate }, e.schema)),
        ...
        var h,
          ...
          C,
          w,
          x = (l = p.getRng()).startContainer || (l.parentElement ? l.parentElement() : null),
          S = e.getBody();
        x === S &&
          p.isCollapsed() &&
          g.isBlock(S.firstChild) &&
          ((h = e), (v = S.firstChild) && !h.schema.getShortEndedElements()[v.nodeName]) &&
          g.isEmpty(S.firstChild) &&
          ((l = g.createRng()).setStart(S.firstChild, 0), l.setEnd(S.firstChild, 0), p.setRng(l)),
          p.isCollapsed() ||
            (nm(e),
            ...
            3 === C.nodeType &&
              y.collapsed &&
              (C.data[w] === oo
                ? (C.deleteData(w, 1), /[\u00a0| ]$/.test(b) || (b += " "))
                : C.data[w - 1] === oo && (C.deleteData(w - 1, 1), /[\u00a0| ]$/.test(b) || (b = " " + b))),
            (t = b));
        var N,
          E,
          k,
          _ = { context: (i = p.getNode()).nodeName.toLowerCase(), data: n.data, insert: !0 };
        if (((u = r.parse(t, _)), !0 === n.paste && Kd(e.schema, u) && Gd(g, i)))
          return (l = Zd(o, g, e.selection.getRng(), u)), e.selection.setRng(l), void e.fire("SetContent", s);
        if (
          (!(function (e) {
        ...
        if ((e._selectionOverrides.showBlockCaretContainer(i), _.invalid)) {
          for (tm(e, d), i = p.getNode(), a = e.getBody(), 9 === i.nodeType ? (i = f = a) : (f = i); f !== a; )
            f = (i = f).parentNode;
            ...
            if (e) {
              ...
              (i = e.previousSibling) && 3 === i.nodeType
                ? (c.setStart(i, i.nodeValue.length),
                  rr.ie ||
                    ((a = e.nextSibling) && 3 === a.nodeType && (i.appendData(a.data), a.parentNode.removeChild(a))))
              ...
              (r = u.getParent(e, u.isBlock)),
                ...
                r &&
                  ...
                  !(o = (function (e) {
                    ...
                    if ((t = Hc(n.getBody()).next(t))) return t.toRange();
                  })(c))
    ...
    um = hd([{ before: ["element"] }, { on: ["element", "offset"] }, { after: ["element"] }]),
    sm =
      (um.before,
      um.on,
      um.after,
    ...
    bm = function (e) {
      ...
      try {
        return t.setStart(e.start().dom(), e.soffset()), t.setEnd(e.finish().dom(), e.foffset()), R.some(t);
      } catch (n) {
        return R.none();
      }
    },
    ...
    wm = function (r) {
      return (r.bookmark ? r.bookmark : R.none())
        .bind(function (e) {
          return (t = Ne.fromDom(r.getBody())), (n = e), R.from(n).filter(gm(t)).map(mm);
          var t, n;
        })
        .bind(bm);
    },
    ...
    Rm = function (e, t) {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        e.activeEditor || (Em.unbind(V.document, "focusin", Sf), (Sf = null));
    },
    Tm = function (t, e) {
      return ((n = e).collapsed ? R.from(Hu(n.startContainer, n.startOffset)).map(Ne.fromDom) : R.none()).bind(
        function (e) {
        ...
        .filter(function (e) {
          return (
            ...
            !(
              ...
              (n.contains("tox-edit-area") || n.contains("tox-edit-area__iframe") || n.contains("mce-content-body"))
            ) && km(r, e.dom())
          );
          var t, n;
        })
    ...
    Pm = function (e) {
      return e.inline
        ? (n = e.getBody()) && Om(Ne.fromDom(n))
        : (t = e).iframeElement && om(Ne.fromDom(t.iframeElement));
      var t, n;
    },
    Lm = function (t) {
      var e = t.selection,
      ...
      if (t.$.contains(n, a)) return Dm(a), Am(t, r), void Im(t);
      t.inline || (rr.opera || Dm(n), t.getWin().focus()), (rr.gecko || t.inline) && (Dm(n), Am(t, r)), Im(t);
    },
    Im = function (e) {
      return e.editorManager.setActive(e);
    },
    Mm = function (e, t) {
      t(e), e.firstChild && Mm(e.firstChild, t), e.next && Mm(e.next, t);
    },
    Fm = function (e, t, n) {
    ...
    jm = function (u, s, c) {
      return (
        ...
        (c.set = !0),
        (c.content = Um(s) ? "" : s),
        Um(s) || c.no_events || (u.fire("BeforeSetContent", c), (s = c.content)),
        R.from(u.getBody()).fold(x(s), function (e) {
          return Um(s)
            ? (function (e, t, n, r) {
                Fm(e.parser.getNodeFilters(), e.parser.getAttributeFilters(), n);
                var o = hf({ validate: e.validate }, e.schema).serialize(n);
                return (
                  (r.content = Or(Ne.fromDom(t)) ? o : hr.trim(o)),
                  zm(e, r.content),
            ...
            : ((t = u),
              ...
              0 === (r = s).length || /^\s+$/.test(r)
                ? ((a = '<br data-mce-bogus="1">'),
                  ...
                  (r =
                    (i = Hs(t)) && t.schema.isValidChild(n.nodeName.toLowerCase(), i.toLowerCase())
                      ? ((r = a), t.dom.createHTML(i, t.settings.forced_root_block_attrs, r))
                      : r || '<br data-mce-bogus="1">'),
                  zm(t, r),
                  t.fire("SetContent", o))
                : ("raw" !== o.format &&
                    (r = hf({ validate: t.validate }, t.schema).serialize(
      ...
      return (
        t === r && Zt(t)
          ? 0 < n &&
            ...
            ((t = (r = Hm(t, n)).previousSibling),
            n < o ? ((t = r = Hm(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0)) : (o = 0))
          : (Zt(t) && 0 < n && n < t.nodeValue.length && ((t = Hm(t, n)), (n = 0)),
        ...
        if ("undefined" == typeof c.length) {
          for (a in c)
            if (c.hasOwnProperty(a)) {
              if (((u = "attributes" === r ? e.getAttrib(t, a) : Sl(e, t, a)), o && !u && !n.exact)) return;
              if ((!o || n.exact) && !qm(u, xl(e, Cl(c[a], i), a))) return;
            }
        } else for (s = 0; s < c.length; s++) if ("attributes" === r ? e.getAttrib(t, c[s]) : Sl(e, t, c[s])) return n;
      return n;
    },
    Ym = function (e, t, n, r, o) {
      ...
      if (c && t)
        for (a = 0; a < c.length; a++)
          if (((i = c[a]), Km(e.dom, t, i) && Xm(l, t, i, "attributes", o, r) && Xm(l, t, i, "styles", o, r))) {
    ...
    Gm = function (e, t, n, r) {
      ...
      return r
        ? Wm(e, r, t, n)
        : ((r = e.selection.getNode()), !!Wm(e, r, t, n) || !((o = e.selection.getStart()) === r || !Wm(e, o, t, n)));
    },
    Jm = function (r, o, i) {
      var a = [],
        u = {},
    ...
    Qm = function (e, t) {
      var n,
        ...
        s = e.dom;
      if (u)
        for (n = e.selection.getStart(), r = El(s, n), i = u.length - 1; 0 <= i; i--) {
    ...
    np = function (e) {
      return (
        ...
        (function (e) {
          for (var t = []; e; ) {
            if ((3 === e.nodeType && e.nodeValue !== ep) || 1 < e.childNodes.length) return [];
    ...
    rp = function (e) {
      if (e) {
        var t = new ra(e, e);
        for (e = t.current(); e; e = t.next()) if (Zt(e)) return e;
      }
      return null;
    },
    op = function (e) {
      var t = Ne.fromTag("span");
      return ln(t, { id: tp, "data-mce-bogus": "1", "data-mce-type": "format-caret" }), e && St(t, Ne.fromText(ep)), t;
    },
    ip = function (e, t, n) {
      void 0 === n && (n = !0);
      var r,
      ...
      if (np(t)) gd(e, !1, Ne.fromDom(t), n);
        ...
        var a = i.getRng(),
          ...
          l = a.endContainer,
          f = a.endOffset,
          d = ((r = rp(t)) && r.nodeValue.charAt(0) === ep && r.deleteData(0, 1), r);
        o.remove(t, !0),
    ...
    ap = function (e, t, n) {
      ...
      var r = e.dom,
        o = e.selection;
      if (t) ip(e, t, n);
      else if (!(t = Fs(e.getBody(), o.getStart()))) for (; (t = r.get(tp)); ) ip(e, t, !1);
    },
    up = function (e, t) {
    ...
    cp = function (e, t, n, r) {
      ...
      if (a)
        if (o) {
          ...
          (b = Vm(b)), e.formatter.remove(t, n, b, r), m.moveToBookmark(y);
        } else {
          ...
          (s = w),
            (c = null !== C ? C : a),
            (l = (u = e).dom),
            (f = l.getParent(c, N(vl, u))) && l.isEmpty(f)
              ? c.parentNode.replaceChild(s, c)
              : (Jf(Ne.fromDom(c)), l.isEmpty(c) ? c.parentNode.replaceChild(s, c) : l.insertAfter(s, c));
          var x = (function (t, e, n, r, o, i) {
              ...
              if (
                ...
                var l = n.cloneNode(!1);
                return u.add(e, l), a.remove(r, o, l, i), u.remove(l), R.some(l);
              }
              return R.none();
            })(e, w, a, t, n, r),
            S = sp(p.concat(x.toArray()), w);
          ip(e, C, !1), m.setCursorLocation(S, 1), d.isEmpty(a) && d.remove(a);
        }
    },
    lp = function (i) {
  ...
  (Ef = function (e) {
    ...
    (t = Wt(["pre"])),
      r.collapsed ||
        ...
        pp(
          mp(mp(n, t), function (e) {
            return t(e.previousSibling) && -1 !== sr(n, e.previousSibling);
          }),
          function (e) {
            var t, n;
            (t = e.previousSibling), na((n = e)).remove(), na(t).append("<br><br>").append(n.childNodes);
          }
        ));
  }),
    dp[(Nf = "pre")] || (dp[Nf] = []),
  ...
  var gp,
    ...
    wp = function (e, t, n) {
      var r, o;
      if (((r = t[n ? "startContainer" : "endContainer"]), (o = t[n ? "startOffset" : "endOffset"]), $t(r))) {
        var i = r.childNodes.length - 1;
        !n && o && o--, (r = r.childNodes[i < o ? i : o]);
      }
      return (
        Zt(r) && n && o >= r.nodeValue.length && (r = new ra(r, e.getBody()).next() || r),
    ...
    Sp = function (e, t, n, r, o) {
      var i = Ne.fromDom(t),
        ...
        u = (n ? gt : pt)(i);
      return Nt(a, u), n ? (Ct(i, a), xt(a, i)) : (wt(i, a), St(a, i)), a.dom();
    },
    Np = function (e, t, n, r) {
    ...
    Ep = function (e, r, o, t, i) {
      ...
      if (
        ...
        !(
          bp((s = t), (c = r).inline) ||
          bp(s, c.block) ||
          (c.selector && $t(s) && u.is(s, c.selector)) ||
      ...
      if ("all" !== r.remove) {
        yp(r.styles, function (e, t) {
          ...
          yp(r.classes, function (e) {
            (e = Cl(e, o)), (i && !l.hasClass(i, e)) || l.removeClass(y, e);
          });
      ...
      return "none" !== r.remove
        ? ((f = e),
          ...
          m.block &&
            (v
              ? g === h.getRoot() &&
                ((m.list_block && bp(d, m.list_block)) ||
                  z(te(d.childNodes), function (e) {
                    yl(f, v, e.nodeName.toLowerCase())
                      ? p
                        ? p.appendChild(e)
                        : ((p = xp(h, e, v)), h.setAttribs(p, f.settings.forced_root_block_attrs))
                      : (p = 0);
                  }))
              : h.isBlock(d) &&
                !h.isBlock(g) &&
                (Np(h, d, !1) || Np(h, d.firstChild, !0, !0) || d.insertBefore(h.create("br"), d.firstChild),
    ...
    kp = function (s, c, l, e, f) {
      var d = s.formatter.get(c),
        ...
        g = function (e) {
          var t, n, r;
          if (
            ($t(e) && u.getContentEditable(e) && ((n = i), (i = "true" === u.getContentEditable(e)), (r = !0)),
            (t = te(e.childNodes)),
            i && !r)
          )
            for (var o = 0; o < d.length && !Ep(s, d[o], l, e, e); o++);
          if (m.deep && t.length) {
            for (o = 0; o < t.length; o++) g(t[o]);
            r && (i = n);
          }
        },
        h = function (e) {
          ...
          return (
            ll((t = r)) && $t(t) && ("_start" === t.id || "_end" === t.id) && (r = r[e ? "firstChild" : "lastChild"]),
            Zt(r) &&
              0 === r.data.length &&
          ...
          if (m.split) {
            if (((o = Vm(o)), (t = wp(s, o, !0)) !== (n = wp(s, o)))) {
              if (
                ...
                return p(Sp(u, i, !0, "span", { id: "_start", "data-mce-type": "bookmark" })), void h(!0);
              }
              if (Cp(u, n, t)) {
                i = R.from(n.lastChild).getOr(n);
                return p(Sp(u, i, !1, "span", { id: "_end", "data-mce-type": "bookmark" })), void h(!1);
              }
              (t = xp(u, t, "span", { id: "_start", "data-mce-type": "bookmark" })),
                (n = xp(u, n, "span", { id: "_end", "data-mce-type": "bookmark" }));
              var a = u.createRng();
              a.setStartAfter(t),
                a.setEndBefore(n),
                jl(u, a, function (e) {
            ...
            z(e, function (t) {
              ...
              z(["underline", "line-through", "overline"], function (e) {
                $t(t) &&
                  ...
                  t.parentNode &&
                  Nl(u, t.parentNode) === e &&
                  Ep(s, { deep: !1, exact: !0, inline: "span", styles: { textDecoration: e } }, null, t);
              });
            });
          });
        };
      if (e)
        ...
        t.isCollapsed() && m.inline && !$l(s).length
          ? cp(s, c, l, f)
          : (Ql(t, !0, function () {
              Jl(s, n);
            }),
    ...
    Tp = function (e, t) {
      var n;
      for (n = e; n; n = n[t]) {
        if (Zt(n) && 0 !== n.nodeValue.length) return e;
        if ($t(n) && !ll(n)) return n;
      }
      return e;
    },
    Ap = function (e, t, n) {
      var r,
        o,
        i = new Df(e);
      if (t && n && ((t = Tp(t, "previousSibling")), (n = Tp(n, "nextSibling")), i.compare(t, n))) {
    ...
    Dp = function (e, t, n) {
      _p(e.childNodes, function (e) {
        Rp(e) && (t(e) && n(e), e.hasChildNodes() && Dp(e, t, n));
      });
    },
    Op = function (t, n) {
      return function (e) {
    ...
    Bp = function (t, n, r) {
      return function (e) {
        t.setStyle(e, n, r), "" === e.getAttribute("style") && e.removeAttribute("style"), Pp(t, e);
      };
    },
    Pp = function (e, t) {
    ...
    Mp = function (R, T, A, r) {
          ...
          if (((e = e || O), n)) {
            ...
            Ip(e.attributes, function (e, t) {
              ...
              Ip(e.classes, function (e) {
                (e = Cl(e, A)), i.hasClass(n, e) || i.addClass(n, e);
              });
          }
        },
        d = function (e, t) {
          ...
          return (
            ...
            (Ip(e, function (e) {
              if (!("collapsed" in e && e.collapsed !== o))
                return i.is(t, e.selector) && !Ms(t) ? (B(t, e), !(n = !0)) : void 0;
            }),
            n)
          );
        },
        a = function (k, e, t, s) {
          ...
          (c = O.inline || O.block),
            ...
            jl(k, e, function (e) {
              var a,
                u = function (e) {
                  ...
                  if (
                    ($t(e) && k.getContentEditable(e) && ((n = f), (f = "true" === k.getContentEditable(e)), (t = !0)),
                    wl(r, "br"))
                  )
                    return (a = 0), void (O.block && k.remove(e));
                  if (O.wrapper && Ym(R, e, T, A)) a = 0;
                  else {
                    if (f && !t && O.block && !O.wrapper && vl(R, r) && yl(R, o, c))
                      return (e = k.rename(e, c)), B(e), _.push(e), void (a = 0);
                    if (O.selector) {
                      var i = d(D, e);
                    ...
                    !yl(R, c, r) ||
                    !yl(R, o, c) ||
                    (!s && 3 === e.nodeType && 1 === e.nodeValue.length && 65279 === e.nodeValue.charCodeAt(0)) ||
                    Ms(e) ||
                    (O.inline && k.isBlock(e))
                      ? ((a = 0), Ip(hr.grep(e.childNodes), u), t && (f = n), (a = 0))
                      : (a || ((a = k.clone(l, !1)), e.parentNode.insertBefore(a, e), _.push(a)), a.appendChild(e));
                  }
                };
              Ip(e, u);
            }),
            !0 === O.links &&
              Ip(_, function (e) {
                var t = function (e) {
                  "A" === e.nodeName && B(e, O), Ip(hr.grep(e.childNodes), t);
                };
                t(e);
              }),
            Ip(_, function (e) {
                ...
                E = function (e) {
                  ...
                  return (
                    Ip(e.childNodes, function (e) {
                      if ((t = e) && 1 === t.nodeType && !ll(t) && !Ms(t) && !Yt(t)) return (n = e), !1;
                      var t;
                    }),
                    n
                  );
                ...
                ? (O.inline || O.wrapper) &&
                  (O.exact ||
                    ...
                    ((S = E((x = e))) &&
                      !ll(S) &&
                      Km(k, S, O) &&
                      ((N = k.clone(S, !1)), B(N), k.replace(N, x, !0), k.remove(S, !0)),
                    (e = N || x)),
                  Lp(R, D, A, e),
                  (y = O),
                  (b = T),
                  (C = A),
                  (Ym((v = R), (w = e).parentNode, b, C) && Ep(v, y, C, w)) ||
                    (y.merge_with_parents &&
                      v.dom.getParent(w.parentNode, function (e) {
                        if (Ym(v, e, b, C)) return Ep(v, y, C, w), !0;
                      })),
                  (m = k),
                  (g = A),
                  (h = e),
                  (p = O).styles &&
                    ...
                    Dp(h, Op(m, "fontSize"), Bp(m, "backgroundColor", Cl(p.styles.backgroundColor, g))),
                  (c = k),
                  (f = e),
                  (d = function (e) {
                    if (1 === e.nodeType && e.parentNode && 1 === e.parentNode.nodeType) {
                      var t = Nl(c, e.parentNode);
                      c.getStyle(e, "color") && t
                        ? c.setStyle(e, "text-decoration", t)
                        : c.getStyle(e, "text-decoration") === t && c.setStyle(e, "text-decoration", null);
                    }
                  }),
                  (l = O).styles && (l.styles.color || l.styles.textDecoration) && (hr.walk(f, d, "childNodes"), d(f)),
                  (a = k),
                  (s = e),
                  ("sub" !== (u = O).inline && "sup" !== u.inline) ||
                    (Dp(s, Op(a, "fontSize"), Bp(a, "fontSize", "")),
                    a.remove(a.select("sup" === u.inline ? "sub" : "sup", s), !0)),
                  (r = k),
                  (o = O),
                  (i = e) && !1 !== o.merge_siblings && ((i = Ap(r, hl(i), i)), (i = Ap(r, i, hl(i, !0)))))
                : k.remove(e, !0);
            });
        };
      if ("false" !== i.getContentEditable(t.getNode())) {
        if (O) {
          if (r)
            pl(r)
              ? d(D, r) || ((e = i.createRng()).setStartBefore(r), e.setEndAfter(r), a(i, Ul(R, e, D), 0, !0))
              : a(i, r, 0, !0);
            ...
            !(function (e, t, n) {
              ...
              if (s && 0 < u && u < s.length && f.test(s.charAt(u)) && f.test(s.charAt(u - 1))) {
                ...
                (m = Vm(m)), e.formatter.apply(t, n, m), i.moveToBookmark(d);
              } else
                (r && o.nodeValue === ep) ||
                  ((c = e.getDoc()),
                  (l = op(!0).dom()),
        ...
        for (var s = 0, c = D.length; s < c; s++)
          if (D[s].ceFalseOverride && i.is(r, D[s].selector)) return void B(r, D[s]);
      }
    },
    Fp = function (n, e) {
      return U(e, function (e) {
    ...
    qp = function (e, t) {
      for (var n, r = e.rows(), o = 0; o < r.length; o++)
        for (var i = r[o].cells(), a = 0; a < i.length; a++)
          if (at(i[a], t)) return R.some(((n = o), { x: x(a), y: x(n) }));
      return R.none();
    },
      ...
      return (
        (n = U((t = e).rows(), function (e) {
          var t = U(e.cells(), function (e) {
              var t = iu(e);
              return dn(t, "colspan"), dn(t, "rowspan"), t;
            }),
            n = ou(e.element());
          return Nt(n, t), n;
        })),
    ...
    Gp = function (e, t) {
      var n,
        r = Ne.fromDom(t.commonAncestorContainer),
        o = nd(r, e),
        i = H(o, function (e) {
          return Nr(e) || xr(e);
        }),
    ...
    eg = function (e, t) {
      var n,
        r,
        o = ql(t, e);
      return 0 < o.length ? Zp(e, o) : ((n = e), 0 < (r = t).length && r[0].collapsed ? Jp() : Qp(n, r[0]));
    },
    tg = function (e, t, n) {
      if (
        (void 0 === n && (n = {}),
      ...
      return "tree" === n.format
        ? f
        : ((n.content = e.selection.isCollapsed() ? "" : f), e.fire("GetContent", n), n.content);
    },
    ng = function (e) {
    ...
    rg = function (e, t, n) {
      var r = (function (e) {
        var t, n, r;
        for (
          r = V.document.createElement("div"), t = V.document.createDocumentFragment(), e && (r.innerHTML = e);
          (n = r.firstChild);
    ...
    ag = function (n) {
      ...
      return (
        ...
        -1 !== t.indexOf("</iframe>")
          ? { type: "fragmented", fragments: r, content: "", bookmark: null, beforeBookmark: null }
          : { type: "complete", fragments: null, content: t, bookmark: null, beforeBookmark: null }
      );
    },
    ug = function (e, t, n) {
      "fragmented" === t.type ? og(t.fragments, e.getBody()) : e.setContent(t.content, { format: "raw" }),
    ...
    cg = function (e) {
      var t = Ne.fromTag(
        "body",
        ig.get().getOrThunk(function () {
          var e = V.document.implementation.createHTMLDocument("undo");
          return ig.set(R.some(e)), e;
        })
      );
      return nu(t, sg(e)), z(Ua(t, "*[data-mce-bogus]"), _t), t.dom().innerHTML;
    },
    lg = function (e, t) {
      return !(!e || !t) && ((r = t), sg(e) === sg(r) || ((n = t), cg(e) === cg(n)));
      var n, r;
    },
    fg = function (e) {
      return 0 === e.get();
      ...
      return {
        undoManager: {
          beforeChange: function (e, t) {
            return (n = s), (r = t), void (fg(e) && r.set(R.some(Ls(n.selection))));
            var n, r;
          },
          addUndoLevel: function (e, t, n, r, o, i) {
            return (function (e, t, n, r, o, i, a) {
              var u = e.settings,
                s = ag(e);
              if (((i = i || {}), (i = hr.extend(i, s)), !1 === fg(r) || e.removed)) return null;
              var c = t.data[n.get()];
              if (e.fire("BeforeAddUndo", { level: i, lastLevel: c, originalEvent: a }).isDefaultPrevented())
                return null;
              if (c && lg(c, i)) return null;
              if (
                (t.data[n.get()] &&
          ...
          undo: function (e, t, n) {
            return (
              ...
              (i = t),
              (a = n),
              (o = e).typing && (o.add(), (o.typing = !1), dg(o, !1, i)),
              0 < a.get() &&
                (a.set(a.get() - 1), (u = o.data[a.get()]), ug(r, u, !0), r.setDirty(!0), r.fire("Undo", { level: u })),
              u
            );
            var r, o, i, a, u;
          },
          redo: function (e, t) {
            return (
              ...
              (o = t),
              (r = e).get() < o.length - 1 &&
                (r.set(r.get() + 1), (i = o[r.get()]), ug(n, i, !1), n.setDirty(!0), n.fire("Redo", { level: i })),
              i
            );
            var n, r, o, i;
          },
          ...
          hasUndo: function (e, t) {
            return (n = s), (r = e), 0 < t.get() || (r.typing && r.data[0] && !lg(ag(n), r.data[0]));
            var n, r;
          },
            ...
            return (function (e, t, n, r, o) {
              if (t.transact(r)) {
                var i = t.data[n.get()].bookmark,
                  a = t.data[n.get() - 1];
                ug(e, a, !0), t.transact(o) && (t.data[n.get() - 1].beforeBookmark = i);
              }
            })(s, e, t, n, r);
          },
        },
    ...
    bg = function (n) {
      ...
      return de(n.plugins, "rtc").fold(
        function () {
          return (r.rtcInstance = vg(n)), R.none();
        },
        function (e) {
          return R.some(
              ...
              return (
                (r.rtcInstance =
                  ...
                  (t = p("Unimplemented feature for rtc")),
                  {
                    ...
                    editor: {
                      getContent: function (e, t) {
                        if ("html" !== t && "tree" !== t) return vg(o).editor.getContent(e, t);
                        var n = i.getContent(),
                          r = hf({ inner: !0 });
                        return gg(o, n), "tree" === t ? n : r.serialize(n);
                      },
                      setContent: function (e, t) {
                        var n = pg(e) ? e : o.parser.parse(e, { isRootContent: !0, insert: !0 });
                        return i.setContent(n), e;
                      },
                      insertContent: function (e, t) {
                        var n = pg(e) ? e : o.parser.parse(e, { insert: !0 });
                        i.insertContent(n);
                      },
                    },
                    selection: {
                      getContent: function (e, t) {
                        if ("html" !== e && "tree" !== e) return vg(o).selection.getContent(e, t);
                        var n = i.getSelectedContent(),
                          r = hf({});
                        return gg(o, n), "tree" === e ? n : r.serialize(n);
                      },
                    },
                    raw: {
                      getModel: function () {
    ...
    xg = function (e, t) {
      ...
      return (n = t), (r = o), Cg(e).editor.getContent(n, r);
    },
    Sg = function (e, t, n) {
      return void 0 === n && (n = {}), (r = t), (o = n), Cg(e).editor.setContent(r, o);
      var r, o;
    },
    Ng = ga.DOM,
    Eg = function (e) {
    ...
    kg = function (e) {
      if (!e.removed) {
        ...
        r && e.save({ is_removing: !0 }),
          ...
          !e.inline && r && ((i = e), Ng.setStyle(i.id, "display", i.orgDisplay)),
          e.fire("detach"),
    ...
    Tg =
      ...
      function () {
        ...
        for (var n = {}, r = 0; r < e.length; r++) {
          var o = e[r];
          for (var i in o) Rg.call(o, i) && (n[i] = gp(n[i], o[i]));
        }
        return n;
      }),
    Ag = nt().deviceType,
    ...
    Og = Ag.isPhone(),
    Bg = Ag.isTablet(),
    Pg = ["lists", "autolink", "autosave"],
    Lg = { table_grid: !1, object_resizing: !1, resize: !1 },
    Ig = function (e) {
      var t = k(e) ? e.join(" ") : e,
        n = U(q(t) ? t.split(" ") : [], $e);
    ...
    zg = function (e, t, n, r) {
      var o,
        ...
        c,
        l,
        f = Ig(n.forced_plugins),
        d = Ig(r.plugins),
        m = Fg((o = t), (i = "mobile")) ? o.sections()[i] : {},
        p = m.plugins ? Ig(m.plugins) : d,
        g =
          e && ((s = u = "mobile"), (c = (a = t).sections()), Fg(a, u) && c[u].theme === s)
            ? H(p, N(M, Pg))
            : e && Fg(t, "mobile")
              ? p
              : d,
        h = ((l = g), [].concat(Ig(f)).concat(Ig(l)));
      return hr.extend(r, { plugins: h.join(" ") });
    },
        ...
        d = e
          ? {
              mobile:
                ((i = o.mobile || {}),
                (a = t),
                (u = { resize: !1, toolbar_mode: Ug(i, "scrolling"), toolbar_sticky: !1 }),
                pe(pe(pe({}, Lg), u), a ? { menubar: !1 } : {})),
            }
          : {},
        m = Mg(["mobile"], Tg(d, o)),
        p = hr.extend(
    ...
    qg = function (e, t, n, r) {
      ...
      return "hash" === r
        ? ((a = {}),
          "string" == typeof (i = u)
            ? z(0 < i.indexOf("=") ? i.split(/[;,](?![^=;,]*(?:[;,]|$))/) : i.split(","), function (e) {
                var t = e.split("=");
    ...
    Qg = function (e, t, n) {
      var r,
        ...
        d,
        m,
        p = Ne.fromDom(e.getBody()),
        g = e.inline ? p : ((r = p), Ne.fromDom(r.dom().ownerDocument.documentElement)),
        h =
          ((o = e.inline),
          (a = t),
          (u = n),
          (s = (i = g).dom().getBoundingClientRect()),
          { x: a - (o ? s.left + i.dom().clientLeft + Jg(i) : 0), y: u - (o ? s.top + i.dom().clientTop + Gg(i) : 0) });
      return (l = h.x), (f = h.y), (d = Xg((c = g))), (m = Yg(c)), 0 <= l && 0 <= f && l <= d && f <= m;
    },
    Zg = function (e) {
      var t,
  ...
  var rh = function (n) {
      var r = [],
        ...
        s = function (e) {
          n.editorManager.setActive(n), Cm(n);
          var t = e();
          return a(t), t;
        };
      return (
    ...
    lh = function (t) {
      var e,
        n,
        r =
          ((n = (e = t).settings.content_css),
          q(n) ? U(n.split(","), $e) : k(n) ? n : !1 === n || e.inline ? [] : ["default"]),
  ...
  var fh = (function hE(r, o) {
    ...
    ph = function (e) {
      var t,
        n,
        r,
        o = Ne.fromDom(V.document),
        i = Ft(o),
        a = ((t = e), (r = (n = mh).owner(t)), dh(n, r)),
        u = Mt(e),
        s = $(
          a,
          function (e, t) {
      ...
      var n,
        r = (function (e) {
          var t = e.dom().ownerDocument,
            ...
            r = t.defaultView,
            o = t.documentElement;
          if (n === e.dom()) return Lt(n.offsetLeft, n.offsetTop);
    ...
    vh = function (e, t) {
      var n = (function (e, t) {
          var n = ht(e);
          if (0 === n.length || gh(e)) return { element: e, offset: t };
          if (t < n.length && !gh(n[t])) return { element: n[t], offset: 0 };
          var r = n[n.length - 1];
          return gh(r)
            ? { element: e, offset: t }
            : "img" === Rt(r)
    ...
    bh = function (e, t, n, r, o) {
      ...
      (i = u),
        e.fire("ScrollIntoView", i).isDefaultPrevented() ||
          (n(t, Ft(t).top(), r, o), (a = u), e.fire("AfterScrollIntoView", a));
    },
    Ch = function (e, t, n, r) {
      ...
      bh(e, i, t, a, r), a.cleanup();
    },
    wh = function (e, t, n, r) {
      var o,
        i = Ne.fromDom(e.getDoc());
      bh(e, i, n, ((o = t), hh(Ne.fromDom(o), f)), r);
    },
    xh = function (e, t, n) {
        ...
        try {
          ...
          r = (function (e, n, t) {
            ...
            if (
              ...
              0 <
                (i = (i = hr.toArray(o.getClientRects())).sort(function (e, t) {
                  return (
    ...
    Mh = function (e, t) {
      for (var n = e; e && Zt(e) && 0 === e.length; ) e = t ? e.nextSibling : e.previousSibling;
      return e || n;
    },
    Fh = function (e, t) {
      void 0 === t && (t = {});
      var n,
        r,
        o = t.format ? t.format : "html";
      return (n = o), (r = t), wg(e).selection.getContent(n, r);
    },
    Uh = function (e, t) {
      return (
        e &&
    ...
    qh = function (e, t, n, r, o) {
      ...
      if (r && rn(o) && t && e.isEmpty(c)) return R.some(ls(o.parentNode, e.nodeIndex(o)));
      for (var l, f, d = new ra(o, c); (a = d[r ? "prev" : "next"]()); ) {
        if ("false" === e.getContentEditableParent(a) || ((f = u), gu((l = a)) && !1 === zh(l, f, Ms))) return R.none();
        if (Zt(a) && 0 < a.nodeValue.length)
          return !1 === jh(a, u, "A") ? R.some(ls(a, r ? a.nodeValue.length : 0)) : R.none();
        if (e.isBlock(a) || s[a.nodeName.toLowerCase()]) return R.none();
        i = a;
      }
    ...
    $h = function (e, t, n, r) {
      ...
      if (
        ...
        return R.none();
      if (($t(o) && i > o.childNodes.length - 1 && (s = !1), tn(o) && ((o = m), (i = 0)), o === m)) {
        if (s && (a = o.childNodes[0 < i ? i - 1 : 0])) {
          if (gu(a)) return R.none();
          if (u[a.nodeName] || Hh(a)) return R.none();
        }
        if (o.hasChildNodes()) {
          if (
          ...
          if (o.hasChildNodes() && !1 === Hh(o)) {
            ...
            do {
              ...
              if (Zt(a) && 0 < a.nodeValue.length) {
                (i = s ? 0 : a.nodeValue.length), (o = a), (p = !0);
                break;
              }
              if (u[a.nodeName.toLowerCase()] && (!(l = a) || !/^(TD|TH|CAPTION)$/.test(l.nodeName))) {
                (i = e.nodeIndex(a)), (o = a.parentNode), s || i++, (p = !0);
                break;
              }
      ...
      return (
        t &&
          (Zt(o) &&
            0 === i &&
            qh(e, c, t, !0, o).each(function (e) {
              (o = e.container()), (i = e.offset()), (p = !0);
            }),
          $t(o) &&
            (!(a = (a = o.childNodes[i]) || o.childNodes[i - 1]) ||
              !rn(a) ||
              ((d = "A"), (f = a).previousSibling && f.previousSibling.nodeName === d) ||
              Vh(e, a, !1) ||
              Vh(e, a, !0) ||
              qh(e, c, t, !0, a).each(function (e) {
                (o = e.container()), (i = e.offset()), (p = !0);
              }))),
        s &&
          !t &&
    ...
    Wh = function (e, t) {
      ...
      return (
        $h(e, n, !0, r).each(function (e) {
          (n && ls.isAbove(o, e)) || r.setStart(e.container(), e.offset());
        }),
        n ||
          $h(e, n, !1, r).each(function (e) {
    ...
    Kh = function (e) {
      return 0 === e.dom().length ? (kt(e), R.none()) : R.some(e);
    },
    Xh = function (r, e) {
      ...
      $u(o, t.filter(Ot), function (e, t) {
        var n, r;
        (n = t.dom()), (r = e.dom().data), n.insertData(0, r), kt(e);
      }),
        $u(i, n.filter(Ot), function (e, t) {
          var n = t.dom().length;
          t.dom().appendData(e.dom().data), r.setEnd(t.dom(), n), kt(e);
        }),
        r.collapse(!1);
    },
    Yh = function (e, t, n) {
      void 0 === n && (n = {});
      var r,
        o = ((r = t), pe(pe({ format: "html" }, n), { set: !0, selection: !0, content: r }));
      if (o.no_events || !(o = e.fire("BeforeSetContent", o)).isDefaultPrevented()) {
        n.content = (function (e, t) {
          if ("raw" === t.format) return t.content;
          var n = e.parser.parse(t.content, pe({ isRootContent: !0, forced_root_block: !1 }, t));
          return hf({ validate: e.validate }, e.schema).serialize(n);
        })(e, o);
  ...
  function Gh(e) {
    return { getBookmark: N(sl, e), moveToBookmark: N(cl, e) };
  }
  ...
  var Jh = Gh,
    ...
    nv = function (r, s) {
      ...
      var D = function (e) {
        ...
        L = function (e) {
          ...
          (t = e.screenX - m),
            ...
            (D(c) && !1 !== s.getParam("resize_img_proportional", !0, "boolean")
              ? !Zh.modifierPressed(e)
              : Zh.modifierPressed(e)) &&
              (R(t) > R(n) ? ((x = T(w * b)), (w = T(x / b))) : ((w = T(x / b)), (x = T(w * b)))),
            P(l, w, x),
            (r = 0 < (r = d.startPos.x + t) ? r : 0),
            (o = 0 < (o = d.startPos.y + n) ? o : 0),
            E.setStyles(f, { left: r, top: o, display: "block" }),
            (f.innerHTML = w + " &times; " + x),
            d[2] < 0 && l.clientWidth <= w && E.setStyle(l, "left", g + (v - w)),
            d[3] < 0 && l.clientHeight <= x && E.setStyle(l, "top", h + (y - x)),
            (t = A.scrollWidth - S) + (n = A.scrollHeight - N) !== 0 && E.setStyles(f, { left: r - t, top: o - n }),
            C || ((i = c), (a = v), (u = y), s.fire("ObjectResizeStart", { target: i, width: a, height: u }), (C = !0));
        },
        I = function () {
          var e = C;
          C = !1;
          ...
          e && (o("width", w), o("height", x)),
            E.unbind(k, "mousemove", L),
            E.unbind(k, "mouseup", I),
            _ !== k && (E.unbind(_, "mousemove", L), E.unbind(_, "mouseup", I)),
            E.remove(l),
            E.remove(f),
            i(c),
            e &&
        ...
        i = function (e) {
          ...
          M(),
            ...
            c !== e && ((c = e), (w = x = 0)),
            (n = s.fire("ObjectSelected", { target: e })),
                  ...
                  (t = E.get("mceResizeHandle" + e)) && E.remove(t),
                    ...
                    E.bind(t, "mousedown", function (e) {
                      ...
                      e.stopImmediatePropagation(),
                        ...
                        (y = O(c).clientHeight),
                        (b = y / v),
                        ((d = n).startPos = { x: r * n[0] + g, y: o * n[1] + h }),
                        (S = A.scrollWidth),
                        (N = A.scrollHeight),
                        (l = c.cloneNode(!0)),
                        ...
                        (l.contentEditable = !1),
                        (l.unSelectabe = !0),
                        E.setStyles(l, { left: g, top: h, margin: 0 }),
                        P(l, r, o),
                        l.removeAttribute("data-mce-selected"),
                        A.appendChild(l),
                        E.bind(k, "mousemove", L),
                        E.bind(k, "mouseup", I),
                        _ !== k && (E.bind(_, "mousemove", L), E.bind(_, "mouseup", I)),
                        (f = E.add(
                          A,
                          "div",
                    ...
                    (n.elm = t),
                    E.setStyles(t, { left: r * n[0] + g - t.offsetWidth / 2, top: o * n[1] + h - t.offsetHeight / 2 });
                })
              : M(),
        ...
        o = function (e) {
          ...
          C ||
            s.removed ||
            (u(E.select("img[data-mce-selected],hr[data-mce-selected]"), function (e) {
              e.removeAttribute("data-mce-selected");
            }),
            (t = "mousedown" === e.type ? e.target : r.getNode()),
            n((t = E.$(t).closest("table,img,figure.image,hr")[0]), A) &&
      ...
      s.on("init", function () {
        if ((z(), rr.browser.isIE() || rr.browser.isEdge())) {
          s.on("mousedown click", function (e) {
            ...
            C ||
              !/^(TABLE|IMG|HR)$/.test(n) ||
              F(t) ||
              (2 !== e.button && s.selection.select(t, "TABLE" === n), "mousedown" === e.type && s.nodeChanged());
          });
          var e = function (e) {
            var t = function (e) {
  ...
  var ov = function (e) {
    ...
    av = function (u, s, e, c) {
      var n,
        ...
        m = function () {
          ...
          try {
            (e = d()) &&
              !qt(e.anchorNode) &&
              (t = 0 < e.rangeCount ? e.getRangeAt(0) : e.createRange ? e.createRange() : r.createRange());
          } catch (a) {}
          return (
            (t = (t = Fp(c, [t])[0]) || (r.createRange ? r.createRange() : r.body.createTextRange())).setStart &&
        ...
        g = {
          ...
          setCursorLocation: function (e, t) {
            var n = u.createRng();
            e ? (n.setStart(e, t), n.setEnd(e, t), a(n), i(!1)) : (Yl(u, n, c.getBody(), !0), a(n));
          },
            ...
            return (
              ...
              (t = m())
                ? ((r = t.startContainer),
                  ...
                  3 === r.nodeType &&
                    3 === o.nodeType &&
                    ((r = r.length === i ? Mh(r.nextSibling, !0) : r.parentNode),
          ...
          getSelectedBlocks: function (e, t) {
            return (function (e, t, n, r) {
              ...
              if (
                ...
                for (var u = new ra((o = n), i); (o = u.next()) && o !== r; ) e.isBlock(o) && a.push(o);
          ...
          normalize: function () {
            var e = m(),
              t = d();
            if (1 < Hl(t).length || !Gl(c)) return e;
            var n = Wh(u, e);
            return (
              n.each(function (e) {
                a(e, p());
          ...
          scrollIntoView: function (e, t) {
            return (r = e), (o = t), void ((n = c).inline ? Rh : Ah)(n, r, o);
            var n, r, o;
          },
      ...
      return (n = Jh(g)), (t = nv(g, c)), (g.bookmarkManager = n), (g.controlSelection = t), g;
    },
    uv = function (e, a, u) {
    ...
    lv = function (e, t) {
      ...
      return R.some(new V.Blob([r], { type: e }));
    },
    fv = function (e) {
      ...
      if (0 !== o.src.indexOf("blob:")) {
        ...
        (a = n),
          (u = r.getByData(a, s))
            ...
            : fv(o.src).then(
                function (e) {
                  (u = r.create(mv(), e, a)), r.add(u), i({ image: o, blobInfo: u });
                },
                function (e) {
                  t(e);
                }
              ...
              function (t) {
                ...
                (n = t),
                  new Mn(function (e) {
                    ...
                    (a = cv(e).data), (u = r.create(mv(), t, a)), r.add(u), i({ image: o, blobInfo: u });
                  });
              },
              function (e) {
                t(e);
  ...
  var hv = function (e, t, n, r) {
      (e.padd_empty_with_br || t.insert) && n[r.name]
        ? (r.empty().append(new df("br", 1)).shortEnded = !0)
        : (r.empty().append(new df("#text", 3)).value = oo);
    },
    vv = function (e, t) {
      ...
      var r = t.blob_cache,
        n = function (t) {
          var e,
            n = t.attr("src");
          n !== rr.transparentSrc &&
            ((e = /data:([^;]+);base64,([a-z0-9\+\/=]+)/i.exec(n))
              ? R.some({ type: e[1], data: decodeURIComponent(e[2]) })
              : R.none()
            )
              .bind(function (e) {
                var t = e.type,
                  n = e.data;
                return R.from(r.getByData(n, t)).orThunk(function () {
                  return lv(t, n).map(function (e) {
                    var t = r.create(mv(), e, n);
                    return r.add(t), t;
                  });
                });
              })
      ...
      g.remove_trailing_brs &&
        e.addNodeFilter("br", function (e, t, n) {
          var r,
            ...
            l,
            f = e.length,
            d = hr.extend({}, h.getBlockElements()),
            ...
            if (((i = (o = e[r]).parent), d[o.parent.name] && o === i.lastChild)) {
              ...
              o &&
                ...
                yv(h, m, p, i) &&
                  ...
                  (c.removeEmpty ? i.remove() : c.paddEmpty && hv(g, n, d, i)));
            } else {
              for (a = o; i && i.firstChild === a && i.lastChild === a && !d[(a = i).name]; ) i = i.parent;
              a === i && !0 !== g.padd_empty_with_br && (((l = new df("#text", 3)).value = oo), o.replace(l));
            }
        }),
    ...
    Ev = function (R, T) {
      ...
      var e,
        ...
        n = {
          ...
          addAttributeFilter: function (e, n) {
            xv(Sv(e), function (e) {
              var t;
              for (t = 0; t < D.length; t++) if (D[t].name === e) return void D[t].callbacks.push(n);
          ...
          parse: function (e, u) {
            ...
            var p,
              ...
              h = T.children,
              v = R.validate,
              y = "forced_root_block" in u ? u.forced_root_block : R.forced_root_block,
              b = !1 === (p = y) ? "" : !0 === p ? "p" : p,
              C = T.getWhiteSpaceElements(),
              w = /^[ \t\r\n]+/,
              x = /[ \t\r\n]+$/,
              S = /[ \t\r\n]+/g,
              N = /^[ \t\r\n]+$/;
            ...
            t = kf(
              {
                ...
                text: function (e, t) {
                  ...
                  f ||
                    ...
                    0 !== e.length && (((n = E("#text", 3)).raw = !!t), (d.append(n).value = e));
                },
                comment: function (e) {
                ...
                start: function (e, t, n) {
                  ...
                  if ((i = v ? T.getElementRule(e) : {})) {
                    for (
                      (r = E(i.outputName || e, 1)).attributes = t,
                        r.shortEnded = n,
                        d.append(r),
                  ...
                  if ((n = v ? T.getElementRule(e) : {})) {
                      ...
                      if ((t = d.firstChild) && 3 === t.type)
                        if (0 < (r = t.value.replace(w, "")).length) (t.value = r), (t = t.next);
                          ...
                          for (o = t.next, t.remove(), t = o; t && 3 === t.type; )
                            (r = t.value),
                              (o = t.next),
                              (0 !== r.length && !N.test(r)) || (t.remove(), (t = o)),
                              (t = o);
                    ...
                    if ((f && C[e] && (f = !1), n.removeEmpty && yv(T, g, C, d)))
                      return (i = d.parent), l[d.name] ? d.empty().remove() : d.unwrap(), void (d = i);
                    n.paddEmpty &&
                      ((vv((a = d), "#text") && a.firstChild.value === oo) || yv(T, g, C, d)) &&
                      hv(R, u, l, d),
                      (d = d.parent);
                  }
                },
            ...
            if (
              ...
              v &&
                ...
                (u.context
                  ...
                  : (function (e) {
                      ...
                      for (
                        d = wv("tr,td,th,tbody,thead,tfoot,table"),
                          ...
                          if (m[n.name] && "li" === n.parent.name) {
                            ...
                            if (r && 1 < o.length) {
                              for (o.reverse(), i = a = P(o[0].clone()), c = 0; c < o.length - 1; c++) {
                                for (
                                  T.isValidChild(a.name, o[c].name) ? ((u = P(o[c].clone())), a.append(u)) : (u = a),
                                    s = o[c].firstChild;
                                  s && s !== o[c + 1];
                              ...
                              yv(T, l, f, i) ? r.insert(n, o[0], !0) : (r.insert(i, o[0], !0), r.insert(n, i)),
                                (r = o[0]),
                              ...
                              T.isValidChild(n.parent.name, "div") && T.isValidChild("div", n.name)
                                ? n.wrap(P(new df("div", 1)))
                                : p[n.name]
                                  ? n.empty().remove()
                                  : n.unwrap();
                            }
              ...
              b &&
                ...
                (function () {
                  var e,
                    ...
                    r = function (e) {
                      e &&
                        ((n = e.firstChild) && 3 === n.type && (n.value = n.value.replace(w, "")),
                    ...
                    for (; n; )
                      (e = n.next),
                        3 === n.type || (1 === n.type && "p" !== n.name && !l[n.name] && !n.attr("data-mce-type"))
                          ? (t || ((t = E(b, 1)).attr(R.forced_root_block_attrs), _.insert(t, n)), t.append(n))
                          : (r(t), (t = null)),
                        (n = e);
                    r(t);
                  }
              ...
              for (c in O)
                if (O.hasOwnProperty(c)) {
                  for (s = A[c], i = (n = O[c]).length; i--; ) n[i].parent || n.splice(i, 1);
                  for (r = 0, o = s.length; r < o; r++) s[r](n, c, u);
                }
      ...
      return Cv(n, R), (e = n), (t = R).inline_styles && sv(e, t), n;
    },
    kv = function (e, t, n) {
      return (
        (m = n),
        (d = e) && d.hasEventListeners("PreProcess") && !m.no_events
          ? ((o = t),
            (i = n),
            (f = (r = e).dom),
            (o = o.cloneNode(!0)),
    ...
    Rv = function (e, t, n, r, o) {
      var i,
        ...
        c,
        l,
        f = ((i = r), hf(t, n).serialize(i));
      return (
        (a = e),
        (s = f),
        (u = o).no_events || !a ? s : ((c = a), (l = pe(pe({}, u), { content: s })), c.fire("PostProcess", l).content)
      );
    },
    Tv = function (y, b) {
      ...
      (s = y),
        ...
        t.addNodeFilter("noscript", function (e) {
          for (var t, n = e.length; n--; ) (t = e[n].firstChild) && (t.value = $r.decode(t.value));
        }),
            ...
            (t = e[n]),
              s.preserve_cdata && 0 === t.value.indexOf("[CDATA[")
                ...
                : 0 === t.value.indexOf("mce:protected ") &&
                  ((t.name = "#text"), (t.type = 3), (t.raw = !0), (t.value = unescape(t.value).substr(14)));
        }),
        t.addNodeFilter("xml:namespace,input", function (e, t) {
          for (var n, r = e.length; r--; )
            7 === (n = e[r]).type
              ? n.remove()
              : 1 === n.type && ("input" !== t || n.attr("type") || n.attr("type", "text"));
        }),
        ...
        serialize: function (e, t) {
          ...
          var n,
            ...
            h =
              ...
              o.selection || Or(Ne.fromDom(r)) ? i : hr.trim(i)),
            v =
              ((a = x),
              (u = h),
              (d = (s = p).selection ? pe({ forced_root_block: !1 }, s) : s),
              (m = a.parse(u, d)),
              (f = function (e) {
                return e && "br" === e.name;
              })((c = m.lastChild)) &&
  ...
  var Ov = 0,
    ...
    Pv = function (u) {
      var n,
          ...
          m(e.src, t),
            u.$(e).attr({
              src: u.getParam("images_reuse_filename", !1, "boolean")
                ? (n = t) + (-1 === n.indexOf("?") ? "?" : "&") + new Date().getTime()
                : t,
              "data-mce-src": r,
            });
        },
                  ...
                  l(function (e) {
                    var t = U(e, function (e, t) {
                      var n,
                        ...
                        i = a[t].image;
                      return (
                        e.status && u.getParam("images_replace_blob_uris", !0, "boolean")
                          ? (s.removeByUri(i.src), g(i, e.url))
                          : e.error &&
                            ((n = u), (r = e.error), ih(n, ka.translate(["Failed to upload image: {0}", r]))),
        ...
        b = function () {
          return (i = i || gv(a, s)).findAll(u.getBody(), y).then(
            l(function (e) {
              return (
                (e = H(e, function (e) {
                  return "string" != typeof e || (ih(u, e), !1);
                })),
                z(e, function (e) {
  ...
  var Uv,
    ...
    Vv = function (e, t) {
      var n,
        ...
        g = function (n, e, t) {
          ...
          return (
            ...
            t &&
              (r || (r = Hv.create("div")).appendChild(n),
              hr.each(t, function (e) {
                var t = p(e);
                r.insertBefore(t, n);
              })),
      ...
      return e && e.length
        ? ((o = e[0]), (n = p(o)), (r = Hv.create("div")).appendChild(g(n, e.slice(1), o.siblings)), r)
        : "";
    },
    qv = function (e) {
      var t,
      ...
      return "preview" in e && !1 === (u = e.preview)
        ...
        : ((t = e.block || e.inline || "span"),
            ...
            (c = e.selector) && "string" == typeof c
              ? ((c = (c = c.split(/\s*,\s*/)[0]).replace(/\s*(~\+|~|\+|>)\s*/g, "$1")),
                hr
                  ...
                  .reverse())
              : []).length
            ? (i[0].name || (i[0].name = t), (t = e.selector), Vv(i, n))
            : Vv([t], n)),
          ...
          jv(e.classes, function (e) {
            (e = l(e)), Hv.hasClass(o, e) || Hv.addClass(o, e);
          }),
          n.fire("PreviewFormats"),
          Hv.setStyles(r, { position: "absolute", left: -65535 }),
            ...
            if (
              !(
                ("background-color" === e &&
                  ...
                  ((t = Hv.getStyle(n.getBody(), e, !0)), "#ffffff" === Hv.toHex(t).toLowerCase())) ||
                ("color" === e && "#000000" === Hv.toHex(t).toLowerCase())
              )
            ) {
    ...
    Wv = function (s) {
      ...
      return (
        ...
        lp(s),
        {
          ...
          apply: function (e, t, n) {
            var r, o, i;
            (r = e), (o = t), (i = n), wg(s).formatter.apply(r, o, i);
          },
          remove: function (e, t, n, r) {
            var o, i, a, u;
            (o = e), (i = t), (a = n), (u = r), wg(s).formatter.remove(o, i, a, u);
          },
          toggle: function (e, t, n) {
            var r, o, i;
            (r = e), (o = t), (i = n), wg(s).formatter.toggle(r, o, i);
          },
          match        : N(Gm, s),
          matchAll     : N(Jm, s),
          matchNode    : N(Ym, s),
    ...
    Kv = function (n, r, o) {
        ...
        n.on("keyup", function (e) {
          ...
          e.isDefaultPrevented() ||
            ...
            i.get() &&
              r.typing &&
              !1 === lg(ag(n), r.data[0]) &&
              (!1 === n.isDirty() && (n.setDirty(!0), n.fire("change", { level: r.data[0], lastLevel: null })),
              n.fire("TypingUndo"),
              i.set(!1),
              n.nodeChanged()));
        }),
          ...
          if (!e.isDefaultPrevented())
            if ((33 <= t && t <= 36) || (37 <= t && t <= 40) || 45 === t) r.typing && a(e);
              ...
              !(t < 16 || 20 < t) ||
                ...
                r.typing ||
                n ||
                (r.beforeChange(), dg(r, !0, o), r.add({}, e), i.set(!0));
            }
        }),
      ...
      n.on("input", function (e) {
        var t;
        e.inputType &&
          ("insertReplacementText" === e.inputType || ("insertText" === (t = e).inputType && null === t.data)) &&
          a(e);
      }),
      ...
      var e,
        ...
        d = {
          ...
          beforeChange: function () {
            var e, t;
            (e = l), (t = c), wg(s).undoManager.beforeChange(e, t);
          },
          add: function (e, t) {
            return (
              (n = d), (r = f), (o = l), (i = c), (a = e), (u = t), wg(s).undoManager.addUndoLevel(n, r, o, i, a, u)
            );
            var n, r, o, i, a, u;
          },
          undo: function () {
            return (e = d), (t = l), (n = f), wg(s).undoManager.undo(e, t, n);
            var e, t, n;
          },
          redo: function () {
            return (e = s), (t = f), (n = d.data), wg(e).undoManager.redo(t, n);
            var e, t, n;
          },
          clear: function () {
            var e, t;
            (e = d), (t = f), wg(s).undoManager.clear(e, t);
          },
          reset: function () {
            var e;
            (e = d), wg(s).undoManager.reset(e);
          },
          hasUndo: function () {
            return (e = d), (t = f), wg(s).undoManager.hasUndo(e, t);
            var e, t;
          },
          hasRedo: function () {
            return (e = d), (t = f), wg(s).undoManager.hasRedo(e, t);
            var e, t;
          },
          transact: function (e) {
            return (t = d), (n = l), (r = e), wg(s).undoManager.transact(t, n, r);
            var t, n, r;
          },
          ignore: function (e) {
            var t, n;
            (t = l), (n = e), wg(s).undoManager.ignore(t, n);
          },
          extra: function (e, t) {
            var n, r, o, i;
            (n = d), (r = f), (o = e), (i = t), wg(s).undoManager.extra(n, r, o, i);
          },
        };
      return (
        yg(s) || Kv(s, d, l),
    ...
    Yv = [
      ...
      Zh.LEFT,
      Zh.RIGHT,
    ].concat(rr.browser.isFirefox() ? [224] : []),
    Gv = "data-mce-placeholder",
    Jv = function (e) {
    ...
    Zv = function (a) {
      var e,
        u = a.dom,
        s = Hs(a),
        c = (e = a).getParam("placeholder", Us.getAttrib(e.getElement(), "placeholder"), "string"),
        l = function (e, t) {
          if (
            !(function (e) {
              if (Jv(e)) {
            ...
            var n,
              ...
              o = a.getBody(),
              i =
                !(Jv((n = e)) && !(Qv(n) || ("keyup" === n.type && 229 === n.keyCode))) &&
                (function (e, t, n) {
            ...
            (("" !== u.getAttrib(o, Gv)) === i && !t) ||
              (u.setAttrib(o, Gv, i ? c : null),
        ...
        a.on("init", function (e) {
          l(e, !0),
            ...
            a.on("remove", function () {
              var e = a.getBody();
              u.setAttrib(e, Gv, null), u.setAttrib(e, "aria-placeholder", null);
            });
        });
    },
    ey = function (e) {
    ...
    ty = function (a) {
      var u = xa(R.none()),
        s = xa(!1),
        r = Aa(function (e) {
          a.fire("longpress", pe(pe({}, e), { type: "longpress" })), s.set(!0);
        }, 400);
      a.on(
        "touchstart",
        function (n) {
          ey(n).each(function (e) {
            ...
            r.throttle(n), s.set(!1), u.set(R.some(t));
          });
        },
        !0
      ),
              ...
              ey(e).each(function (i) {
                u.get().each(function (e) {
                  ...
                  (t = i),
                    ...
                    (5 < r || 5 < o) && (u.set(R.none()), s.set(!1), a.fire("longpresscancel"));
                });
              });
          },
          !0
            ...
            r.cancel(),
              "touchcancel" !== t.type &&
                u
                  ...
                  .each(function () {
                    s.get() ? t.preventDefault() : a.fire("tap", pe(pe({}, t), { type: "tap" }));
                  });
          },
          !0
        );
    ...
    oy = function (e) {
      ...
      if (
        ...
        m.isValidChild(l, v.toLowerCase()) &&
          ((y = p),
          (b = h),
          (C = g),
        ...
        for (
          ...
          if (((w = p), Zt((x = g)) || ($t(x) && !ny(w, x) && !ll(x)))) {
            if (ry(p, g)) {
              (g = (u = g).nextSibling), f.remove(u);
              continue;
            }
            a || ((a = f.create(v, Vs(e))), g.parentNode.insertBefore(a, g), (s = !0)),
              (g = (u = g).nextSibling),
              a.appendChild(u);
    ...
    iy = function (e, t, n) {
      var r = e ? 1 : -1;
      return (
        t.setRng(ms(n.container(), n.offset() + r).toRange()),
    ...
    ay = function (e, t) {
      ...
      return (
        !!D(t.selection.getSel().modify) &&
        (e && vu(r) ? iy(!0, t.selection, r) : !(e || !yu(r)) && iy(!1, t.selection, r))
      );
    },
    uy = Zt,
    sy = function (e) {
        ...
        e
          ? function (e) {
              if (uy(e.previousSibling))
                return cy(e.previousSibling) || e.previousSibling.appendData(su), e.previousSibling;
              if (uy(e)) return sy(e) || e.insertData(0, su), e;
              var t = ly(e);
              return e.parentNode.insertBefore(t, e), t;
            }
          : function (e) {
              if (uy(e.nextSibling)) return sy(e.nextSibling) || e.nextSibling.insertData(0, su), e.nextSibling;
              if (uy(e)) return cy(e) || e.appendData(su), e;
              var t = ly(e);
    ...
    hy = function (n, e) {
      return e.fold(
        function (e) {
          rc(n.get());
          var t = dy(e);
          return n.set(t), R.some(ms(t, t.length - 1));
        },
        function (e) {
          return Zc(e).map(function (e) {
            if (gy(e, n)) return ms(n.get(), 1);
            rc(n.get());
            var t = py(e, !0);
        ...
        function (e) {
          return el(e).map(function (e) {
            if (gy(e, n)) return ms(n.get(), n.get().length - 1);
            rc(n.get());
            var t = py(e, !1);
    ...
    by = function (e) {
      return "rtl" === ga.DOM.getStyle(e, "direction", !0) || ((t = e.textContent), vy.test(t));
      var t;
    },
    Cy = function (e, t, n) {
      var r,
        o,
        i,
        a = ((r = e), (o = t), (i = n), H(ga.DOM.getParents(i.container(), "*", o), r));
      ...
      return e
        ? pu(n)
          ...
          : vu(t)
            ...
            : t
        : pu(n)
          ? Zt(n.previousSibling)
            ? ms(n.previousSibling, n.previousSibling.data.length)
            : ms.before(n)
          : yu(t)
            ? ms(n, r - 1)
            : t;
    ...
    Ey = hd([{ before: ["element"] }, { start: ["element"] }, { end: ["element"] }, { after: ["element"] }]),
    ky = function (e, t) {
      var n = yc(t, e);
      return n || e;
    },
    ...
    Uy = function (a, e, u, t, n, s) {
      return $u(Cy(e, u, t), Cy(e, u, n), function (e, t) {
        return e !== t && ((r = t), (o = yc(e, (n = u))), (i = yc(r, n)), o && o === i) ? Ey.after(a ? e : t) : s;
        var n, r, o, i;
      }).getOr(s);
    },
    zy = function (e, r) {
      return e.fold(x(!0), function (e) {
        return (n = r), !(Iy((t = e)) === Iy(n) && Ly(t) === Ly(n));
        var t, n;
      });
    },
    jy = function (e, t) {
      return e
        ? t.fold(a(R.some, Ey.start), R.none, a(R.some, Ey.after), R.none)
        : t.fold(R.none, a(R.some, Ey.before), R.none, a(R.some, Ey.end));
    },
    Hy = function (e, a, u, s) {
      var t = wy(e, s),
        c = Py(a, u, t);
    ...
    Ky = function (e, t) {
      if (e.selection.isCollapsed() && !0 !== e.composing && t.get()) {
        ...
        ms.isTextPosition(n) && !1 === (vu((r = n)) || yu(r)) && (Vy(e, nc(t.get(), n)), t.set(null));
      }
      var r;
    },
    Xy = function (a, u, s) {
        ...
        function (e, t) {
          return e.concat(
            (function (t) {
              ...
              if ($t(t)) return e(t.getClientRects());
              if (Zt(t)) {
                var n = t.ownerDocument.createRange();
  ...
  ((zv = Uv = Uv || {})[(zv.Up = -1)] = "Up"), (zv[(zv.Down = 1)] = "Down");
  var eb,
    tb,
    nb = function (o, i, a, e, u, t) {
      var n,
        s,
        c = 0,
        l = [],
        r = function (e) {
          var t, n, r;
          for (r = Zy([e]), -1 === o && (r = r.reverse()), t = 0; t < r.length; t++)
            if (((n = r[t]), !a(n, s))) {
              if ((0 < l.length && i(n, fr(l)) && c++, (n.line = c), u(n))) return !0;
              l.push(n);
            }
        };
      return (
        (s = fr(t.getClientRects())) &&
          (r((n = t.getNode())),
          (function (e, t, n, r) {
            for (; (r = vc(r, e, Bu, t)); ) if (n(r)) return;
          })(o, e, r, n)),
        l
      );
    },
    rb = N(nb, Uv.Up, Fu, Uu),
    ob = N(nb, Uv.Down, Uu, Fu),
    ib = function (n) {
      return function (e) {
        return (t = n), e.line > t;
        var t;
    ...
    mb = function (e, t, n, r) {
      for (; (r = sb(r, e, Bu, t)); ) if (n(r)) return;
    },
    pb = function (e, t, n) {
      var r,
        o,
        ...
        s,
        c,
        l = Zy(H(te(e.getElementsByTagName("*")), cc)),
        f = H(l, function (e) {
      ...
      return (r =
        ...
        ? ((i = t), { node: (o = r).node, before: cb(o, i) < lb(o, i) })
        : null;
    },
    gb = on,
    hb = an,
    ...
    bb = function (e, t, n) {
      var r = Ec(1, e.getBody(), t),
        ...
        i = o.getNode();
      if (hb(i)) return vb(1, e, i, !o.isAtEnd(), !1);
      var a = o.getNode(!0);
      if (hb(a)) return vb(1, e, a, !1, !1);
  ...
  var wb = function (e, t) {
    ...
    xb = function (e, t, n, r) {
      for (
        var o, i, a, u, s, c, l = Hc(n), f = r, d = [];
        f && ((s = l), (c = f), (o = t === fs.Forwards ? s.next(c) : s.prev(c)));

      ) {
        if (rn(o.getNode(!1)))
          return t === fs.Forwards
            ? { positions: wb(t, d).concat([o]), breakType: eb.Br, breakAt: R.some(o) }
            : { positions: wb(t, d), breakType: eb.Br, breakAt: R.some(o) };
        if (o.isVisible()) {
          if (e(f, o)) {
            var m =
              ((i = t), (a = f), rn((u = o).getNode(i === fs.Forwards)) ? eb.Br : !1 === bc(a, u) ? eb.Block : eb.Wrap);
            return { positions: wb(t, d), breakType: m, breakAt: R.some(o) };
          }
          d.push(o), (f = o);
        } else f = o;
      }
      return { positions: wb(t, d), breakType: eb.Eol, breakAt: R.none() };
    },
    Sb = function (n, r, o, e) {
      return r(o, e)
    ...
    Ob = function (e, t, n, r) {
      ...
      if (!r.collapsed) {
        var a = Db(r);
        if (Ab(a)) return vb(e, t, a, e === fs.Backwards, !0);
      }
      var u = mu(r.startContainer),
        s = _c(e, t.getBody(), r);
      if (i(s)) return yb(t, s.getNode(!o));
      var c = wy(o, n(s));
      if (!c) return u ? r : null;
      if (i(c)) return vb(e, t, c.getNode(!o), o, !0);
      var l = n(c);
    ...
    Bb = function (e, t, n, r) {
      ...
      if (
        ...
        return null;
      if (((c = s.left), (u = db(a, c)) && Ab(u.node)))
        return (l = Math.abs(c - u.left)), (f = Math.abs(c - u.right)), vb(e, t, u.node, l < f, !0);
      if (d) {
        var m = (function (e, t, n, r) {
          ...
          c = m(
            (u =
              1 === e
                ? ((o = l.next), (i = Uu), (a = Fu), ms.after(r))
                : ((o = l.prev), (i = Fu), (a = Uu), ms.before(r)))
          );
          do {
            if (u.isVisible() && !a((s = m(u)), c)) {
              if ((0 < f.length && i(s, fr(f)) && d++, ((s = Lu(s)).position = u), (s.line = d), n(s))) return f;
              f.push(s);
            }
          } while ((u = o(u)));
          return f;
        })(e, t.getBody(), ib(1), d);
        if ((u = db(H(m, ab(1)), c))) return Cb(t, u.position.toRange(), !0);
        if ((u = fr(H(m, ab(0))))) return Cb(t, u.position.toRange(), !0);
      }
    },
    Pb = function (e, t, n) {
      var r,
      ...
      if (n.collapsed && e.settings.forced_root_block) {
        ...
        (1 === t ? s : c)(ms.fromRangeStart(n)) ||
          ((a = (i = e).dom.create(Hs(i))),
    ...
    Mb = function (r, o) {
      return function () {
        var t,
          e = o ? ms.fromRangeEnd(r.selection.getRng()) : ms.fromRangeStart(r.selection.getRng()),
          n = (o ? _b : kb)(r.getBody(), e);
    ...
    Ub = function (e, t, n, r, o) {
      var i,
        a,
        u = Ua(Ne.fromDom(n), "td,th,caption").map(function (e) {
          return e.dom();
        }),
    ...
    $b = function (e, t, n) {
      var r,
        ...
        a,
        u = e(t, n);
      return ((a = u).breakType === eb.Wrap && 0 === a.positions.length) ||
        (!rn(n.getNode()) && (i = u).breakType === eb.Br && 1 === i.positions.length)
        ? ((r = e),
          (o = t),
          !u.breakAt
            .map(function (e) {
                ...
                return (
                  ...
                  void ((i = Hs((r = u)))
                    ? r.undoManager.transact(function () {
                        var e = Ne.fromTag(i);
                        ln(e, Vs(r)), St(e, Ne.fromTag("br")), (n ? wt : Ct)(Ne.fromDom(o), e);
                        var t = r.dom.createRng();
                        t.setStart(e.dom(), 0), t.setEnd(e.dom(), 0), qb(r, t);
                      })
                    : qb(r, t.toRange()))
                );
                var n, r, o, t, i;
    ...
    rC = function (e, t, n, r) {
      return "" === t
        ? ((l = e), (f = r), (d = Ne.fromTag("br")), nC(l, d, f), tC(d))
        : ((o = e),
          (i = r),
          (a = t),
          (u = n),
    ...
    oC = function (e, t, n) {
      return t ? ((o = e.dom()), _b(o, n).breakAt.isNone()) : ((r = e.dom()), kb(r, n).breakAt.isNone());
      var r, o;
    },
    iC = function (t, n) {
      var e,
        r,
        o = Ne.fromDom(t.getBody()),
        i = ms.fromRangeStart(t.selection.getRng()),
        a = Hs(t),
        u = Vs(t);
      return (
        (e = i),
        (r = N(at, o)),
        Va(Ne.fromDom(e.container()), Sr, r)
          .filter(eC)
          .exists(function () {
            if (oC(o, n, i)) {
              var e = rC(o, a, u, n);
    ...
    uC = function (e, r) {
      return Y(
        U(e, function (e) {
          return pe({ shiftKey: !1, altKey: !1, ctrlKey: !1, metaKey: !1, keyCode: 0, action: f }, e);
        }),
        function (e) {
          return (
            (t = e),
    ...
    lC = function (i, a) {
      i.on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          cC(
            [
              { keyCode: Zh.RIGHT, action: Lb(t, !0) },
              { keyCode: Zh.LEFT, action: Lb(t, !1) },
              { keyCode: Zh.UP, action: Ib(t, !1) },
              { keyCode: Zh.DOWN, action: Ib(t, !0) },
              { keyCode: Zh.RIGHT, action: Qb(t, !0) },
              { keyCode: Zh.LEFT, action: Qb(t, !1) },
              { keyCode: Zh.UP, action: Zb(t, !1) },
              { keyCode: Zh.DOWN, action: Zb(t, !0) },
              { keyCode: Zh.RIGHT, action: Xy(t, n, !0) },
              { keyCode: Zh.LEFT, action: Xy(t, n, !1) },
              { keyCode: Zh.RIGHT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: Jy(t, n) },
              { keyCode: Zh.LEFT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: Qy(t, n) },
              { keyCode: Zh.UP, action: aC(t, !1) },
              { keyCode: Zh.DOWN, action: aC(t, !0) },
            ],
            r
          ).each(function (e) {
            r.preventDefault();
    ...
    gC = function (o, i, e) {
          ...
          return Kc(i, o, e.position).bind(function (e) {
            return pC(o, e).map(function (e) {
              return (
                (t = o),
                (n = i),
                rn((r = e).position.getNode()) && !1 === Gf(r.block)
                  ? Gc(!1, r.block.dom())
                      .bind(function (e) {
                        return e.isEqual(r.position)
                          ? Kc(n, t, e).bind(function (e) {
                              return pC(t, e);
                            })
                          : R.some(r);
                      })
      ...
      return $u(t, n, mC).filter(function (e) {
        return (
          !1 === at((r = e).from.block, r.to.block) &&
          ft((n = e).from.block)
            .bind(function (t) {
    ...
    bC = function (e, t, n) {
      if (Gf(n)) return kt(n), Gf(t) && Qf(t), Zc(t.dom());
      var r = el(n.dom());
      return (
        z(hC(t), function (e) {
          St(n, e);
    ...
    CC = function (e, t) {
      return st(t, e) ? ((n = nd(e, t)), R.from(n[n.length - 1])) : R.none();
      var n;
    },
    wC = function (e, t) {
      Gc(e, t.dom())
    ...
    xC = function (e, t, n) {
      return wC(!0, t), wC(!1, n), CC(t, n).fold(N(bC, e, t, n), N(yC, e, t, n));
    },
    SC = function (e, t, n, r) {
    ...
    kC = function (e, t) {
      var n,
        r,
        o = Qc(e.dom(), ms.fromRangeStart(t)).isNone(),
        i = Jc(e.dom(), ms.fromRangeEnd(t)).isNone();
    ...
    OC = function (e, t) {
      return (n = t), R.from(n.getNode(!0)).map(Ne.fromDom).exists(Er) || AC(!1, e, t).isSome();
      var n;
    },
    BC = N(AC, !1),
    PC = N(AC, !0),
    LC = hd([{ remove: ["element"] }, { moveToElement: ["element"] }, { moveToPosition: ["position"] }]),
    IC = function (e, t, n, r) {
      var o = r.getNode(!1 === t);
      return fC(Ne.fromDom(e), Ne.fromDom(n.getNode()))
        .map(function (e) {
    ...
    MC = function (u, s, c) {
      return Kc(s, u, c).bind(function (e) {
        return (
          (a = e.getNode()),
          Dr(Ne.fromDom(a)) || Rr(Ne.fromDom(a))
            ? R.none()
            : ((t = u),
              (o = e),
              (i = function (e) {
              ...
              kc(!(n = s), (r = c)).fold(function () {
                ...
                ? R.none()
                : (s && an(e.getNode())) || (!1 === s && an(e.getNode(!0)))
                  ? IC(u, s, c, e)
                  : (s && qf(c)) || (!1 === s && Vf(c))
                    ? R.some(LC.moveToPosition(e))
                    : R.none())
        );
        var t, n, r, o, i, a;
      });
    ...
    FC = function (r, e, o) {
      return (
        ...
        (a = o.getNode(!1 === i)),
        (u = i ? "after" : "before"),
        $t(a) && a.getAttribute("data-mce-caret") === u
          ? ((t = e),
            (n = o.getNode(!1 === e)),
            (t && an(n.nextSibling)
              ? R.some(LC.moveToElement(n.nextSibling))
              : !1 === t && an(n.previousSibling)
                ? R.some(LC.moveToElement(n.previousSibling))
                : R.none()
            ).fold(function () {
              return MC(r, e, o);
            }, R.some))
          : MC(r, e, o).bind(function (e) {
              return (
                (t = r),
                (n = o),
                e.fold(
      ...
      return UC(a, e)
        ...
        .fold(
          function () {
            ...
            (i = Ne.fromDom(e)),
            (!1 === t && qf(o)
              ? R.some(LC.remove(o.getNode(!0)))
              : t && Vf(o)
                ? R.some(LC.remove(o.getNode()))
                : !1 === t && Vf(o) && OC(i, o)
                  ? BC(i, o).map(function (e) {
                      return LC.remove(e.getNode());
                    })
                  : t && qf(o) && DC(i, o)
                    ? PC(i, o).map(function (e) {
                        return LC.remove(e.getNode());
                      })
                    : FC(e, t, o)
            ).map(function (e) {
              return e.fold(
                function (e) {
                  return o._selectionOverrides.hideFakeCaret(), gd(o, i, Ne.fromDom(e)), !0;
                },
                ((r = i = u),
                function (e) {
    ...
    VC = function (e) {
      var t,
        n = HC(e.getBody(), e.selection.getNode());
      return (
        on(n) &&
          e.dom.isBlock(n) &&
          e.dom.isEmpty(n) &&
    ...
    WC = function (e, t) {
      return (function (e, t) {
        ...
        var r = t ? fs.Forwards : fs.Backwards,
          ...
          c = _c(r, e.getBody(), n),
          l = wy(t, u(c));
        if (!l || !Ac(c, l)) return !1;
        if (s(l)) return $C(e, n, c.getNode(), r, t, l);
        var f = u(l);
    ...
    YC = function (n, r, i, o) {
      var e,
        t,
        a = ((e = n.getBody()), (t = o.container()), yc(t, e) || e),
        u = N(yy, n),
        s = Py(u, a, o);
      return s
        .bind(function (e) {
          return i
            ? e.fold(x(R.some(Fy(e))), R.none, x(R.some(My(e))), R.none)
            : e.fold(R.none, x(R.some(My(e))), R.none, x(R.some(Fy(e))));
        })
        .map(KC(n, r))
        .getOrThunk(function () {
          var t = Xc(i, a, o),
            ...
            : e
                .bind(function (e) {
                  return t.map(function (e) {
                    return i ? XC(n, r, o, e) : XC(n, r, e, o), !0;
                  });
                })
                .getOr(!1);
        });
    ...
    ZC = function (r, o) {
      var t,
        e = Ne.fromDom(r.getBody()),
        n = Ne.fromDom(r.selection.getStart()),
        s = H(
          ((t = nd(n, e)),
      ...
      return ee(s)
        .map(function (e) {
          var t,
            ...
            a,
            u,
            n = ms.fromRangeStart(r.selection.getRng());
          return (
            (i = o),
            (a = n),
            (u = e.dom()),
    ...
    hw = function (e, t, n) {
      if (e.selection.isCollapsed() && ow(e)) {
        ...
        if (null !== a && dw(Ne.fromDom(a), i)) return uw(e, "outdent"), !0;
      }
      return !1;
    },
    vw = function (o, i) {
      o.on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          cC(
            [
              { keyCode: Zh.BACKSPACE, action: sC(hw, t, !1) },
              { keyCode: Zh.BACKSPACE, action: sC(qC, t, !1) },
              { keyCode: Zh.DELETE, action: sC(qC, t, !0) },
              { keyCode: Zh.BACKSPACE, action: sC(WC, t, !1) },
              { keyCode: Zh.DELETE, action: sC(WC, t, !0) },
              { keyCode: Zh.BACKSPACE, action: sC(GC, t, n, !1) },
              { keyCode: Zh.DELETE, action: sC(GC, t, n, !0) },
              { keyCode: Zh.BACKSPACE, action: sC(Vd, t, !1) },
              { keyCode: Zh.DELETE, action: sC(Vd, t, !0) },
              { keyCode: Zh.BACKSPACE, action: sC(tw, t, !1) },
              { keyCode: Zh.DELETE, action: sC(tw, t, !0) },
              { keyCode: Zh.BACKSPACE, action: sC(RC, t, !1) },
              { keyCode: Zh.DELETE, action: sC(RC, t, !0) },
              { keyCode: Zh.BACKSPACE, action: sC(NC, t, !1) },
              { keyCode: Zh.DELETE, action: sC(NC, t, !0) },
              { keyCode: Zh.BACKSPACE, action: sC(ew, t, !1) },
              { keyCode: Zh.DELETE, action: sC(ew, t, !0) },
            ],
            r
          ).each(function (e) {
            r.preventDefault();
        ...
        o.on("keyup", function (e) {
          ...
          !1 === e.isDefaultPrevented() &&
            ...
            cC(
              [
                { keyCode: Zh.BACKSPACE, action: sC(VC, t) },
                { keyCode: Zh.DELETE, action: sC(VC, t) },
              ],
              n
            ));
        });
    ...
    Sw = function (e, t, n) {
      for (var r = e[n ? "firstChild" : "lastChild"]; r && !$t(r); ) r = r[n ? "nextSibling" : "previousSibling"];
      return r === t;
    },
    Nw = function (e, t, n, r, o) {
      ...
      if (n !== e.getBody()) {
        ...
        var s,
          c,
          l = o ? t(o) : i.create("BR");
        if (Sw(n, r, !0) && Sw(n, r, !1)) Cw(n, "LI") ? i.insertAfter(l, xw(n)) : i.replace(l, n);
        else if (Sw(n, r, !0))
          Cw(n, "LI")
            ? (i.insertAfter(l, xw(n)), l.appendChild(i.doc.createTextNode(" ")), l.appendChild(n))
            : n.parentNode.insertBefore(l, n);
        else if (Sw(n, r, !1)) i.insertAfter(l, xw(n));
        else {
          n = xw(n);
          var f = a.cloneRange();
    ...
    Rw = function (e, t, n) {
      return !1 === Zt(t)
        ? n
        : e
          ? 1 === n && t.data.charAt(n - 1) === su
            ? 0
            : n
          : n === t.data.length - 1 && t.data.charAt(n) === su
            ? t.data.length
            : n;
    },
    Tw = function (e, t) {
    ...
    Ow = function (a, e) {
      var t,
        ...
        b = function (e) {
          var t,
            ...
            r,
            o = s,
            i = h.getTextInlineElements();
          if (
            ((r = t = e || "TABLE" === f || "HR" === f ? g.create(e || m) : c.cloneNode(!1)),
            !1 === a.getParam("keep_styles", !0))
          )
            g.setAttrib(t, "style", null), g.setAttrib(t, "class", null);
          else
            do {
              if (i[o.nodeName]) {
                if (Ms(o) || ll(o)) continue;
                (n = o.cloneNode(!1)),
                  g.setAttrib(n, "id", ""),
          ...
          return Dw(a, t), Ew(r), t;
        },
        C = function (e) {
          var t,
            n,
            r = Rw(e, s, i);
          if (Zt(s) && (e ? 0 < r : r < s.nodeValue.length)) return !1;
          if (s.parentNode === c && p && !e) return !0;
          if (e && $t(s) && s === c.firstChild) return !0;
          if (kw(s, "TABLE") || kw(s, "HR")) return (p && !e) || (!p && e);
          var o = new ra(s, c);
        ...
        w = function () {
          (r = /^(H[1-6]|PRE|FIGURE)$/.test(f) && "HGROUP" !== d ? b(m) : b()),
            a.getParam("end_container_on_empty_block", !1) && _w(g, l) && g.isEmpty(c)
              ? (r = g.split(l, c))
              : g.insertAfter(r, c),
            yw(a, r);
        };
      ...
      $t(s) &&
        ...
        (u = Tw(g, s)) &&
          (((m && !n) || (!m && n)) &&
            (s = (function (e, t, n, r, o) {
              ...
              if (!(a = m.getParent(r, m.isBlock)) || !_w(m, a)) {
                if (
                  ((l =
                    (a = a || p) === e.getBody() || ((f = a) && /^(TD|TH|CAPTION)$/.test(f.nodeName))
                      ? a.nodeName.toLowerCase()
                      : a.parentNode.nodeName.toLowerCase()),
                  !a.hasChildNodes())
                )
                  return (i = m.create(d)), Dw(e, i), a.appendChild(i), n.setStart(i, 0), n.setEnd(i, 0), i;
                for (s = r; s.parentNode !== a; ) s = s.parentNode;
                for (; s && !m.isBlock(s); ) s = (u = s).previousSibling;
                if (u && e.schema.isValidChild(l, d.toLowerCase())) {
                  for (i = m.create(d), Dw(e, i), u.parentNode.insertBefore(i, u), s = u; s && !m.isBlock(s); )
          ...
          "LI" !== (d = l ? l.nodeName.toUpperCase() : "") || R || ((l = (c = l).parentNode), (f = d)),
          /^(LI|DT|DD)$/.test(f) && g.isEmpty(c)
            ? Nw(a, b, l, c, m)
            : (m && c === a.getBody()) ||
              ((m = m || "P"),
              mu(c)
                ? ((r = xu(c)), g.isEmpty(c) && Ew(c), Dw(a, r), yw(a, r))
                : C()
                  ? w()
                  : C(!0)
                    ? ((r = c.parentNode.insertBefore(b(), c)), yw(a, kw(c, "HR") ? r : c))
                    : ((_ = (k = y).cloneRange()).setStart(k.startContainer, Rw(!0, k.startContainer, k.startOffset)),
                      ...
                      g.isEmpty(c) && Ew(c),
                      r.normalize(),
                      g.isEmpty(r) ? (g.remove(r), w()) : (Dw(a, r), yw(a, r))),
              g.setAttrib(r, "id", ""),
    ...
    Iw = function (e, t) {
      var n = Ne.fromTag("br");
      Ct(Ne.fromDom(t), n), e.undoManager.add();
    },
    Mw = function (e, t) {
      Fw(e.getBody(), t) || wt(Ne.fromDom(t), Ne.fromTag("br"));
      var n = Ne.fromTag("br");
      wt(Ne.fromDom(t), n), Bw(e.dom, e.selection, n.dom()), Pw(e.dom, e.selection, n.dom(), !1), e.undoManager.add();
    },
    Fw = function (e, t) {
      return (
        (n = ms.after(t)),
    ...
    Hw = function (e, t) {
      var n,
        r,
        o,
        i = ((r = N(yy, (n = e))), (o = ms.fromRangeStart(n.selection.getRng())), Py(r, n.getBody(), o).filter(zw));
    ...
    tx = function (e, t) {
      return Ny(
        [
          ex([$w], qw.none()),
          ex([Xw("summary", !0)], qw.br()),
          ex([Yw(!0), Gw(!1), Qw], qw.br()),
          ex([Yw(!0), Gw(!1)], qw.block()),
          ex([Yw(!0), Gw(!0), Qw], qw.block()),
          ex([Yw(!0), Gw(!0)], qw.br()),
          ex([Kw(!0), Qw], qw.br()),
          ex([Kw(!0)], qw.block()),
          ex([Ww(!0), Qw, Zw], qw.block()),
          ex([Ww(!0)], qw.br()),
          ex([Jw], qw.br()),
          ex([Ww(!1), Qw], qw.br()),
          ex([Zw], qw.block()),
        ...
        e.keyCode === Zh.ENTER &&
          ...
          (n = e).isDefaultPrevented() ||
            ...
            t.undoManager.transact(function () {
              !1 === t.selection.isCollapsed() && t.execCommand("Delete"), nx(t, n);
            })));
      });
    },
    ox = function (n, r) {
      var e = r.container(),
        t = r.offset();
      return Zt(e)
        ? (e.insertData(t, n), R.some(ls(e, t + n.length)))
        : Rc(r).map(function (e) {
            var t = Ne.fromText(n);
            return (r.isAtEnd() ? wt : Ct)(e, t), ls(t.dom(), n.length);
          });
    },
    ix = N(ox, oo),
    ax = N(ox, " "),
    ...
    fx = function (e) {
      return Rc(e)
        ...
        .exists(function (e) {
          return (t = mn(e, "white-space")), M(["pre", "pre-wrap"], t);
          var t;
        });
    },
    dx = function (e, t) {
      return (
        (r = t),
        Qc(e.dom(), r).isNone() || ((n = t), Jc(e.dom(), n).isNone()) || dw(e, t) || mw(e, t) || OC(e, t) || DC(e, t)
      );
      var n, r;
    },
    mx = function (e, t) {
      var n,
        r,
        o,
        i = ((r = (n = t).container()), (o = n.offset()), Zt(r) && o < r.data.length ? ls(r, o + 1) : n);
      return !fx(i) && (mw(e, i) || gw(e, i) || DC(e, i) || lx(e, i));
    },
    px = function (e, t) {
      return (n = e), (!fx((r = t)) && (dw(n, r) || pw(n, r) || OC(n, r) || cx(n, r))) || mx(e, t);
      var n, r;
    },
    gx = function (e, t) {
    ...
    yx = function (l, e) {
      return R.some(e)
        ...
        .bind(function (e) {
          ...
          (u = (a = c).data),
          (s = ls(a, 0)),
          !(!gx(u, 0) || px(i, s) || ((a.data = " " + u.slice(1)), 0)) ||
            vx(c) ||
            ((t = l),
            (r = (n = c).data),
            (o = ls(n, r.length - 1)),
            !(!gx(r, r.length - 1) || px(t, o) || ((n.data = r.slice(0, -1) + " "), 0))))
            ? R.some(e)
            : R.none();
        });
    },
    bx = function (t) {
      ...
      t.selection.isCollapsed() &&
        yx(e, ls.fromRangeStart(t.selection.getRng())).each(function (e) {
          t.selection.setRng(e.toRange());
        });
    },
    Cx = function (r, o) {
      return function (e) {
        return (t = r), (!fx((n = e)) && (dx(t, n) || cx(t, n) || lx(t, n)) ? ix : ax)(o);
        var t, n;
      };
    },
    wx = function (e) {
      var t,
        n,
        r = ms.fromRangeStart(e.selection.getRng()),
        o = Ne.fromDom(e.getBody());
      if (e.selection.isCollapsed()) {
        var i = N(yy, e),
          a = ms.fromRangeStart(e.selection.getRng());
        return Py(i, e.getBody(), a)
          .bind(
            ((n = o),
            function (e) {
              return e.fold(
    ...
    xx = function (r) {
      r.on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ((t = r),
          (n = e),
          cC([{ keyCode: Zh.SPACEBAR, action: sC(wx, t) }], n).each(function (e) {
            n.preventDefault();
          }));
      });
    },
    Sx = function (e, t) {
      ...
      t.hasAttribute("data-mce-caret") &&
        (xu(t), (n = e).selection.setRng(n.selection.getRng()), e.selection.scrollIntoView(t));
    },
    Nx = function (e, t) {
      var n,
        r =
      ...
      if (r)
        return "compositionstart" === t.type
          ? (t.preventDefault(), t.stopPropagation(), void Sx(e, r))
          : void (hu(r) && (Sx(e, r), e.undoManager.add()));
    },
    Ex = nt().browser,
    kx = function (t) {
      var e, n;
    ...
    _x = function (r) {
      r.on("keydown", function (e) {
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          cC(
            [
              { keyCode: Zh.END, action: Mb(t, !0) },
              { keyCode: Zh.HOME, action: Mb(t, !1) },
            ],
            n
          ).each(function (e) {
            n.preventDefault();
    ...
    Rx = function (e) {
      var t,
        n = Gy(e);
      (t = e).on("keyup compositionstart", N(Nx, t)), lC(e, n), vw(e, n), rx(e), xx(e), kx(e), _x(e);
    },
    Tx =
      ((Ax.prototype.nodeChanged = function (e) {
        var t,
          n,
          r,
        ...
        this.editor.initialized &&
          ...
          ((t = o.getStart(!0) || r).ownerDocument === this.editor.getDoc() && this.editor.dom.isChildOf(t, r)) ||
            (t = r),
          (n = []),
  ...
  function Ax(r) {
    ...
    "onselectionchange" in r.getDoc() ||
      ...
      r.on("SelectionChange", function () {
        ...
        !e ||
          (!rr.range && r.selection.isCollapsed()) ||
          (Gl(r) &&
      ...
      r.on("mouseup", function (e) {
        !e.isDefaultPrevented() &&
          ...
          ("IMG" === r.selection.getNode().nodeName
            ? Xn.setEditorTimeout(r, function () {
                r.nodeChanged();
              })
            : r.nodeChanged());
      });
  ...
  var Dx = function (e) {
    ...
    Lx = function (e, t) {
      return (
        (n = (u = e).inline ? Px(u.getBody()) : { left: 0, top: 0 }),
        (a = (i = e).getBody()),
          ...
          pageX:
            (o = (function (e, t) {
              ...
              var n,
                ...
                i,
                a,
                u = Px(e.getContentAreaContainer()),
                s =
                  ((r = (n = e).getBody()),
    ...
    zx = function (g, h) {
      ...
      return function (e) {
        ...
        if (g.dragging) {
          var p = ((f = g), { pageX: (d = Lx(h, e)).pageX - f.relX, pageY: d.pageY + 5 });
          (c = g.ghost),
            (l = h.getBody()),
        ...
        if (
          ...
          n.isDefaultPrevented() ||
            ...
            f.undoManager.transact(function () {
              Fx(l.element), f.insertContent(f.dom.getOuterHTML(t)), f._selectionOverrides.hideFakeCaret();
            }));
        }
        var r, o, i, a, u, s, c;
        Hx(l);
    ...
    Hx = function (e) {
      (e.dragging = !1), (e.element = null), Fx(e.ghost);
    },
    Vx = function (e) {
      var t,
        n,
      ...
      (t = ga.DOM),
        ...
        (u = c),
        (i = function () {
          u.dragging && s.fire("dragend"), Hx(u);
        }),
        (s = e).on("mousedown", n),
        e.on("mousemove", r),
        e.on("mouseup", o),
      ...
      var h,
        ...
        u = function (e) {
          var t = g.schema.getShortEndedElements(),
            ...
            a = e.endOffset;
          return (
            me(t, r.nodeName.toLowerCase()) ? (0 === o ? n.setStartBefore(r) : n.setStartAfter(r)) : n.setStart(r, o),
        ...
        s = function (e, t) {
          ...
          if (e.collapsed) {
            if (!C(e))
              if (!1 === t) {
                if (((c = _c(-1, v, e)), cc(c.getNode(!0)))) return b(-1, c.getNode(!0), !1, !1);
                if (cc(c.getNode())) return b(-1, c.getNode(), !c.isAtEnd(), !1);
              } else {
                if (((c = _c(1, v, e)), cc(c.getNode()))) return b(1, c.getNode(), !c.isAtEnd(), !1);
                if (cc(c.getNode(!0))) return b(1, c.getNode(!0), !1, !1);
              }
            return null;
          }
          if (
            ...
            return null;
          if ((u === a + 1 && i === e.endContainer && (n = i.childNodes[a]), !Wx(n))) return null;
          if (
            ((l = f = n.cloneNode(!0)),
            (s = g.fire("ObjectSelected", { target: n, targetClone: l })).isDefaultPrevented())
          )
            return null;
          (r = $a(Ne.fromDom(g.getBody()), "#" + y).fold(
            function () {
              return d([]);
            },
            function (e) {
            ...
            (l = s.targetClone),
            0 === r.length &&
              (r = d('<div data-mce-bogus="all" class="mce-offscreen-selection"></div>').attr("id", y)).appendTo(
                g.getBody()
              ),
            (e = g.dom.createRng()),
            l === f && rr.ie
              ? (r.empty().append('<p style="font-size: 0" data-mce-bogus="all">\xa0</p>').append(l),
                e.setStartAfter(r[0].firstChild.firstChild),
                e.setEndAfter(l))
              : (r.empty().append(oo).append(l).append(oo),
          ...
          var p = Ne.fromDom(n);
          return (
            z(Ua(Ne.fromDom(g.getBody()), "*[data-mce-selected]"), function (e) {
        ...
        c = function () {
          h && (h.removeAttribute("data-mce-selected"), $a(Ne.fromDom(g.getBody()), "#" + y).each(kt), (h = null)),
      ...
      return (
          ...
          (function () {
            g.on("mouseup", function (e) {
              ...
              g.on("click", function (e) {
                var t;
                (t = Kx(g, e.target)) &&
                  (Wx(t) && (e.preventDefault(), g.focus()), $x(t) && g.dom.isChildOf(t, g.selection.getNode()) && c());
              }),
            ...
            var n,
              i = function (e, t) {
                ...
                return (
                  !(!o || !g.dom.isChildOf(o, i) || !1 !== Wx(Kx(g, o))) ||
                  (o &&
            ...
            (n = g).on(
              ...
              function (e) {
                var t = Kx(n, e.target);
                Wx(t) && (e.preventDefault(), s(yb(n, t)));
              },
              !0
            ),
              g.on("mousedown", function (e) {
                ...
                if ((n === v || "HTML" === n.nodeName || g.dom.isChildOf(n, v)) && !1 !== Qg(g, e.clientX, e.clientY))
                  if ((t = Kx(g, n)))
                    Wx(t)
                      ? (e.preventDefault(), s(yb(g, t)))
                      : (c(),
                        ($x(t) && e.shiftKey) ||
                          Qh(e.clientX, e.clientY, g.selection.getRng()) ||
              ...
              g.on("keypress", function (e) {
                Zh.modifierPressed(e) || (e.keyCode, Wx(g.selection.getNode()) && e.preventDefault());
              }),
          ...
          })(),
        {
          ...
          showBlockCaretContainer: function (e) {
            e.hasAttribute("data-mce-caret") && (xu(e), a(r()), g.selection.scrollIntoView(e));
          },
          hideFakeCaret          : w,
          destroy: function () {
            o.destroy(), (h = null);
          ...
          u.inline ||
            ...
            u.on("click", function (e) {
              ...
              if ("HTML" === e.target.nodeName) {
                if (11 < rr.ie) return void u.getBody().focus();
      ...
      return (
        ...
        u.on("keydown", function (e) {
          ...
          if (!v(e) && (a === l || a === c)) {
            ...
            if (!t && ((r = u.selection.getRng()), (o = s(r)), (i = f.createRng()).selectNode(u.getBody()), o !== s(i)))
              return;
            e.preventDefault(),
              u.setContent(""),
          ...
          u.on("dragstart", function (e) {
            ...
            (t = e).dataTransfer &&
              ...
              0 < (n = u.selection.getContent()).length &&
                ((r = p + escape(u.id) + "," + escape(n)), t.dataTransfer.setData(g, r)));
          }),
          u.on("drop", function (e) {
            if (!v(e)) {
              var t =
                (i = e).dataTransfer && (a = i.dataTransfer.getData(g)) && 0 <= a.indexOf(p)
                  ? ((a = a.substr(p.length).split(",")), { id: unescape(a[0]), html: unescape(a[1]) })
                  : null;
              if (t && t.id !== u.id) {
                e.preventDefault();
        ...
        i &&
          ...
          u.on("keypress", function (e) {
            ...
            if (!v(e) && (8 === e.keyCode || 46 === e.keyCode) && r())
              return (t = n()), u.getDoc().execCommand("delete", !1, null), t(), e.preventDefault(), !1;
          }),
    ...
    Zx = function (u) {
      var e = u.dom.getRoot();
      u.inline ||
        (Gl(u) && u.selection.getStart(!0) !== e) ||
        Zc(e).each(function (e) {
          var t,
            n,
            r,
            o,
            i = e.getNode(),
            a = Gt(i) ? Zc(i).getOr(e) : e;
          rr.browser.isIE()
            ? ((t = u),
              (n = a.toRange()),
              (r = Ne.fromDom(t.getBody())),
      ...
      e.bindPendingEventDelegates(),
        ...
        (t = e).settings.auto_focus &&
          Xn.setEditorTimeout(
            ...
            function () {
              var e;
              (e = !0 === t.settings.auto_focus ? t : t.editorManager.get(t.settings.auto_focus)).destroyed ||
                e.focus();
            },
            100
          );
    ...
    tS = function (t, e) {
      var n = t.settings,
        r = t.getDoc(),
        o = t.getBody();
      n.browser_spellcheck || n.gecko_spellcheck || ((r.body.spellcheck = !1), Gx.setAttrib(o, "spellcheck", "false")),
        (t.quirks = Yx(t)),
        t.fire("PostRender");
      var i,
        a,
        ...
        s,
        c,
        l = t.getParam("directionality", ka.isRtl() ? "rtl" : undefined);
      if (
        (l !== undefined && (o.dir = l),
        n.protect &&
      ...
      ((i = t).inline ? Gx.styleSheetLoader : i.dom.styleSheetLoader).loadAll(
        t.contentCSS,
        function (e) {
          eS(t);
        },
    ...
    nS = function (t, e) {
      ...
      c.inline || (t.getElement().style.visibility = t.orgVisibility),
        e || t.inline || (f.open(), f.write(t.iframeHTML), f.close()),
        t.inline &&
          (t.on("remove", function () {
            var e = this.getBody();
        ...
        t.readonly ||
          (t.inline && "static" === Gx.getStyle(n, "position", !0) && (n.style.position = "relative"),
        ...
        (t.parser =
          ((r = Ev(Qx((u = t)), u.schema)).addAttributeFilter("src,href,style,tabindex", function (e, t) {
            for (var n, r, o = e.length, i = u.dom, a = "data-mce-" + t; o--; )
              if ((r = (n = e[o]).attr(t)) && !n.attr(a)) {
                if (0 === r.indexOf("data:") || 0 === r.indexOf("blob:")) continue;
                "style" === t
                  ? ((r = i.serializeStyle(i.parseStyle(r), n.name)).length || (r = null), n.attr(a, r), n.attr(t, r))
                  : "tabindex" === t
          ...
          u.settings.preserve_cdata &&
            r.addNodeFilter("#cdata", function (e) {
              for (var t, n = e.length; n--; )
                ((t = e[n]).type = 8), (t.name = "#comment"), (t.value = "[CDATA[" + u.dom.encode(t.value) + "]]");
            }),
    ...
    oS = function (e) {
      var t, n, r;
      return (
        (r = e.getParam("doctype", "<!DOCTYPE html>") + "<html><head>"),
        ...
        (r +=
          '</head><body id="' + t + '" class="mce-content-body ' + n + '" data-id="' + e.id + '"><br></body></html>')
      );
    },
    iS = function (e, t) {
      var n,
        ...
        u =
          ...
          (i = Ne.fromTag("iframe")),
          ln(i, o),
          ln(i, { id: n + "_ifr", frameBorder: "0", allowTransparency: "true", title: r }),
    ...
    uS = function (t, n, e) {
      ...
      if (((e = hr.trim(e)), r && -1 === hr.inArray(n, e))) {
        if (
          (hr.each(th.dependencies(e), function (e) {
            uS(t, n, e);
          }),
          t.plugins[e])
        )
    ...
    lS = function (e) {
      var t,
        n,
        r = e.getElement();
      return e.inline ? cS(null) : ((t = r), (n = aS.create("div")), aS.insertAfter(n, t), cS(n));
    },
    fS = function (e) {
      var n, t, r, o, i, a;
      ...
      var u,
        ...
        h =
          ...
          q(u.settings.theme)
            ...
            : D(u.settings.theme)
              ? ((c = (s = u).getElement()),
                (l = (0, s.settings.theme)(s, c)).editorContainer.nodeType &&
                  (l.editorContainer.id = l.editorContainer.id || s.id + "_parent"),
                l.iframeContainer &&
                  l.iframeContainer.nodeType &&
                  (l.iframeContainer.id = l.iframeContainer.id || s.id + "_iframecontainer"),
                (l.height = l.iframeHeight ? l.iframeHeight : c.offsetHeight),
                l)
              : lS(u));
      return (
        (e.editorContainer = h.editorContainer ? h.editorContainer : null),
        ((d = e).contentCSS = d.contentCSS.concat(lh(d))),
        e.inline
          ? nS(e)
          : ((g = iS((m = e), (p = h))),
            p.editorContainer &&
              ((rS.get(p.editorContainer).style.display = m.orgDisplay), (m.hidden = rS.isHidden(p.editorContainer))),
    ...
    gS = function (t, e, n) {
      return R.from(e)
        ...
        .map(function (e) {
          return { url: t.editorManager.baseURL + "/icons/" + e + "/icons" + n + ".js", name: R.some(e) };
        });
    },
    hS = function (e, o, t) {
      var n,
        ...
        i =
          ((n = o),
          R.from(n.getParam("icons_url", "", "string"))
            .filter(function (e) {
              return 0 < e.length;
            })
            .map(function (e) {
      ...
      z(
        ...
        function (r) {
          e.add(r.url, f, undefined, function () {
            var e, t, n;
            (e = o), (t = r.url), (n = r.name.getOrUndefined()), ah(e, "IconsLoadError", uh("icons", t, n));
          });
        }
      );
    },
          ...
          hr.each(n.plugins.split(/[ ,]/), function (e) {
            if ((e = hr.trim(e)) && !th.urls[e])
              if (mS(e)) {
                ...
                var n = { prefix: "plugins/", resource: e, suffix: "/plugin" + o + ".js" };
    ...
    yS = function (e, t) {
      var n,
        ...
        a =
          "string" != typeof (n = t)
            ? ((r = hr.extend({ paste: n.paste, data: { paste: n.paste } }, n)), { content: n.content, details: r })
            : { content: n, details: {} };
      (o = a.content), (i = a.details), Cg(e).editor.insertContent(o, i);
    },
    bS = function (e, t) {
    ...
    xS = { "font-size": "size", "font-family": "face" },
    SS = function (e, t, n) {
      var r = function (r) {
        return gn(r, e).orThunk(function () {
          return "font" === Rt(r)
            ? de(xS, e).bind(function (e) {
                return (t = r), (n = e), R.from(fn(t, n));
                var t, n;
              })
            : R.none();
        });
    ...
    NS = function (o) {
      return function (r, e) {
        return R.from(e)
          ...
          .filter(Dt)
          .bind(function (e) {
            return SS(o, r, e.dom()).or(((t = o), (n = e.dom()), R.from(ga.DOM.getStyle(n, t, !0))));
            var t, n;
          })
          .getOr("");
      };
    ...
    RS = function (o) {
      return R.from(o.selection.getRng()).bind(function (e) {
        var t,
          ...
          r = o.getBody();
        return (
          (n = r), (t = e).startContainer === n && 0 === t.startOffset ? R.none() : R.from(o.selection.getStart(!0))
        );
      });
    },
    TS = function (e, t) {
      if (/^[0-9\.]+$/.test(t)) {
        ...
        if (1 <= n && n <= 7) {
          var r =
            ...
            o = ((i = e), hr.explode(i.getParam("font_size_classes", "")));
    ...
    BS = hr.inArray,
    PS =
      ((LS.prototype.execCommand = function (t, n, r, e) {
        var o,
          i,
          a = !1,
          u = this;
        if (!u.editor.removed) {
          ...
          if (((i = t.toLowerCase()), (o = u.commands.exec[i])))
            return o(i, n, r), u.editor.fire("ExecCommand", { command: t, ui: n, value: r }), !0;
          if (
            (DS(this.editor.plugins, function (e) {
              if (e.execCommand && e.execCommand(t, n, r))
                return u.editor.fire("ExecCommand", { command: t, ui: n, value: r }), !(a = !0);
            }),
            a)
          )
            return a;
        ...
        this.addCommands({
          ...
          "Cut,Copy,Paste": function (e) {
            ...
            if (("paste" !== e || n.queryCommandEnabled(e) || (t = !0), t || !n.queryCommandSupported(e))) {
              ...
              rr.mac && (r = r.replace(/Ctrl\+/g, "\u2318+")), i.notificationManager.open({ text: r, type: "error" });
            }
          },
          unlink: function () {
            ...
            a.execNativeCommand(e),
              (t = i.dom.getParent(i.selection.getNode(), "ol,ul")) &&
                ...
                /^(H[1-6]|P|ADDRESS|PRE)$/.test(n.nodeName) &&
                  (a.storeSelection(), i.dom.split(n, t), a.restoreSelection()));
          },
          ...
          FontSize: function (e, t, n) {
            var r, o;
            (o = n), (r = i).formatter.toggle("fontsize", { value: TS(r, o) }), r.nodeChanged();
          },
          ...
          mceReplaceContent: function (e, t, n) {
            i.execCommand(
              "mceInsertContent",
              !1,
              n.replace(/\{\$selection\}/g, i.selection.getContent({ format: "text" }))
            );
          },
    ...
    MS =
      ...
      (FS.prototype.fire = function (e, t) {
        ...
        if (
          ...
          for (r = 0, o = n.length; r < o; r++) {
            if (((i = n[r]).once && this.off(e, i.func), t.isImmediatePropagationStopped()))
      ...
      (FS.prototype.on = function (e, t, n, r) {
        ...
        if ((!1 === t && (t = g), t)) {
          var u = { func: t };
          for (r && hr.extend(u, r), a = (i = e.toLowerCase().split(" ")).length; a--; )
            (e = i[a]),
              (o = this.bindings[e]) || ((o = this.bindings[e] = []), this.toggleEvent(e, !0)),
        ...
        if (e)
          for (n = (o = e.toLowerCase().split(" ")).length; n--; ) {
            ...
            if (r) {
              if (t)
                for (i = r.length; i--; )
                  r[i].func === t && ((r = r.slice(0, i).concat(r.slice(i + 1))), (this.bindings[e] = r));
              else r.length = 0;
  ...
  var US,
    ...
    XS = function (t) {
      t.parser.addAttributeFilter("contenteditable", function (e) {
        KS(t) &&
          z(e, function (e) {
            e.attr(HS, e.attr("contenteditable")), e.attr("contenteditable", "false");
          });
      }),
      ...
      return "selectionchange" === t
        ...
        : !e.inline && /^mouse|touch|click|contextmenu|drop|dragover|dragend/.test(t)
          ...
          : e.settings.event_root
            ? (e.eventRoot || (e.eventRoot = YS.select(e.settings.event_root)[0]), e.eventRoot)
            : e.getBody();
    },
    JS = function (e, t, n) {
      var r, o, i, a, u;
    ...
    QS = function (i, a) {
      ...
      if ((i.delegates || (i.delegates = {}), !i.delegates[a] && !i.removed))
        if (((e = GS(i, a)), i.settings.event_root)) {
          if (
            (US ||
              ((US = {}),
      ...
      toggleNativeEvent: function (e, t) {
        ...
        "focus" !== e &&
          ...
          (t
            ...
            : n.initialized && (n.dom.unbind(GS(n, e), e, n.delegates[e]), delete n.delegates[e]));
      },
        ...
        }),
        {
          ...
          register: function (e, t) {
            o.set(
              (function (e, t, n) {
                var r;
                if (M(eN, t)) throw new Error("Cannot override default mode " + t);
                return pe(
                  pe({}, e),
                  (((r = {})[t] = pe(pe({}, n), {
                    deactivate: function () {
    ...
    aN = hr.makeMap("alt,ctrl,shift,meta,access"),
    uN =
      ((sN.prototype.add = function (e, n, r, o) {
        var t,
          i = this;
        return (
          "string" == typeof (t = r)
      ...
      (sN.prototype.parseShortcut = function (e) {
        ...
        for (n in (rN(oN(e.toLowerCase(), "+"), function (e) {
          e in aN
            ...
            : /^[0-9]{2,}$/.test(e)
              ...
              : ((r.charCode = e.charCodeAt(0)), (r.keyCode = iN[e] || e.toUpperCase().charCodeAt(0)));
        }),
        (t = [r.keyCode]),
        aN))
          r[n] ? t.push(n) : (r[n] = !1);
        return (
          (r.id = t.join(",")),
          r.access && ((r.alt = !0), rr.mac ? (r.ctrl = !0) : (r.shift = !0)),
          r.meta && (rr.mac ? (r.meta = !0) : ((r.ctrl = !0), (r.meta = !1))),
          r
        );
      }),
      (sN.prototype.createShortcut = function (e, t, n, r) {
        var o;
        return (
          ((o = hr.map(oN(e, ">"), this.parseShortcut))[o.length - 1] = hr.extend(o[o.length - 1], {
            func : n,
            scope: r || this.editor,
          })),
          hr.extend(o[0], { desc: this.editor.translate(t), subpatterns: o.slice(1) })
        );
      }),
  ...
  function sN(e) {
    ...
    e.on("keyup keypress keydown", function (t) {
      (!n.hasModifier(t) && !n.isFunctionKey(t)) ||
        ...
        (rN(n.shortcuts, function (e) {
          if (n.matchShortcut(t, e))
            return (n.pendingPatterns = e.subpatterns.slice(0)), "keydown" === t.type && n.executeShortcutAction(e), !0;
        }),
        n.matchShortcut(t, n.pendingPatterns[0]) &&
          (1 === n.pendingPatterns.length && "keydown" === t.type && n.executeShortcutAction(n.pendingPatterns[0]),
  ...
  var cN = function () {
        ...
        s =
          ...
          (a = {}),
          {
            addButton: (u = function (n, r) {
              return function (e, t) {
                return (n[e.toLowerCase()] = pe(pe({}, t), { type: r }));
              };
            })((e = {}), "button"),
    ...
    mN = { ftp: 21, http: 80, https: 443, mailto: 25 },
    pN =
      ((gN.parseDataUri = function (e) {
        var t,
      ...
      (gN.prototype.toRelative = function (e) {
        ...
        var r = this.getURI(),
          o = n.getURI();
        return r === o || ("/" === r.charAt(r.length - 1) && r.substr(0, r.length - 1) === o)
          ? r
      ...
      (gN.prototype.toAbsPath = function (e, t) {
        ...
        return (
          0 !==
            (o = (n = u.length - i) <= 0 ? J(a).join("/") : u.slice(0, n).join("/") + "/" + J(a).join("/")).indexOf(
              "/"
            ) && (o = "/" + o),
    ...
    wN =
      ((xN.prototype.render = function () {
        !(function (t) {
          ...
          ka.setCode(Ws(t));
          var r = function () {
            dS.unbind(V.window, "ready", r), t.render();
          };
          if (ho.Event.domLoaded) {
            if (t.getElement() && rr.contentEditable) {
              e.inline
                ? (t.inline = !0)
                : ((t.orgVisibility = t.getElement().style.visibility), (t.getElement().style.visibility = "hidden"));
              var o = t.getElement().form || dS.getParent(n, "form");
              o &&
                ((t.formElement = o),
                e.hidden_input &&
                  !Qt(t.getElement()) &&
                  (dS.insertAfter(dS.create("input", { type: "hidden", name: n }), n), (t.hasHiddenInput = !0)),
          ...
          } else dS.bind(V.window, "ready", r);
        })(this);
      }),
      (xN.prototype.focus = function (e) {
        var t, n;
        (n = e), (t = this).removed || (n ? Im : Lm)(t);
      }),
      ...
      (xN.prototype.show = function () {
        this.hidden &&
          ((this.hidden = !1),
          this.inline ? (this.getBody().contentEditable = "true") : (hN.show(this.getContainer()), hN.hide(this.id)),
          this.load(),
          this.fire("show"));
      }),
      (xN.prototype.hide = function () {
        var e = this,
          t = e.getDoc();
        e.hidden ||
          (CN && t && !e.inline && t.execCommand("SelectAll"),
          e.save(),
          e.inline
            ? ((e.getBody().contentEditable = "false"),
              e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null))
            : (hN.hide(e.getContainer()), hN.setStyle(e.id, "display", e.orgDisplay)),
          (e.hidden = !0),
          e.fire("hide"));
      }),
          ...
          return (
            ...
            Qt(o)
              ...
              : ((!e.is_removing && r.inline) || (o.innerHTML = t),
                (n = hN.getParent(r.id, "form")) &&
                  yN(n.elements, function (e) {
      ...
      (xN.prototype.insertContent = function (e, t) {
        t && (e = vN({ content: e }, t)), this.execCommand("mceInsertContent", !1, e);
      }),
      (xN.prototype.resetContent = function (e) {
        e === undefined ? Sg(this, this.startContent, { format: "raw" }) : Sg(this, e),
      ...
      (xN.prototype.getWin = function () {
        var e;
        return (
          this.contentWindow || ((e = this.iframeElement) && (this.contentWindow = e.contentWindow)), this.contentWindow
        );
      }),
      (xN.prototype.getDoc = function () {
        var e;
        return (
          this.contentDocument || ((e = this.getWin()) && (this.contentDocument = e.document)), this.contentDocument
        );
      }),
  ...
  function xN(e, t, n) {
    ...
    (this.plugins = {}),
      ...
      this.settings.referrer_policy &&
        (ba.ScriptLoader._setReferrerPolicy(this.settings.referrer_policy),
      ...
      (this.id = e),
      this.setDirty(!1),
      (this.documentBaseURI = new pN(this.settings.document_base_url, { base_uri: this.baseUri })),
  ...
  var SN,
    ...
    PN = function (e) {
      e !== AN && (e ? na(window).on("resize scroll", BN) : na(window).off("resize scroll", BN), (AN = e));
    },
    LN = function (t) {
      var e = ON;
      delete DN[t.id];
    ...
    IN = "CSS1Compat" !== V.document.compatMode,
    MN = pe(pe({}, jS), {
      baseURI         : null,
      baseURL         : null,
      defaultSettings : {},
      ...
      init: function (r) {
        ...
        var c = function (e) {
            var t = e.id;
            return t || ((t = (t = e.name) && !EN.get(t) ? e.name : EN.uniqueId()), e.setAttribute("id", t)), t;
          },
          l = function (e, t) {
            ...
            EN.unbind(window, "ready", e),
              ...
              (o = na.unique(
                (function (t) {
                  ...
                  if (t.types)
                    return (
                      _N(t.types, function (e) {
                        n = n.concat(EN.select(e.selector));
                      }),
                      n
                    );
                  if (t.selector) return EN.select(t.selector);
                    ...
                    case "exact":
                      0 < (e = t.elements || "").length &&
                        _N(kN(e), function (t) {
                          ...
                          (e = EN.get(t))
                            ? n.push(e)
                            : _N(V.document.forms, function (e) {
                                _N(e.elements, function (e) {
                                  e.name === t && ((t = "mce_editor_" + TN++), EN.setAttrib(e, "id", t), n.push(e));
                                });
                              });
                        });
                      break;
              ...
              r.types
                ? _N(r.types, function (t) {
                    hr.each(o, function (e) {
                      return !EN.is(e, t.selector) || (n(c(e), RN({}, r, t), e), !1);
                    });
                  })
                : (hr.each(o, function (e) {
                    var t;
                    (t = s.get(e.id)) &&
                      ...
                      (LN(t), t.unbindAllNativeEvents(), t.destroy(!0), (t.removed = !0), (t = null));
                  }),
                  0 ===
                  (o = hr.grep(o, function (e) {
                    return !s.get(e.id);
                  })).length
                    ? f([])
                    : _N(o, function (e) {
                        ...
                        (t = e),
                          r.inline && t.tagName.toLowerCase() in u
                            ? ch("Could not initialize inline editor on invalid inline target element", e)
                            : n(c(e), r, e);
                      }));
          };
        return (
      ...
      add: function (e) {
        ...
        return (
          DN[e.id] === e ||
            (null === n.get(e.id) && ("length" !== e.id && (DN[e.id] = e), DN.push(e), ON.push(e)),
            PN(!0),
            (n.activeEditor = e),
        ...
        if (e) {
          if (!q(e))
            return (
              ...
              _(r.get(n.id))
                ? null
                : (LN(n) && r.fire("RemoveEditor", { editor: n }),
      ...
      execCommand: function (e, t, n) {
        ...
        switch (e) {
          case "mceAddEditor":
            return this.get(n) || new wN(n, this.settings, this).render(), !0;
      ...
      setActive: function (e) {
        ...
        this.activeEditor !== e &&
          (t && t.fire("deactivate", { relatedTarget: e }), e.fire("activate", { relatedTarget: t })),
          (this.activeEditor = e);
      },
  ...
  var UN,
    ...
    qN =
      ...
      (zN = {}),
      {
        ...
        add: function (e, t) {
          zN[e] !== undefined && (zN[e](t), delete zN[e]), (UN[e] = Mn.resolve(t));
        },
      }),
    $N = Math.min,
    WN = Math.max,
  ...
  ZN.extend = jN = function (n) {
    var o,
      ...
      r = function () {
        var e, t, n;
        if (!HN && (this.init && this.init.apply(this, arguments), (t = this.Mixins)))
    ...
    return (
      ...
      (HN = !1),
      n.Mixins &&
        (JN(n.Mixins, function (e) {
          for (var t in e) "init" !== t && (n[t] = e[t]);
        }),
        i.Mixins && (n.Mixins = i.Mixins.concat(n.Mixins))),
      n.Methods &&
        JN(n.Methods.split(","), function (e) {
          n[e] = t;
        }),
      n.Properties &&
        JN(n.Properties.split(","), function (e) {
          var t = "_" + e;
          n[e] = function (e) {
    ...
    iE = pe(pe({}, jS), {
      send: function (e) {
        ...
        if (
          ...
          (e.async = !1 !== e.async),
          (e.data = e.data || ""),
          iE.fire("beforeInitialize", { settings: e }),
          ...
          if (
            ...
            e.requestheaders &&
              hr.each(e.requestheaders, function (e) {
                t.setRequestHeader(e.key, e.value);
              }),
            t.setRequestHeader("X-Requested-With", "XMLHttpRequest"),
            (t = iE.fire("beforeSend", { xhr: t, settings: e }).xhr).send(e.data),
            !e.async)
          )
            return r();
          Xn.setTimeout(r, 10);
    ...
    uE =
      ...
      (sE.prototype.send = function (e) {
        ...
        (o.success = function (e, t) {
          void 0 === (e = rE.parse(e)) && (e = { error: "JSON Parse error." }),
          ...
          (o.data = rE.serialize({ id: e.id || "c" + this.count++, method: e.method, params: e.params })),
          (o.content_type = "application/json"),
          iE.send(o);
      }),
      sE);
  function sE(e) {
    (this.settings = aE({}, e)), (this.count = 0);
  }
  var cE;
  try {
    var lE = "__storage_test__";
    (cE = V.window.localStorage).setItem(lE, lE), cE.removeItem(lE);
  } catch (pE) {
    cE = (function () {
      return (
        (n = {}),
                    ...
                    : "v" in e &&
                      (function (e, t, n) {
                        ...
                        if (
                          ...
                          switch (
                            ((r = e / 60), (i = (o = n * t) * (1 - Math.abs((r % 2) - 1))), (a = n - o), Math.floor(r))
                          ) {
                            case 0:
                              (u = o), (s = i), (c = 0);
                              break;
                          ...
                          (u = nE(255 * (u + a))), (s = nE(255 * (s + a))), (c = nE(255 * (c + a)));
                        } else u = s = c = nE(255 * n);
                      })(e.h, e.s, e.v)
