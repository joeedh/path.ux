...
let _ui_tabs = undefined;

define([
  "util", "vectormath", "ui_base", './icon_enum', './events', "ui"
], function(util, vectormath, ui_base, icon_enum, events, ui) {
  "use strict";
  
  let exports = _ui_tabs = {};
  ...
  let ModalTabMove = exports.ModalTabMode = class ModalTabMode extends events.EventHandler {
  ...
  let TabBar = exports.TabBar = class TabBar extends UIBase {
    constructor() {
      super();
  ...
  let TabContainer = exports.TabContainer = class TabContainer extends UIBase {
    constructor() {
      super();
