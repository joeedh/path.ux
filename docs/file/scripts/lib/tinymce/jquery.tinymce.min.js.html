...
<head>
  ...
  <title data-ice="title">scripts/lib/tinymce/jquery.tinymce.min.js | path.ux</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">scripts/lib/tinymce/jquery.tinymce.min.js</h1>
...
var r=n[0],a=l(r);return a?a.getContent({save:!0}):s.attr.apply(p(r),i)}}}();</code></pre>
