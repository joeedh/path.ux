...
<head>
  ...
  <title data-ice="title">scripts/lib/tinymce/plugins/image/plugin.min.js | path.ux</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">scripts/lib/tinymce/plugins/image/plugin.min.js</h1>
