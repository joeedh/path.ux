...
!(function (f) {
  ...
  var n,
    ...
    H = function (t) {
      ...
      if (!v(e))
        return (
          F("The setting textpattern_patterns should be an array"),
      ...
      return ot(e, t)
        ...
        .bind(function (n) {
          ...
          R(t, function (t) {
            ...
            return z.trim(o).length === t.start.length
              ? []
              : [{ pattern: t, range: dt(i.getRoot(), n, 0, n, 0) }];
          });
        })
        .getOr([]);
    },
    ...
    Ct = function (e, o, a, t) {
      ...
      return st(
        ...
        if (r.offset >= u.length) {
          var t = e.createRng();
          return (
            t.setStart(r.container, r.offset - u.length), t.setEnd(r.container, r.offset), y.some(t)
          );
        }
    ...
    Et = function (a, i, u) {
      ...
      return ft(l, d - u.pattern.end.length, i).bind(function (t) {
        ...
        if (et(s))
          return y.some({ matches: [{ pattern: s, startRng: e, endRng: e }], position: t });
            ...
            return ut(n, e, o).bind(function (n) {
              return Ct(t, r, o, n).bind(function (t) {
                if (a) {
                  ...
                  if (0 === n.offset && t.endContainer.textContent.length === t.endOffset)
                    return y.none();
                }
                return y.some(t);
              });
