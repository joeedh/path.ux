  ...
  var e,
          ...
          start: function (e, t) {
            if (!c.get())
              if (j(t.map, "data-ephox-embed-iri"))
                ...
                "source" === e &&
                  (u.source ? u.altsource || (u.altsource = t.map.src) : (u.source = t.map.src)),
      ...
      !(function (e, t) {
        ...
        if (a.map[t])
          for (var n = a.length; n--; ) {
            var i = a[n];
            i.name === t &&
              (r ? ((a.map[t] = r), (i.value = r)) : (delete a.map[t], a.splice(n, 1)));
          }
                  ...
                  if (u)
                    switch (e) {
                      ...
                      case "iframe":
                        ...
                        break;
                      case "source":
                        if (d < 2 && (N(t, { src: c[U[d]], type: c[U[d] + "mime"] }), !c[U[d]]))
                          return;
                        d++;
                        break;
                      case "img":
      ...
      return c
        ? ((i = t),
          ...
          new q(function (t, e) {
            var r = function (e) {
              return (
                e.html && (B[i.source] = e), t({ url: i.source, html: e.html ? e.html : a(i) })
              );
            };
            ...
            switch (t.name) {
              case "source":
                (s = d.get()),
                  ...
                  s.source !== l.source &&
                    (X(f, m)({ url: l.source, html: "" }), G(m, l).then(X(f, m))["catch"](Q(m)));
                break;
              case "embed":
              ...
              if (((o = !0), "script" !== e && "noscript" !== e && "svg" !== e)) {
                for (var n = t.length - 1; 0 <= n; n--) {
                  ...
                  0 === i.indexOf("on") && (delete t.map[i], t.splice(n, 1)),
                    "style" === i &&
                      (t[n].value = a.dom.serializeStyle(a.dom.parseStyle(t[n].value), e));
                }
                c.start(e, t, r), (o = !1);
              }
            },
    ...
    ie = function (e, t, r) {
      ...
      (c = t.firstChild && t.firstChild.value) &&
        (r.attr("data-mce-html", escape(ne(e, c))), (r.firstChild = null));
    },
    ae = function (e) {
      for (; (e = e.parent); )
        if (
