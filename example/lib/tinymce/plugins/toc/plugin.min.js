  ...
  var e,
    ...
    v = function (n) {
      var t,
        o = l(n),
        e = m(n),
        i = u(1 <= (t = parseInt(n.getParam("toc_depth", "3"), 10)) && t <= 9 ? t : 3),
        r = n.$(i);
      return (
        r.length &&
          /^h[1-9]$/i.test(e) &&
        ...
        d =
          (function (t) {
            ...
            for (e = 0; e < t.length; e++)
              if ((t[e].level < n && (n = t[e].level), 1 === n)) return n;
            return n;
          })(u) - 1;
      if (!u.length) return "";
      for (
        ...
        if ((((o = u[e]).element.id = o.id), (i = u[e + 1] && u[e + 1].level), d === o.level))
          a += "<li>";
        else for (n = d; n < o.level; n++) a += "<ul><li>";
        if (((a += '<a href="#' + o.id + '">' + o.title + "</a>"), i !== o.level && i))
    ...
    r = function (t) {
      var e,
        ...
        c = t.$("." + r);
      (o = t),
        !(i = c).length || 0 < o.dom.getParents(i[0], ".mce-offscreen-selection").length
          ? t.insertContent(
              ((n = d((e = t))),
              '<div class="' + e.dom.encode(l(e)) + '" contenteditable="false">' + n + "</div>")
            )
          : g(t);
    },
    g = function (t) {
    ...
    t.add("toc", function (t) {
      ...
      (e = t).addCommand("mceInsertToc", function () {
        ...
        n.on("SetContent", function () {
          var t = o("." + i);
          t.length &&
            (t.attr("contentEditable", !1), t.children(":first-child").attr("contentEditable", !0));
        });
    });
  })();
})();
