...
(function (domGlobals) {
  ...
  var missingBranch = function (path, branches, branch) {
    return nu$3(path, function () {
      return (
        'The chosen schema: "' + branch + '" did not exist in branches: ' + formatObj(branches)
      );
    });
  };
  ...
  var processEvent = function (eventName, initialTarget, f) {
    var status = get(eventConfig.get(), eventName)
      .orThunk(function () {
  ...
  var ReceivingSchema = [
    strictOf(
      ...
      setOf$1(
        Result.value,
        objOfOnly([onStrictHandler("onReceive"), defaulted$1("schema", anyValue$1())])
      )
    ),
  ];
    ...
    var toEvents = function (keyingConfig, keyingState) {
      ...
      var keyboardEvents = [
        ...
        run(keyup(), function (component, simulatedEvent) {
          processKey(component, simulatedEvent, getKeyupRules, keyingConfig, keyingState).each(
            function (_) {
              simulatedEvent.stop();
            }
          );
  ...
  var inside = function (target) {
    return (
      (name(target) === "input" && get$1(target, "type") !== "radio") || name(target) === "textarea"
    );
  };
  ...
  var getKeydownRules = function (component, _simulatedEvent, executeConfig, _executeState) {
    ...
    return [rule(inSet(execKeys), execute$1)].concat(
      executeConfig.useControlEnter ? [rule(and([isControl, inSet(ENTER())]), execute$1)] : []
    );
  };
  ...
  var subPlaceholder = function (owner, detail, compSpec, placeholders) {
    ...
    return get(placeholders, compSpec.name).fold(
      function () {
        throw new Error(
      ...
      part.fold(
        ...
        function (data) {
          ...
          externals[data.name] = constant(
            data.factory.sketch(combine(detail, data, partSpec[original()]), partSpec)
          );
        },
        function (data) {
  ...
  var record = function (spec) {
    var uid =
      isSketchSpec(spec) && hasNonNullableKey(spec, "uid") ? spec.uid : generate$3("memento");
  ...
  var sketch$6 = function (rawSpec) {
    ...
    var reposition = function (dialog, message) {
      descendant$1(dialog.element(), "." + resolve("serialised-dialog-chain")).each(
        function (parent) {
  ...
  var combineGroups = function (byEventName, eventOrder) {
    var r = mapToArray(byEventName, function (tuples, eventName) {
      ...
      return combined.map(function (handler) {
        ...
        var purpose =
          tuples.length > 1
            ? filter$1(eventOrder[eventName], function (o) {
  ...
  var getDomDefinition = function (info, bList, bData) {
    ...
    var modification =
      bList.length > 0 ? combine$1(bData, baseModification, bList, definition) : infoModification;
  ...
  var build = function (spec) {
    ...
    var config = function (behaviour) {
      ...
      var f = isFunction(b[behaviour.name()])
        ...
        : function () {
            throw new Error(
              "Could not find " + behaviour.name() + " in " + JSON.stringify(spec, null, 2)
            );
          };
      return f();
    };
  ...
  var make$3 = function (detail, _rawUiSpec) {
    ...
    var buildMenus = function (container, primaryName, menus) {
      return map(menus, function (spec, name) {
        var makeSketch = function () {
          return Menu.sketch(
            __assign(__assign({ dom: spec.dom }, spec), {
              value       : name,
              items       : spec.items,
              markers     : detail.markers,
    ...
    (function (ExpandHighlightDecision) {
      ExpandHighlightDecision[(ExpandHighlightDecision["HighlightSubmenu"] = 0)] =
        "HighlightSubmenu";
    ...
    var keyOnItem = function (f) {
      return function (container, simulatedEvent) {
        return closest$2(simulatedEvent.getSource(), "." + detail.markers.item).bind(
          function (target) {
            return container
              .getSystem()
              .getByDom(target)
  ...
  var tieredMenu = single$2({
    ...
    configFields: [
      ...
      strictObjOf("data", [strict$1("primary"), strict$1("menus"), strict$1("expansions")]),
      defaulted$1("fakeFocus", false),
      onHandler("onHighlight"),
      onHandler("onHover"),
      tieredMenuMarkers(),
  ...
  var jumpTo = function (comp, transConfig, transState, destination) {
    ...
    if (
      ...
      get$1(comp.element(), transConfig.stateAttr) !== destination
    ) {
    ...
    strictOf(
      ...
      setOf$1(
        ...
        setOf$1(
          Result.value,
          objOfOnly([
            optionObjOfOnly("transition", [strict$1("property"), strict$1("transitionClass")]),
          ])
        )
      )
    ),
  ...
  var initEvents = function (editorApi, toolstrip, alloy) {
    ...
    var updateMargin = function () {
      var rangeInContent =
        editorApi.doc().dom().hasFocus() && editorApi.getSelection().exists(isRanged);
      alloy
        .getByDom(toolstrip)
        .each((rangeInContent || hasRangeInUi()) === true ? Toggling.on : Toggling.off);
    };
    var listeners = [
  ...
  var doGetExact = function (selection) {
    ...
    return after$2(anchor, selection.anchorOffset, focus, selection.focusOffset)
  ...
  var hasScroll = function (container) {
    return get$1(container, dataHorizontal) === "true"
  ...
  var isTransitioning = function (component, slideConfig, slideState) {
    return (
      isGrowing(component, slideConfig) === true || isShrinking(component, slideConfig) === true
    );
  };
  ...
  var derive$2 = function (rawEvent, rawTarget) {
    var source = get(rawEvent, "target")
  ...
  var create$6 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      getActiveApi(platform.editor).each(function (editorApi) {
        ...
        iosEvents.set(
          initEvents$1(editorApi, iosApi, platform.toolstrip, platform.socket, platform.dropup)
        );
      });
    };
    var exit = function () {
  ...
  var derive$3 = function (editor) {
    var base = get(editor.settings, "skin_url").fold(
      function () {
